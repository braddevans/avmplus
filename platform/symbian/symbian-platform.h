...
// VMPI_strcat in Symbian has also been changed to take 3 arguments
...
// VMPI_strncpy in Symbian has also been changed to take 4 arguments
...
struct vmpi_spin_lock_t {
  ...
  // Using pthread_mutex for now (unfortunate since it's usually more
  // expensive).
...
REALLY_INLINE int VMPI_processorQtyAtBoot() { return 1; }
