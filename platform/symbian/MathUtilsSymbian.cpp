...
namespace avmplus {
double MathUtils::abs(double value) { return ::fabs(value); }
...
double MathUtils::ceil(double value) { return ::ceil(value); }
...
double MathUtils::floor(double value) { return ::floor(value); }
