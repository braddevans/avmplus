...
#endif
#ifdef WINDOWS_STORE_APP // For Windows Store Apps both AVMSYSTEM_WIN32 and
                         // AVMSYSTEM_WINDOWSSTOREAPP are defined.
...
#elif AVMSYSTEM_ARM
#if AVMSYSTEM_WEBOS
// At the time of this writing (Feb 2010), Palm's webOS deliberately enables
// software interrupts for all unaligned accesses, apparently in the name of
// promoting "clean code", making unaligned accesses vastly slower than aligned
// (reportedly on the order of 1000x). Unless they change this policy (or give
// us a way to change it selectively) we will consider all webOS builds not to
...
// ARMv7 (e.g. Cortex-A8): Unaligned access support cannot be disabled; you
// always have it.
//

// GCC and RealView usually define __ARM_ARCH__,
// otherwise try well-known GCC flags ( see
// http://gcc.gnu.org/onlinedocs/gcc/ARM-Options.html )
#if __ARM_ARCH__ >= 7 || defined(__ARM_ARCH_7__) ||                            \
