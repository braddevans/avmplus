...
REALLY_INLINE double MathUtils::abs(double value) { return ::fabs(value); }

REALLY_INLINE float MathUtils::absf(float value) { return ::fabsf(value); }

REALLY_INLINE double MathUtils::acos(double value) { return ::acos(value); }

REALLY_INLINE float MathUtils::acosf(float value) { return ::acosf(value); }

REALLY_INLINE double MathUtils::asin(double value) { return ::asin(value); }

REALLY_INLINE float MathUtils::asinf(float value) { return ::asinf(value); }

REALLY_INLINE double MathUtils::atan(double value) { return ::atan(value); }
...
REALLY_INLINE float MathUtils::cosf(float value) { return ::cosf(value); }

REALLY_INLINE double MathUtils::exp(double value) { return ::exp(value); }

REALLY_INLINE float MathUtils::expf(float value) { return ::expf(value); }
...
REALLY_INLINE double MathUtils::log(double value) { return ::log(value); }

REALLY_INLINE float MathUtils::logf(float value) { return ::logf(value); }

REALLY_INLINE double MathUtils::mod(double x, double y) { return ::fmod(x, y); }
...
REALLY_INLINE float MathUtils::sinf(float value) { return ::sinf(value); }

REALLY_INLINE double MathUtils::sqrt(double value) { return ::sqrt(value); }
