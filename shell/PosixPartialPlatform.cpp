...
namespace avmshell {
void PosixPartialPlatform::exit(int code) { ::exit(code); }

File *PosixPartialPlatform::createFile() { return mmfx_new(PosixFile()); }

void PosixPartialPlatform::destroyFile(File *file) { mmfx_delete(file); }
