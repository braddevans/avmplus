...
public:
  AbstractBaseObject(avmplus::VTable *vtable, avmplus::ScriptObject *prototype)
...
public:
  NativeSubclassOfAbstractBaseClass(avmplus::VTable *cvtable)
...
public:
  NativeSubclassOfAbstractBaseObject(avmplus::VTable *vtable,
                                     avmplus::ScriptObject *prototype)
      : AbstractBaseObject(vtable, prototype) {}
...
public:
  RestrictedBaseClass(avmplus::VTable *cvtable)
      : avmplus::ClassClosure(cvtable) {}
...
public:
  RestrictedBaseObject(avmplus::VTable *vtable,
                       avmplus::ScriptObject *prototype)
      : avmplus::ScriptObject(vtable, prototype) {}
...
public:
  NativeSubclassOfRestrictedBaseClass(avmplus::VTable *cvtable)
      : avmplus::ClassClosure(cvtable) {}
...
public:
  NativeSubclassOfRestrictedBaseObject(avmplus::VTable *vtable,
                                       avmplus::ScriptObject *prototype)
      : RestrictedBaseObject(vtable, prototype) {}
...
public:
  AbstractRestrictedBaseClass(avmplus::VTable *cvtable)
      : avmplus::ClassClosure(cvtable) {}
...
public:
  AbstractRestrictedBaseObject(avmplus::VTable *vtable,
                               avmplus::ScriptObject *prototype)
      : avmplus::ScriptObject(vtable, prototype) {}
...
class GC_AS3_EXACT(NativeSubclassOfAbstractRestrictedBaseClass,
                   avmplus::ClassClosure) {
public:
  NativeSubclassOfAbstractRestrictedBaseClass(avmplus::VTable *cvtable)
      : avmplus::ClassClosure(cvtable) {}
...
class GC_AS3_EXACT(NativeSubclassOfAbstractRestrictedBaseObject,
                   AbstractRestrictedBaseObject) {
public:
  NativeSubclassOfAbstractRestrictedBaseObject(avmplus::VTable *vtable,
                                               avmplus::ScriptObject *prototype)
      : AbstractRestrictedBaseObject(vtable, prototype) {}
...
public:
  const double amount;
  MIObjectImpl(avmplus::VTable *vtable, avmplus::ScriptObject *prototype,
               double a)
      : avmplus::ScriptObject(vtable, prototype), amount(a) {}
...
public:
  CheckBaseObject(avmplus::VTable *vtable, avmplus::ScriptObject *prototype)
      : avmplus::ScriptObject(vtable, prototype) {}
...
public:
  NativeBaseObject(avmplus::VTable *vtable, avmplus::ScriptObject *prototype)
      : avmplus::ScriptObject(vtable, prototype) {}
...
// this class exists solely to test native classes that use MI.
class MIObject : public MIObjectImpl,
                 public MixinClassThatDoesNotDescendFromScriptObject {
public:
  MIObject(avmplus::VTable *vtable, avmplus::ScriptObject *prototype)
      : MIObjectImpl(vtable, prototype, 1),
        MixinClassThatDoesNotDescendFromScriptObject(2) {}
  ~MIObject() {}
...
public:
  REALLY_INLINE static SystemClass *create(MMgc::GC *gc,
  ...
  // Initiate a garbage collection; future versions will not return before
  // completed.
  ...
  // Test vector length smash protection feature.  No effect if feature not
  // configured.
  ...
  // These are provided solely for testing purposes, as the semantics of an AS3
  // program should not depend on the word size of the platform nor the internal
  // encoding of atoms.
