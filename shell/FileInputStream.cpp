...
bool FileInputStream::valid() const { return file != NULL; }

FileInputStream::~FileInputStream() {
  Platform::GetInstance()->destroyFile(file);
}

void FileInputStream::seek(int64_t offset) { file->setPosition(offset); }
...
size_t FileInputStream::read(void *buffer, size_t count) {
