...
inline bool Ctx::mustPushThis() {
  return tag == CTX_ClassMethod || tag == CTX_Program;
}
inline bool Ctx::mustPushScopeReg() {
...
inline uint32_t Cogen::emitSlotTrait(uint32_t name, uint32_t type) {
  return traits->addTrait(ALLOC(ABCSlotTrait, (name, type, TRAIT_Slot)));
}
inline uint32_t Cogen::emitConstTrait(uint32_t name, uint32_t type) {
  return traits->addTrait(ALLOC(ABCSlotTrait, (name, type, TRAIT_Const)));
}
inline uint32_t Cogen::emitMethodTrait(uint32_t name, uint32_t method) {
  return traits->addTrait(ALLOC(ABCMethodTrait, (name, method)));
}
inline uint32_t Cogen::emitNamespace(uint32_t name) {
  return abc->addNamespace(CONSTANT_Namespace, name);
}

inline uint32_t Cogen::getTemp() { return temp_counter++; }
...
inline void Cogen::I_applytype(uint32_t nargs) {
  emitOpU30(OP_applytype, nargs);
}
...
inline void Cogen::I_getglobalslot(uint32_t index) {
  emitOpU30(OP_getglobalslot, index);
}
inline void Cogen::I_getlex(uint32_t index) { emitOpU30(OP_getlex, index); }
inline void Cogen::I_getouterscope(uint32_t index) {
  emitOpU30(OP_getouterscope, index);
}
inline void Cogen::I_getscopeobject(uint32_t index) {
  emitOpU30(OP_getscopeobject, index);
}
...
inline void Cogen::I_ifstricteq(Label *label) {
  emitJump(OP_ifstricteq, label);
}
inline void Cogen::I_ifstrictne(Label *label) {
  emitJump(OP_ifstrictne, label);
}
...
inline void Cogen::I_newactivation() {
  need_activation = true;
  emitOp(OP_newactivation);
}
...
inline void Cogen::I_newfunction(uint32_t index) {
  emitOpU30(OP_newfunction, index);
}
...
inline void Cogen::I_pushdouble(uint32_t index) {
  emitOpU30(OP_pushdouble, index);
}
#ifdef VMCFG_FLOAT
inline void Cogen::I_pushfloat(uint32_t index) {
  emitOpU30(OP_pushfloat, index);
}
#endif
inline void Cogen::I_pushfalse() { emitOp(OP_pushfalse); }
inline void Cogen::I_pushint(uint32_t index) { emitOpU30(OP_pushint, index); }
inline void Cogen::I_pushnamespace(uint32_t index) {
  emitOpU30(OP_pushnamespace, index);
}
inline void Cogen::I_pushnan() { emitOp(OP_pushnan); }
inline void Cogen::I_pushnull() { emitOp(OP_pushnull); }
inline void Cogen::I_pushscope() {
  scope_depth++;
  emitOp(OP_pushscope);
}
inline void Cogen::I_pushshort(int16_t v) { emitOpS16(OP_pushshort, v); }
inline void Cogen::I_pushstring(uint32_t index) {
  emitOpU30(OP_pushstring, index);
}
...
inline void Cogen::I_setglobalslot(uint32_t index) {
  emitOpU30(OP_setglobalslot, index);
}
...
inline void Cogen::I_construct(uint32_t nargs) {
  emitOpU30(OP_construct, nargs);
}
inline void Cogen::I_constructsuper(uint32_t nargs) {
  emitOpU30(OP_constructsuper, nargs);
}

inline void Cogen::I_callmethod(uint32_t index, uint32_t nargs) {
  emitOpU30U30(OP_callmethod, index, nargs);
}
inline void Cogen::I_callstatic(uint32_t index, uint32_t nargs) {
  emitOpU30U30(OP_callstatic, index, nargs);
}

inline void Cogen::I_callsuper(uint32_t index, uint32_t nargs) {
  callMN(OP_callsuper, index, nargs);
}
inline void Cogen::I_callproperty(uint32_t index, uint32_t nargs) {
  callMN(OP_callproperty, index, nargs);
}
inline void Cogen::I_constructprop(uint32_t index, uint32_t nargs) {
  callMN(OP_constructprop, index, nargs);
}
inline void Cogen::I_callproplex(uint32_t index, uint32_t nargs) {
  callMN(OP_callproplex, index, nargs);
}
inline void Cogen::I_callsupervoid(uint32_t index, uint32_t nargs) {
  callMN(OP_callsupervoid, index, nargs);
}
inline void Cogen::I_callpropvoid(uint32_t index, uint32_t nargs) {
  callMN(OP_callpropvoid, index, nargs);
}

inline void Cogen::I_deleteproperty(uint32_t index) {
  propU30(OP_deleteproperty, index);
}
inline void Cogen::I_getdescendants(uint32_t index) {
  propU30(OP_getdescendants, index);
}
inline void Cogen::I_getproperty(uint32_t index) {
  propU30(OP_getproperty, index);
  ;
}
inline void Cogen::I_getsuper(uint32_t index) {
  propU30(OP_getsuper, index);
  ;
}
inline void Cogen::I_findproperty(uint32_t index) {
  propU30(OP_findproperty, index);
}
inline void Cogen::I_findpropstrict(uint32_t index) {
  propU30(OP_findpropstrict, index);
}
inline void Cogen::I_initproperty(uint32_t index) {
  propU30(OP_initproperty, index);
}
inline void Cogen::I_setproperty(uint32_t index) {
  propU30(OP_setproperty, index);
}
inline void Cogen::I_setsuper(uint32_t index) { propU30(OP_setsuper, index); }

inline void Cogen::I_hasnext2(uint32_t object_reg, uint32_t index_reg) {
  emitOpU30U30(OP_hasnext2, object_reg, index_reg);
}

inline void Cogen::I_newarray(uint32_t nargs) {
  emitOpU30Special(OP_newarray, nargs, nargs);
}
inline void Cogen::I_newobject(uint32_t nargs) {
  emitOpU30Special(OP_newobject, nargs, 2 * nargs);
}
