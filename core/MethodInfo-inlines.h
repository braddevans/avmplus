...
REALLY_INLINE uint32_t MethodInfo::hasOptional() const { return _hasOptional; }

REALLY_INLINE uint32_t MethodInfo::isNative() const { return _isNative; }

REALLY_INLINE uint32_t MethodInfo::isNonInterruptible() {
  return _isNonInterruptible;
}

REALLY_INLINE uint32_t MethodInfo::isResolved() const { return _isResolved; }
...
REALLY_INLINE uint32_t MethodInfo::needClosure() const { return _needClosure; }

REALLY_INLINE uint32_t MethodInfo::needRest() const { return _needRest; }
...
REALLY_INLINE uint32_t MethodInfo::isFinal() const { return _isFinal; }

REALLY_INLINE uint32_t MethodInfo::setsDxns() const { return _setsDxns; }

REALLY_INLINE uint32_t MethodInfo::isStaticInit() const {
  return _isStaticInit;
}

REALLY_INLINE uint32_t MethodInfo::unboxThis() const { return _unboxThis; }
...
REALLY_INLINE uint32_t MethodInfo::osrEnabled() const { return _osr_enabled; }
...
// elimination
REALLY_INLINE PoolObject *MethodInfo::pool() const { return _pool; }
#endif
...
REALLY_INLINE int32_t MethodInfo::method_id() const { return _method_id; }
...
REALLY_INLINE bool MethodSignature::argcOk(int32_t argc) const {
  ...
  return uint32_t(argc) >=
             (uint32_t(_param_count) - uint32_t(_optional_count)) &&
