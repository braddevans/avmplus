...
public:
  ...
  AvmCore
      *core; // access console via core dynamically since core may modify it.
#endif
};
...
public:
  ...
  BindingCache
      *bindingCaches; // head of linked list of all BindingCaches allocated by
                      // this codeMgr (only for flushing... lifetime is still
                      // managed by codeAlloc)
  CodeMgr(nanojit::Config *conf);
  void flushBindingCaches(); // invalidate all binding caches for this
                             // codemgr... needed when AbcEnv is unloaded
...
protected:
  ...
  typedef enum { F4_X = 0, F4_Y = 1, F4_Z = 2, F4_W = 3 } eFloat4Component;

protected:
  LIns *downcast_obj(LIns *atom, LIns *env,
                     Traits *t); // atom -> typed scriptobj
  ...
  LIns *InsConstDbl(double d, bool blind);
  ...
  LIns *InsConstFlt(float f, bool blind);
...
protected: // data
  ...
  bool const use_cmov;
  debug_only(ValidateWriter *validate1;) debug_only(ValidateWriter *validate2;)
...
#define SIG0(r) nanojit::CallInfo::typeSig0(ARGTYPE_##r)
#define SIG1(r, a1) nanojit::CallInfo::typeSig1(ARGTYPE_##r, ARGTYPE_##a1)
#define SIG2(r, a1, a2)                                                        \
  nanojit::CallInfo::typeSig2(ARGTYPE_##r, ARGTYPE_##a1, ARGTYPE_##a2)
#define SIG3(r, a1, a2, a3)                                                    \
  nanojit::CallInfo::typeSig3(ARGTYPE_##r, ARGTYPE_##a1, ARGTYPE_##a2,         \
                              ARGTYPE_##a3)
#define SIG4(r, a1, a2, a3, a4)                                                \
  nanojit::CallInfo::typeSig4(ARGTYPE_##r, ARGTYPE_##a1, ARGTYPE_##a2,         \
                              ARGTYPE_##a3, ARGTYPE_##a4)
#define SIG5(r, a1, a2, a3, a4, a5)                                            \
  nanojit::CallInfo::typeSig5(ARGTYPE_##r, ARGTYPE_##a1, ARGTYPE_##a2,         \
                              ARGTYPE_##a3, ARGTYPE_##a4, ARGTYPE_##a5)
#define SIG6(r, a1, a2, a3, a4, a5, a6)                                        \
  nanojit::CallInfo::typeSig6(ARGTYPE_##r, ARGTYPE_##a1, ARGTYPE_##a2,         \
                              ARGTYPE_##a3, ARGTYPE_##a4, ARGTYPE_##a5,        \
                              ARGTYPE_##a6)
#define SIG7(r, a1, a2, a3, a4, a5, a6, a7)                                    \
  nanojit::CallInfo::typeSig7(ARGTYPE_##r, ARGTYPE_##a1, ARGTYPE_##a2,         \
                              ARGTYPE_##a3, ARGTYPE_##a4, ARGTYPE_##a5,        \
                              ARGTYPE_##a6, ARGTYPE_##a7)
#define SIG8(r, a1, a2, a3, a4, a5, a6, a7, a8)                                \
  nanojit::CallInfo::typeSig8(ARGTYPE_##r, ARGTYPE_##a1, ARGTYPE_##a2,         \
                              ARGTYPE_##a3, ARGTYPE_##a4, ARGTYPE_##a5,        \
                              ARGTYPE_##a6, ARGTYPE_##a7, ARGTYPE_##a8)
