...
public:
  REALLY_INLINE static E4XNodeAux *create(MMgc::GC *gc, Stringp name,
                                          Namespace *ns,
...
public:
  REALLY_INLINE static TextE4XNode *create(MMgc::GC *gc, E4XNode *parent,
                                           String *value) {
...
public:
  REALLY_INLINE static CommentE4XNode *create(MMgc::GC *gc, E4XNode *parent,
                                              String *value) {
...
public:
  REALLY_INLINE static AttributeE4XNode *create(MMgc::GC *gc, E4XNode *parent,
                                                String *value) {
...
public:
  REALLY_INLINE static CDATAE4XNode *create(MMgc::GC *gc, E4XNode *parent,
                                            String *value) {
...
public:
  REALLY_INLINE static PIE4XNode *create(MMgc::GC *gc, E4XNode *parent,
                                         String *value) {
