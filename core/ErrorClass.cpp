...
namespace avmplus {
ErrorClass::ErrorClass(VTable *cvtable) : ClassClosure(cvtable) {
 ...
 * ErrorObject
 */
ErrorObject::ErrorObject(VTable *vtable, ScriptObject *delegate)
...
NativeErrorClass::NativeErrorClass(VTable *cvtable) : ClassClosure(cvtable) {
  AvmAssert(traits()->getSizeOfInstance() >= sizeof(ErrorClass));
