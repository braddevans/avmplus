...
enum ApiVersionSeries { kApiVersionSeries_AIR, kApiVersionSeries_FP };

enum { kApiVersionSeries_count = 2 };
...
extern ApiVersion const kApiVersionSeriesTransfer[kApiVersion_count]
