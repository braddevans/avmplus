...
REALLY_INLINE int32_t Multiname::isRtns() const { return flags & RTNS; }

REALLY_INLINE int32_t Multiname::isRtname() const { return flags & RTNAME; }

REALLY_INLINE int32_t Multiname::isQName() const { return flags & QNAME; }
...
REALLY_INLINE int32_t Multiname::isNsset() const { return flags & NSSET; }
...
REALLY_INLINE Stringp HeapMultiname::getName() const { return name.getName(); }
...
REALLY_INLINE int32_t HeapMultiname::ctFlags() const { return name.ctFlags(); }
...
REALLY_INLINE int32_t HeapMultiname::isRtns() const { return name.isRtns(); }

REALLY_INLINE int32_t HeapMultiname::isRtname() const {
  return name.isRtname();
}

REALLY_INLINE int32_t HeapMultiname::isQName() const { return name.isQName(); }
...
REALLY_INLINE int32_t HeapMultiname::isNsset() const { return name.isNsset(); }
