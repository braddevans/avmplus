...
public:
  REALLY_INLINE static MethodClosureClass *create(MMgc::GC *gc,
                                                  VTable *cvtable) {
...
public:
  REALLY_INLINE static MethodClosure *create(MMgc::GC *gc, VTable *vtable,
                                             MethodEnv *call, Atom savedThis) {
    return new (gc, MMgc::kExact, vtable->getExtraSize())
...
protected:
  ...
  create(MMgc::GC *gc, VTable *vtable, MethodEnv *call, Atom savedThis) {
    return new (gc, MMgc::kExact, vtable->getExtraSize())
