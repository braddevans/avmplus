...
public:
  ...
  */
  ...
  REALLY_INLINE Width getWidth() const {
    return Width(m_bitsAndFlags & TSTR_WIDTH_MASK);
  }
  /// Return the string type.
  REALLY_INLINE int32_t getType() const {
  ...
  */
   ...
   */
  int32_t FASTCALL Compare(String &other, int32_t other_start = 0,
                           int32_t other_length = 0) const;
  ...
  */
  int32_t FASTCALL indexOfLatin1(const char *p, int32_t len = -1,
                                 int32_t start = 0,
  ...
  @return                     the index of the found position, or -1 if no match
  */
  int32_t FASTCALL indexOfCharCode(wchar c, int32_t start = 0,
                                   int32_t end = 0x7FFFFFFF) const;
  /**
  Convenience method for old code (boolean result)
  */
  ...
  */
  REALLY_INLINE Stringp appendLatin1(const char *p) {
    return _append(NULL, Pointers((const uint8_t *)p), Length(p), k8);
  }
  REALLY_INLINE Stringp appendLatin1(const char *p, int32_t len) {
  ...
  */
  REALLY_INLINE Stringp append16(const wchar *p) {
    return _append(NULL, Pointers(p), Length(p), k16);
  }
  REALLY_INLINE Stringp append16(const wchar *p, int32_t len) {
...
private:
  ...
  */
  ...
  REALLY_INLINE int32_t getCharsLeft() const {
