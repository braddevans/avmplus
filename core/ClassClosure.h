...
private:
  ...
  checkForRestrictedInheritance(VTable *ivtable, CreateInstanceProc p);
...
public:
  ...
  cantInstantiateCreateInstanceProc(ClassClosure *cls);
  static ScriptObject *FASTCALL impossibleCreateInstanceProc(ClassClosure *cls);

private:
  static ScriptObject *FASTCALL
  reinitNullPrototypeCreateInstanceProc(ClassClosure *cls);
