...
private:
  ...
  MethodInfo(int32_t _method_id, PoolObject *pool, const uint8_t *abc_info_pos,
             uint8_t abcFlags, const NativeMethodInfo *native_info);
...
public:
  REALLY_INLINE static MethodInfo *create(MMgc::GC *gc, int32_t _method_id,
                                          PoolObject *pool,
...
public:
  Stringp FASTCALL getMethodNameWithTraits(
      Traits *declaringTraits, bool includeAllNamespaces = false) const;
...
public:
  REALLY_INLINE static MethodSignature *create(MMgc::GC *gc, size_t extra,
                                               int32_t param_count) {
