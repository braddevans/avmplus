...
const char *const kApiVersionNames[kApiVersion_count] = {
    "VM_ALLVERSIONS", "AIR_1_0", "FP_10_0", "AIR_1_5", "AIR_1_5_1",
    "FP_10_0_32", "AIR_1_5_2", "FP_10_1", "AIR_2_0", "AIR_2_5", "FP_10_2",
    "AIR_2_6", "SWF_12", "AIR_2_7", "SWF_13", "AIR_3_0", "SWF_14", "AIR_3_1",
    "SWF_15", "AIR_3_2", "SWF_16", "AIR_3_3", "SWF_17", "AIR_3_4", "SWF_18",
    "AIR_3_5", "SWF_19", "AIR_3_6", "SWF_20", "AIR_3_7", "SWF_21", "AIR_3_8",
    "SWF_22", "AIR_3_9", "SWF_23", "AIR_4_0", "SWF_24", "AIR_13_0", "SWF_25",
    "AIR_14_0", "SWF_26", "AIR_15_0", "SWF_27", "AIR_16_0", "SWF_28",
    "AIR_17_0", "SWF_29", "AIR_18_0", "SWF_30", "AIR_19_0", "SWF_31",
    "AIR_20_0",
...
uint32_t const kApiVersionSeriesMembership[kApiVersion_count] = {
    ...
    (1 << kApiVersionSeries_AIR), (1 << kApiVersionSeries_FP),
    (1 << kApiVersionSeries_AIR), (1 << kApiVersionSeries_AIR),
    (1 << kApiVersionSeries_FP), (1 << kApiVersionSeries_AIR),
    (1 << kApiVersionSeries_FP), (1 << kApiVersionSeries_AIR),
    (1 << kApiVersionSeries_AIR), (1 << kApiVersionSeries_FP),
    (1 << kApiVersionSeries_AIR), (1 << kApiVersionSeries_FP),
    (1 << kApiVersionSeries_AIR), (1 << kApiVersionSeries_FP),
...
// If a version is in an inactive series, what is the closest superset in the
// active series?
ApiVersion const
    kApiVersionSeriesTransfer[kApiVersion_count][kApiVersionSeries_count] = {
        {kApiVersion_VM_ALLVERSIONS,
         kApiVersion_VM_ALLVERSIONS},                     // VM_ALLVERSIONS
        ...
        {kApiVersion_AIR_20_0, kApiVersion_SWF_31},       // SWF_31
        {kApiVersion_AIR_20_0, kApiVersion_VM_INTERNAL},  // AIR_20_0
        // ADD_PREVIOUS_2_VERSIONED_LINES
        {kApiVersion_VM_INTERNAL, kApiVersion_VM_INTERNAL} // VM_INTERNAL
};

ApiVersion const kApiVersionFirst[kApiVersionSeries_count] = {
    kApiVersion_AIR_1_0, kApiVersion_FP_10_0};

ApiVersion const kApiVersionLatest[kApiVersionSeries_count] = {
    kApiVersion_AIR_20_0, kApiVersion_SWF_31
