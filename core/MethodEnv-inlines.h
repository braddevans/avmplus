...
REALLY_INLINE MethodEnv *MethodEnv::create(MMgc::GC *gc, MethodInfo *method,
                                           ScopeChain *scope) {
  return new (gc, MMgc::kExact) MethodEnv(method, scope);
}

REALLY_INLINE AbcEnv *MethodEnv::abcEnv() const { return _scope->abcEnv(); }
...
// elimination
REALLY_INLINE AvmCore *MethodEnv::core() const { return method->pool()->core; }
#endif
...
// Avoid premature inlining for GO AOT; it prevents LLVM constant subexpression
// elimination
REALLY_INLINE ScopeChain *MethodEnv::scope() const { return _scope; }
#endif
...
// Avoid premature inlining for GO AOT; it prevents LLVM constant subexpression
// elimination
REALLY_INLINE VTable *MethodEnv::vtable() const { return _scope->vtable(); }
#endif
