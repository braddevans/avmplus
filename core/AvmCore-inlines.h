...
REALLY_INLINE DomainMgr *AvmCore::domainMgr() const { return m_domainMgr; }
...
REALLY_INLINE QCache *AvmCore::tbCache() { return m_tbCache; }

REALLY_INLINE QCache *AvmCore::tmCache() { return m_tmCache; }

REALLY_INLINE QCache *AvmCore::msCache() { return m_msCache; }
...
REALLY_INLINE /*static*/ Binding AvmCore::makeSlotBinding(uintptr_t id,
                                                          BindingKind kind) {
  AvmAssert(kind == BKIND_VAR || kind == BKIND_CONST);
  return Binding((id << 3) | kind);
}

REALLY_INLINE /*static*/ Binding AvmCore::makeMGSBinding(uintptr_t id,
                                                         BindingKind kind) {
...
REALLY_INLINE /*static*/ bool AvmCore::isNumeric(Atom atom) {
  ...
  return isNumber(atom) || (((uintptr_t)atom > (uintptr_t)trueAtom) &&
...
REALLY_INLINE ScriptObject *AvmCore::newObject(VTable *vtable,
...
REALLY_INLINE /*static*/ bool AvmCore::atomDoesNotNeedCoerce(Atom a,
                                                             BuiltinType bt) {
...
REALLY_INLINE /*static*/ bool AvmCore::getIndexFromAtom(Atom a,
                                                        uint32_t *result) {
...
REALLY_INLINE Isolate *AvmCore::getIsolate() const { return m_isolate; }
