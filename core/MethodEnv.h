...
public:
  ...
  void initproperty(Atom obj, const Multiname *multiname, Atom value,
                    VTable *vtable) const;
...
public:
  REALLY_INLINE static ScriptEnv *create(MMgc::GC *gc, MethodInfo *_method,
                                         ScopeChain *_scope) {
...
public:
  REALLY_INLINE static FunctionEnv *create(MMgc::GC *gc, MethodInfo *_method,
                                           ScopeChain *_scope) {
