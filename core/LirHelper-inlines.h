...
REALLY_INLINE LIns *LirHelper::InsConst(int32_t c, bool blind) {
  return lirout->insImmI(c, blind);
}
...
REALLY_INLINE LIns *LirHelper::InsConstAtom(Atom c, bool blind) {
  return lirout->insImmP((void *)c, blind);
}

REALLY_INLINE LIns *LirHelper::i2p(LIns *i) { return lirout->insI2P(i); }

REALLY_INLINE LIns *LirHelper::ui2p(LIns *i) { return lirout->insUI2P(i); }
...
REALLY_INLINE LIns *LirHelper::eqp0(LIns *ptr) { return lirout->insEqP_0(ptr); }

REALLY_INLINE LIns *LirHelper::eqi0(LIns *ptr) { return lirout->insEqI_0(ptr); }
...
REALLY_INLINE LIns *LirHelper::label() { return lirout->ins0(LIR_label); }
...
REALLY_INLINE LIns *LirHelper::std(LIns *val, LIns *p, int32_t d,
                                   AccSet accSet) {
  AvmAssert(val->isD());
...
REALLY_INLINE LIns *LirHelper::InsConstDbl(double d, bool blind) {
