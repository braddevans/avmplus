...
template <class OBJ> class TypedVectorClass : public TypedVectorClassBase {
...
public:
  REALLY_INLINE static DoubleVectorClass *create(MMgc::GC *gc,
                                                 VTable *cvtable) {
    return new (gc, MMgc::kExact, cvtable->getExtraSize())
...
public:
  REALLY_INLINE static ObjectVectorClass *create(MMgc::GC *gc,
                                                 VTable *cvtable) {
    return new (gc, MMgc::kExact, cvtable->getExtraSize())
...
template <class T> struct TypedVectorConstants {
  static T nullValue();
...
protected:
  Atom _mapImpl(ScriptObject *callback, Atom thisObject, VectorBaseObject *r,
                uint32_t len);
  Atom _filterImpl(ScriptObject *callback, Atom thisObject, VectorBaseObject *r,
                   uint32_t len);
...
template <class TLIST> class TypedVectorObject : public VectorBaseObject {
...
// only on the stack.
template <class TLIST, uintptr_t align = 0> class VectorAccessor {
public:
...
public:
  REALLY_INLINE static IntVectorObject *create(MMgc::GC *gc, VTable *ivtable,
...
public:
  REALLY_INLINE static UIntVectorObject *create(MMgc::GC *gc, VTable *ivtable,
                                                ScriptObject *delegate) {
    return new (gc, MMgc::kExact, ivtable->getExtraSize())
...
public:
  REALLY_INLINE static DoubleVectorObject *create(MMgc::GC *gc, VTable *ivtable,
                                                  ScriptObject *delegate) {
    return new (gc, MMgc::kExact, ivtable->getExtraSize())
...
public:
  REALLY_INLINE static ObjectVectorObject *create(MMgc::GC *gc, VTable *ivtable,
                                                  ScriptObject *delegate) {
    return new (gc, MMgc::kExact, ivtable->getExtraSize())
