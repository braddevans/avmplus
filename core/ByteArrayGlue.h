...
public:
  ...
  REALLY_INLINE uint8_t operator[](uint32_t index) const {
...
public:
  ...
  //
  REALLY_INLINE const uint8_t *GetReadableBuffer() const {
  ...
  enum CompressionAlgorithm { k_zlib, k_deflate, k_lzma };
