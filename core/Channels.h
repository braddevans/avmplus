 ...
 */
template <class BUFFER> class BlockingChannel : public FixedHeapRCObject {
public:
  BlockingChannel();
  ~BlockingChannel();
 ...
 * atomic updates.
 */
template <class BUFFER> class NonBlockingChannel : public FixedHeapRCObject {
public:
 ...
 *   void gc()               -- returns GC the channel content is registered
 * with
 */
class PromiseChannel : public PromiseChannelImpl {
  // The buffer can contain a pointer that the GC of the sender should know
  // about.
