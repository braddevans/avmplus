...
REALLY_INLINE uintptr_t _AvmThunkUnbox_AvmReceiver(MethodEnv *env,
                                                   uintptr_t r) {
...
REALLY_INLINE uintptr_t _AvmThunkUnbox_AvmAtomReceiver(MethodEnv *env,
                                                       uintptr_t r) {
...
private:
  ...
  REALLY_INLINE const NativeMethodInfo *get_method(uint32_t i) const {
