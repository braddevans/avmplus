...
public:
  ObjectOutputObject(VTable *vtable, GCRef<ScriptObject> delegate)
...
public:
  ObjectInputObject(VTable *vtable, GCRef<ScriptObject> delegate)
      : ScriptObject(vtable, delegate) {}
...
public:
  DynamicPropertyOutputObject(VTable *vtable, GCRef<ScriptObject> delegate)
      : ScriptObject(vtable, delegate) {
    m_out = NULL;
  }
