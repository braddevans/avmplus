 ...
 */
    ...
    public:
        ...
        //  specialization.
        template<class T> REALLY_INLINE GCRef<T>

        GetThisRef(const T *ths) const {
 ...
 */
    ...
    REALLY_INLINE GCWeakRef
    *

    GCObject::GetWeakRef() const {
    ...
    *
    ...
    GCTraceableObject::GetWeakRef() const {
        return GC::GetWeakRef(this);
    }
    ...
    *
    ...
    GCFinalizedObject::GetWeakRef() const {
        return GC::GetWeakRef(this);
    }
 ...
 */
    ...
    public:
        ...
        RefCount() const { return (composite & RCBITS) - 1; }
        ...
        Sticky() const { return composite & STICKYFLAG; }
