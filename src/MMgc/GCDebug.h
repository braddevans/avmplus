...
#define GCAssert(condition) _GCAssert((condition), __LINE__, __FILE__)

#define _GCAssert(condition, line_, file_) __GCAssert((condition), line_, file_)

#define __GCAssert(condition, line_, file_)                                    \
  do {                                                                         \
    GCAssertMsg((condition), "Assertion failed: \"" #condition "\" (" #file_   \
                             ":" #line_ ")\n");                                \
  } while (0)
