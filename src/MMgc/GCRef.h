...
//  GCRef Definition
        ...
        protected:
            ...
            *
            ...
            ProtectedGetOtherRawPtr(const GCRef<T2> &other) {
                return other.t;
            }
        ...
        public:
            ...
            *
            ...
            template<class T2> REALLY_INLINE GCRef
            &

            operator=(const GCRef<T2> &other);
            ...
            template<class T2> REALLY_INLINE GCRef<T2>
