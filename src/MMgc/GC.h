 ...
 */
    enum DependentMemoryType {
        typeByteArray, typeUnknown, typeCount
    };
 ...
 */
    ...
    public:
         ...
         */
        enum {
            GCV_COREPLAYER, GCV_AVMCORE, GCV_COUNT
        };
...
#define AllocFloat4 AllocBibopType<avmplus::AtomConstants::kBibopFloat4Type>
    ...
    private:
        ...
        WriteBarrier(const void *address, const void *value);

        static void FASTCALL

        WriteBarrierRC(const void *address, const void *value);

        // Optimized version that ignores the value at address, it must be NULL.
        static void FASTCALL

        WriteBarrierRC_ctor(const void *address,
                            const void *value);
    ...
    public:
        ...
        WriteBarrierRC_dtor(const void *address);
    ...
    private:
        ...
        void TraceConservativePointer(
                uintptr_t val, bool handleInteriorPtrs HEAP_GRAPH_ARG(uintptr_t
