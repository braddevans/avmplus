...
// -----------------------------------------
    ...
    template<class T>
    REALLY_INLINE GCRoot::GCMember<T>::GCMember() : GCRef<T>() {
        GCAssert(!IsAddressOnStack(this));
    }
    ...
    template<class T>
    REALLY_INLINE GCRoot::GCMember<T>::~GCMember() { set(NULL); }
