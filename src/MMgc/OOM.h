...
namespace MMgc {
    ...
    public:
        ...
        //  It is the caller's responsibility to make sure the AbortUnwindObject has
        //  not already been added to this list This method is not thread safe.
        void AddAbortUnwindObject(AbortUnwindObject *obj);

        //  It is the caller's responsibility to make sure the AbortUnwindObject has
        //  previously been added to the list This method is not thread safe.
