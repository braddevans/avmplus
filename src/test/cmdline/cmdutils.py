...
class RunTestLib:
    ...
    def run_test(self, name, command=None, cwd=None, input=None, expectedout=None, expectederr=None, expectedcode=None,
                 actualcode=None, actualout=None, actualerr=None):
        if command != None:
