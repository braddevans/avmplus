...
// High ASCII test
var xmlHighASCII = "<f><fname>S�ren Lehmenk�hler</fname></f>";

Assert.expectEq("High ASCII node value:", "S�ren Lehmenk�hler", (o = new XML(xmlHighASCII), o.fname.toString()));
...
Assert.expectEq("XMLList[1] = <a>b</a>; XMLList[0] = <c>d</c>", "d", (ol = new XMLList(), ol[1] = <a>b</a>, ol[0] =
    <c>d</c>, ol.toString()));

Assert.expectEq("XMLList[0] = <a>b</a>; XMLList[1] = <c>d</c>", convertToString(new XMLList("<a>b</a><c>d</c>")), (ol = new XMLList(), ol[0] =
    <a>b</a>, ol[1] = <c>d</c>, ol).toString());
