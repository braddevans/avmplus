...
Assert.expectEq("new XML(\"<unterminated><terminated>text</terminated>\")", expected, result);
...
Assert.expectEq("new XML(\"<unterminated><terminated>text</terminated></unterm>\")", expected, result);
