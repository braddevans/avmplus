...
Assert.expectEq("MYXML = new XML(xmlDoc),MYXML.valueOf() === MYXML",
    true,
    (MYXML.valueOf() === MYXML));
MYXML = new XML();
Assert.expectEq("MYXML = new XML(),MYXML.valueOf() === MYXML",
    true,
    (MYXML.valueOf() === MYXML));
MYXML = new XML('');
Assert.expectEq("MYXML = new XML(''),MYXML.valueOf() === MYXML",
    ...
    (MYXML.valueOf() === MYXML));
MYXML = new XML('foo');
Assert.expectEq("MYXML = new XML('foo'),MYXML.valueOf() === MYXML",
    true,
    (MYXML.valueOf() === MYXML));
