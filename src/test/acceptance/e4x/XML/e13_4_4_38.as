...
XML.prettyPrinting = false;
Assert.expectEq("MYXML = new XML(xmlDoc), MYXML.employee[0].toString()",
...
Assert.expectEq("MYXML = new XML(xmlDoc), MYXML.employee[1].toString()",
...
Assert.expectEq("MYXML = new XML(xmlDoc), MYXML.employee[0].firstname.toString()",
    "John",
    (MYXML = new XML(xmlDoc), MYXML.employee[0].firstname.toString()));

Assert.expectEq("MYXML = new XML(xmlDoc), MYXML.employee[1].firstname.toString()",
    "Sue",
...
Assert.expectEq("MYXML = new XML(xmlDoc), MYXML.toString()",
    "foo",
