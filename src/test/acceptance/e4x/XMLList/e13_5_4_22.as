...
Assert.expectEq("MYXML = new XMLList(xmlDoc),MYXML.valueOf() === MYXML",
    true,
    (MYXML.valueOf() === MYXML));
MYXML = new XMLList();
Assert.expectEq("MYXML = new XMLList(),MYXML.valueOf() === MYXML",
    true,
    (MYXML.valueOf() === MYXML));
MYXML = new XMLList('');
Assert.expectEq("MYXML = new XMLList(''),MYXML.valueOf() === MYXML",
...
Assert.expectEq("MYXML = new XMLList('foo'),MYXML.valueOf() === MYXML",
    true,
    (MYXML.valueOf() === MYXML));
