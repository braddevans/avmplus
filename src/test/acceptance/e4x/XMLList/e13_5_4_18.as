...
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.propertyIsEnumerable(0)", true,
    (MYXML = new XMLList(xmlDoc), MYXML.propertyIsEnumerable('0')));
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.propertyIsEnumerable(1)", true,
    (MYXML = new XMLList(xmlDoc), MYXML.propertyIsEnumerable('1')));
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.propertyIsEnumerable(2)", false,
    (MYXML = new XMLList(xmlDoc), MYXML.propertyIsEnumerable('2')));
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.propertyIsEnumerable('employee')", false,
