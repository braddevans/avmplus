...
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.elements('Team').toString()", "<Team>Giants</Team>" + NL() + "<Team>Padres</Team>",
    (MYXML = new XMLList(xmlDoc), MYXML.elements('Team').toString()));

Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.elements('TEAM').toString()", "",
    (MYXML = new XMLList(xmlDoc), MYXML.elements('TEAM').toString()));

Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.elements('bogus').toString()", "",
    (MYXML = new XMLList(xmlDoc), MYXML.elements('bogus').toString()));

Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.elements()", "<Team>Giants</Team>" + NL() + "<City>San Francisco</City>" + NL() + "<Team>Padres</Team>" + NL() + "<City>San Diego</City>",
    (MYXML = new XMLList(xmlDoc), MYXML.elements().toString()));

xmlDoc = "<MLB><Team>Giants</Team><City>San Francisco</City></MLB>";

Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.elements('City').toString()", "San Francisco",
...
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.elements('MLB')", "<MLB>" + NL() + "  <Team>Giants</Team>" + NL() + "  <City>San Francisco</City>" + NL() + "  <Team>Padres</Team>" + NL() + "  <City>San Diego</City>" + NL() + "</MLB>",
