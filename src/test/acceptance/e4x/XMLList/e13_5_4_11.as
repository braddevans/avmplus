...
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.hasOwnProperty('copy')", false,
    (MYXML = new XMLList(xmlDoc), MYXML.hasOwnProperty('copy')));
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.hasOwnProperty('hasSimpleContent')", false,
...
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.hasOwnProperty('firstname')", true,
    (MYXML = new XMLList(xmlDoc), MYXML.hasOwnProperty('firstname')));
Assert.expectEq("MYXML = new XMLList(xmlDoc), MYXML.hasOwnProperty('lastname')", true,
