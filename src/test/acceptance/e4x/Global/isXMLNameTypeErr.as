...
Assert.expectEq("var object1 = { toString: function() { return this; } }; isXMLName(object1)", expected, result);
...
try {
    ...
    Utils.grabError(e2, e2.toString());

}


Assert.expectEq("var object2 = { toString: function() { return String(object1); } }; isXMLName(object2)", expected, result);
