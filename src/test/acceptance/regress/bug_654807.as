...
function run_tests(b: Array, mode: String) {
    ...
    MyTestCase(mode + " shift",
        ...
        function () {
            var r = b.shift();
            return String(r) + ":" + String(b.concat());
        });
    ...
    MyTestCase(mode + " filter",
        ...
        function () {
            return String(b.filter(function (i) {
                return i != 1;
            }));
        });
    ...
    MyTestCase(mode + " forEach",
        ...
        function () {
            return String(b.forEach(function (i) {
            }));
        });
    ...
    MyTestCase(mode + " some",
        ...
        function () {
            return String(b.some(function (i) {
                return true
            }));
        });
    ...
    MyTestCase(mode + " map",
        ...
        function () {
            return String(b.map(function (i) {
                return i + 1
            }));
        });
