...
var testnum = 1;
Assert.expectError(testnum++, "TypeError: Error #1007", function () {
    var a = 1;
    new a.foo();
});
Assert.expectError(testnum++, "TypeError: Error #1007", function () {
...
Assert.expectError(testnum++, "TypeError: Error #1009", function () {
    var a = null;
    new a.foo();
});
Assert.expectError(testnum++, "TypeError: Error #1010", function () {
    var a = undefined;
    new a.foo();
});
