...
function apply_alikes(f) {
    ...
    var i = 1;
    all_arraylike[1].map(f);
    i += 2; // array
    if (i >= all_arraylike.length) return;
    all_arraylike[3].map(f);
    i += 2; // subclass of array
    if (i >= all_arraylike.length) return;
    all_arraylike[5].map(f);
    i += 2; // vector
    if (i >= all_arraylike.length) return;
    all_arraylike[7].map(f);
    i += 2; // bytearray
    if (i >= all_arraylike.length) return;
    all_arraylike[9].map(f);
    i += 2; // object with length
}
...
function reset() {
    ...
    if (testing_bytearray) {
        ...
        bzero = pushlike(new ByteArray());
        bzero.length = 0;
        bfive = pushlike(new ByteArray());
        bfive.length = 5;
...
function alternating_lengths(arr) {
    ...
    for (var i = 0; i < arr.length; i += 2) {
        ...
        result.push(name);
        result = result.concat(arraylikes.map(function (a) {
            return a.length;
        }))
    }
...
test_arrays("length direct 1K", function (a) {
        a.length = 1000;
    },
    "arrays:,1000,1000,1000,1000,1000",
    "subarrays:,1000,1000,1000,1000,1000");

test_arrays("length indirect 1K", function (a) {
        a["length"] = 1000
    },
    "arrays:,1000,1000,1000,1000,1000",
    "subarrays:,1000,1000,1000,1000,1000");

test_arrays("length direct wrap", function (a) {
        a.length = uint.MAX_VALUE + 2;
    },
    "arrays:,1,1,1,1,1",
    "subarrays:,1,1,1,1,1");

test_arrays("length indirect wrap", function (a) {
        a["length"] = uint.MAX_VALUE + 2;
    },
    "arrays:,1,1,1,1,1",
    "subarrays:,1,1,1,1,1");

test_arrays("pub pop arrays", function (a) {
        a.public::pop();
    },
    "arrays:,0,4,4294967294,4294967292,4294967289",
    "subarrays:,0,4,4294967294,4294967292,4294967289");

test_arrays("AS3 pop arrays", function (a) {
        a.AS3::pop();
    },
    "arrays:,0,4,4294967294,4294967292,4294967289",
    "subarrays:,0,4,4294967294,4294967292,4294967289");
...
test_arraylikes("pub pop alikes",
    function (a) {
        Array.prototype.public::pop.call(a);
    },
    "arrays:,0,4,4294967294,4294967292,4294967289",
    "subarrays:,0,4,4294967294,4294967292,4294967289",
    "vectors:,0,4",
...
if (false /*|| System.swfVersion >= 15*/) {
    test_arrays("pub push arrays", function (a) {
            a.public::push(1, 2, 3, 4, 5);
        },
...
test_arrays("AS3 push arrays", function (a) {
        a.AS3::push(1, 2, 3, 4, 5);
    },
    "arrays:,5,10,4294967295,4294967295,4294967295",
    "subarrays:,5,10,4294967295,4294967295,4294967295");
...
test_arrays("pub shift arrays", function (a) {
        a.public::shift();
    },
    "arrays:,0,4,4294967294,4294967292,4294967289",
    "subarrays:,0,4,4294967294,4294967292,4294967289");

test_arrays("AS3 shift arrays", function (a) {
        a.AS3::shift();
    },
    "arrays:,0,4,4294967294,4294967292,4294967289",
    "subarrays:,0,4,4294967294,4294967292,4294967289");
...
if (false /*|| System.swfVersion >= 15*/) {
    test_arrays("pub unshift arrays", function (a) {
            a.public::unshift(1, 2, 3, 4, 5);
        },
        "arrays:,5,10,4294967295,4294967295,4294967295",
        "subarrays:,5,10,4294967295,4294967295,4294967295");
} else {
...
// uncomment (and remove "false ||") when Bugzilla 685323 fixed
if (false /*|| System.swfVersion >= 15*/) {
    test_arrays("AS3 unshift arrays", function (a) {
            a.AS3::unshift(1, 2, 3, 4, 5);
        },
        "arrays:,5,10,4294967295,4294967295,4294967295",
        "subarrays:,5,10,4294967295,4294967295,4294967295")
} else {
