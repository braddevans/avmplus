...
public class Test implements ITest {
    ...
    public function get vo(): Vector.<Object> {
        return _vo;
    }

    public function get vs(): Vector.<String> {
        return _vs;
    }

    public function get vc(): Vector.<C> {
        return _vc;
    }

    public function get vi(): Vector.<int> {
        return _vi;
    }

    public function get va(): Vector.<*> {
        return _va;
    }
