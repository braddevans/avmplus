...
function Test(index, expected_r, expected_w) {
...
if (System.swfVersion >= 11) {
    ...
    Test(3, RANGE, RANGE);
    Test("3", RANGE, RANGE);
    Test(3.0, RANGE, RANGE);
    Test("3.0", RANGE, RANGE);

    Test(3.14, RANGE, RANGE);
    Test("3.14", RANGE, RANGE);
    ...
    Test("foo", REFERENCE, REFERENCE);  // "foo" undefined in prototype
    Test("bar", NONE, REFERENCE);  // "bar" defined in prototype
    ...
    Test(max_uint_p1, RANGE, RANGE);
    Test(max_uint, RANGE, RANGE);
    Test(max_uint_m1, RANGE, RANGE);

    Test(max_int_p1, RANGE, RANGE);
    Test(max_int, RANGE, RANGE);
    Test(max_int_m1, RANGE, RANGE);

    Test(max_int28_p1, RANGE, RANGE);
    Test(max_int28, RANGE, RANGE);
    Test(max_int28_m1, RANGE, RANGE);

    Test(min_int_p1, RANGE, RANGE);
    Test(min_int, RANGE, RANGE);
    Test(min_int_m1, RANGE, RANGE);
