...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("new String(\"string\") === new String(\"string\")", true, String("string") === String("string"));
    array[item++] = Assert.expectEq("new String(\"string\") === \"string\"", true, String("string") === "string");
    ...
    array[item++] = Assert.expectEq("new Boolean(true) === true", true, true === Boolean(true));
    array[item++] = Assert.expectEq("new MyObject(true) === true", false, true === new MyObject(true));

    array[item++] = Assert.expectEq("new Boolean(false) === false", true, Boolean(false) === false);
    array[item++] = Assert.expectEq("new MyObject(false) === false", false, new MyObject(false) === false);

    array[item++] = Assert.expectEq("true === new Boolean(true)", true, true === Boolean(true));
    array[item++] = Assert.expectEq("true === new MyObject(true)", false, true === new MyObject(true));

    array[item++] = Assert.expectEq("false === new Boolean(false)", true, false === Boolean(false));
