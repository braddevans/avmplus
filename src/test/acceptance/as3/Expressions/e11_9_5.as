...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("new Boolean(true) !== new Boolean(true)", false, Boolean(true) !== Boolean(true));
    array[item++] = Assert.expectEq("new Boolean(false) !== new Boolean(false)", false, Boolean(false) !== Boolean(false));

    x = new MyObject(true);
    y = x;
    z = x;
    array[item++] = Assert.expectEq("x = new MyObject(true); y = x; z = x; z !== y", false, z !== y);
    x = new MyObject(false);
    y = x;
    z = x;
    ...
    array[item++] = Assert.expectEq("new String(\"string\") !== new String(\"string\")", false, String("string") !== String("string"));
    array[item++] = Assert.expectEq("new String(\"string\") !== \"string\"", false, String("string") !== "string");
    ...
    array[item++] = Assert.expectEq("new Boolean(true) !== true", false, true !== Boolean(true));
    array[item++] = Assert.expectEq("new MyObject(true) !== true", true, true !== new MyObject(true));

    array[item++] = Assert.expectEq("new Boolean(false) !== false", false, Boolean(false) !== false);
    array[item++] = Assert.expectEq("new MyObject(false) !== false", true, new MyObject(false) !== false);

    array[item++] = Assert.expectEq("true !== new Boolean(true)", false, true !== Boolean(true));
    array[item++] = Assert.expectEq("true !== new MyObject(true)", true, true !== new MyObject(true));

    array[item++] = Assert.expectEq("false !== new Boolean(false)", false, false !== Boolean(false));
