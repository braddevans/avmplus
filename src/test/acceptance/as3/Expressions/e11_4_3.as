...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("typeof(new Boolean(true))", "boolean", typeof (Boolean(true)));
    ...
    array[item++] = Assert.expectEq("typeof(new Array(1,2,3))", "object", typeof ([1, 2, 3]));
    array[item++] = Assert.expectEq("typeof(new String('string object'))", "string", typeof (String("string object")));
