...
public class Attrs {
    ...
    function getPubStatVar() {
        return pubStatVar;
    }

    function getPrivStatVar() {
        return privStatVar;
    }

    function getStatPubVar() {
        return statPubVar;
    }

    function getStatPrivVar() {
        return statPrivVar;
    }
    ...
    public static function pubStatFunc() {
        return "func, public static ";
    }

    private static function privStatFunc() {
        return "func, private static";
    }

    static public function statPubFunc() {
        return "func, static public ";
    }

    static private function statPrivFunc() {
        return "func, static private";
    }

    function getStatFunc() {
        return statFunc();
    }

    function getPubStatFunc() {
        return pubStatFunc();
    }

    function getPrivStatFunc() {
        return privStatFunc();
    }

    function getStatPubFunc() {
        return statPubFunc();
    }

    function getStatPrivFunc() {
        return statPrivFunc();
    }
}
}
