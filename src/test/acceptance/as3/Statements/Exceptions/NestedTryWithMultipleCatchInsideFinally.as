...
try {
    ...
    Assert.expectEq("Testing Nested try block with multiple catch block inside the finally block of the outer try block", "This is outer finally:This is outer reference error:ReferenceError", "This is outer finally:" + thisError1);
    try {
        throw new TypeError();
    } catch (ei: TypeError) {
        ...
        Assert.expectEq("Testing Nested try block with multiple catch block inside the finally block of the inner try block", "This is inner finally:This is Inner Type Error:TypeError", "This is inner finally:" + thisError);
    }
}
