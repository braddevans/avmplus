...
try {
    ...
    try {
        ...
        Assert.expectEq("Testing Nested try block with multiple catch block inside the first catch block of the outer try block", "This is inner finally:This is Inner Type Error:TypeError", "This is inner finally:" + thisError);
    }
} catch (eo1: TypeError) {
