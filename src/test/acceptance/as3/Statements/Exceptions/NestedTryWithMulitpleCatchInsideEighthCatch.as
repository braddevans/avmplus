...
try {
    ...
    try {
        ...
        Assert.expectEq("Testing Nested try block with multiple catch block inside the eighth catch block of the outer try block", "This is inner finally:This is Inner Type Error:TypeError", "This is inner finally:" + thisError);
    }
} finally {
    Assert.expectEq("Testing Nested try block with multiple catch block inside the eighth catch block of the outer try block", "This is outer finally:This is outer Error:Error: This is an error", "This is outer finally:" + thisError1);
}
