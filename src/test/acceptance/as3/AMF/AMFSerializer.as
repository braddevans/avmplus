...
class UserDefClassAllTypes {
    ...
    public function Init(): void {
        ...
        //Number - Positive Value
        num_Positive_Obj = Number(100);
        //Number - Min Value
        num_Min_Obj = Number(Number.MIN_VALUE);
        //String - title case
        str_Title_Obj = String("A Quick Brown Fox Jumps Over A Lazy Dog");
        //Date - 18/07/2011 9:10:01:10 AM
        dt_Fixed_Obj = new Date(2011, 07, 18, 9, 10, 01, 10);
        //Array - Index : int Value: String
        arr_IntStr_Obj = ["TEST1", "TEST2", "TEST3", "TEST4"];
        //Array - Index : Mixed Value: Mixed
        arr_MixMix_Obj = [];
        ...
        xml_Obj = <employee>
            <name>XANDER</name>
            <id>xan007</id>
            <address>#5, Salarpuria Infinity, Bannerghatta Road, Bangalore</address>
        </employee>;
        //Vector int typed
...
dynamic class UserDefinedDynamicClass {
    ...
    public const strPubConstString: String = String("User Defined Dynamic Class Public Constant Variable");


    public function UserDefinedDynamicClass() {
        strPubString = String("User Defined Dynamic Class Public Variable");
        strPrivString = String("User Defined Dynamic Class Private Variable");
        strProtString = String("User Defined Dynamic Class Protected Variable");
    }
...
final class UserDefinedFinalClass {
    ...
    private var strPrivString: String;
    protected var strProtString: String;
    public const strPubConstString: String = String("User Defined Final Class Public Constant Variable");

    public function UserDefinedFinalClass() {
        // constructor code
        strPubString = String("User Defined Final Class Public Variable");
        strPrivString = String("User Defined Final Class Private Variable");
        strProtString = String("User Defined Final Class Protected Variable");
    }
...
//Number - Positive Value
var num_Positive_Obj: Number = Number(1234567890);
buildBAnCallAddTC("Num Positive", num_Positive_Obj);
//Number - Negative Value
var num_Negative_Obj: Number = Number(-1234567890);
buildBAnCallAddTC("Num Negative", num_Negative_Obj);

//String - title case
var str_Title_Obj: String = String("A Quick Brown Fox Jumps Over A Lazy Dog");
...
var xml_CmntCDATA_Obj: XML = <testfunc><![CDATA[function printAlert(a,b){alert "hello";}]]> <!-- name -->
    <name>SQUARE!!!!!</name>
</testfunc>
...
//Vector object typed
var obj_Test3: Object = {};
obj_Test3.value = "VALUE 1";
var obj_Test4: Object = {};
obj_Test4.value = "VALUE 2";
...
var obj_drcheck_Obj: Object = {};
var obj_drcheck1_Obj: Object = {};
...
var obj_dyn_Obj: Object = {};
var obj_level2_Obj: Object = {};
...
var arr_Rednt_Obj: Array = ["Adobe", "Adobe", "Test Adobe", "Test Adobe"];
ba_TestObject = new ByteArray();
