...
Assert.expectEq("Internal class extends Internal class that implements a internal interface with a public method", true, obj.pubFunc());

//Internal class extends internal class that implements a internal interface with a //namespace //method
Assert.expectEq("Internal class extends internal class that implements a internal interface with a namespace method", 4, obj.accnsFunc());
