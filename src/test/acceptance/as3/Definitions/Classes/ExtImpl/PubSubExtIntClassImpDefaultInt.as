...
//Assert.expectEq("Public class extends Internal class implements a default interface with a default method", //"PASSED", obj.accdeffunc());

//Public class extends Internal class implements a default interface with a public method
Assert.expectEq("Public class extends Internal class implements a default interface with a public method", false, obj.pubFunc());

//public class extends Internal class implements a default interface with a namespace method
Assert.expectEq("Public class extends Internal class implements a default interface with a namespace method", 4, obj.accnsFunc());
