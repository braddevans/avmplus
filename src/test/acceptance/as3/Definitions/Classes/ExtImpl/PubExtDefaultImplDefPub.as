...
Assert.expectEq("PUBEXTDEFIMPLDEFPUB.setPubBoolean(false), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()", false, (PUBEXTDEFIMPLDEFPUB.setPubBoolean(false), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()));
Assert.expectEq("PUBEXTDEFIMPLDEFPUB.setPubBoolean(true), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()", true, (PUBEXTDEFIMPLDEFPUB.setPubBoolean(true), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()));
