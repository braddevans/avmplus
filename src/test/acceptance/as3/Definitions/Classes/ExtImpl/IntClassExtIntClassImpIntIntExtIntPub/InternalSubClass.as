...
internal class InternalSuperClass {
    public function MySuperBoolean(): Boolean {
        return true;
    }

    internal function MySuperNumber(): Number {
        return 10;
    }

    public static function MySuperStaticDate(): Date {
        return new Date(0);
    }
...
internal class InternalSubClass extends InternalSuperClass implements PublicInt3 {
    ...
    public function RetMySuperNumber(): Number {
        return MySuperNumber();
    }

    public function RetMySuperBoolean(): Boolean {
        return MySuperBoolean();
    }

    public function RetMySuperStaticDate(): Date {
        return MySuperStaticDate();
    }
