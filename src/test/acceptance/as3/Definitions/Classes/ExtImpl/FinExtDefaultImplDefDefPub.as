...
Assert.expectEq("iGetBoolean", false, obj.acciiGetBoolean());
Assert.expectEq("iGetBoolean", false, obj.accjiGetBoolean());
Assert.expectEq("*** public method implemented interface ***", 2, 2);
Assert.expectEq("iGetPubNumber", 5, obj.acciGetPubNumber());
Assert.expectEq("iGetNumber", 5, obj.acciiGetNumber());
Assert.expectEq("iGetNumber", 5, obj.accjiGetNumber());
//*******************************************
