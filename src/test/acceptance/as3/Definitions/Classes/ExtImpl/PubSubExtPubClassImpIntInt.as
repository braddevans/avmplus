...
//Assert.expectEq("Public class extends Public class implements an internal interface with a //default method", "PASSED", obj.getdeffunc());

//Public class extends Public class implements an internal interface with a public method
Assert.expectEq("Public class extends Public class implements an internal interface with a public method", false, obj.pubFunc());

//Public class extends Public class implements an internal interface with a namespace method
Assert.expectEq("Public class extends Public class implements an internal interface with a namespace method", 4, obj.getnsFunc());
