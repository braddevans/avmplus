...
Assert.expectEq("Calling a method in public namespace in the public interface implemented  by the subclass through the subclass", "Good Morning!", PubInt.MyString());
...
Assert.expectEq("Calling a method in public namespace in the public interface implemented  by the subclass through the subclass", "Good Morning!", obj.MyString());
...
Assert.expectEq("Calling a method in public namespace in the public interface implemented  by the subclass through the subclass", "Good Morning!", obj.PublicInt2::MyString());
