...
Assert.expectEq("Default class implements the first public interface with an interface name method", "PASSED", obj.accdeffunc());
//Default class implements the second public interface with an interface name method
Assert.expectEq("Default class implements the second public interface with an interface name method", "PASSED", obj.accdeffunc_s());
