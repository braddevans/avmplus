...
Assert.expectEq("Final class implements the first public interface with an interface name method", "PASSED", obj.accdeffunc());
//Final class implements the second public interface with an interface name method
Assert.expectEq("Final class implements the second public interface with an interface name method", "PASSED", obj.accdeffunc_s());
