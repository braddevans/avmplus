...
Assert.expectEq("Public class implements the first public interface with an interface name method", "PASSED", obj.accdeffunc());
//Public class implements the second public interface with an interface name method
Assert.expectEq("Public class implements the second public interface with an interface name method", "PASSED", obj.accdeffunc());
