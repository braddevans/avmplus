...
Assert.expectEq("Public class implements the first default interface with an interface name method", "PASSED", c.accdeffunc());
//Public class implements the second default interface with an interface name method
Assert.expectEq("Public class implements the second default interface with an interface name method", "PASSED", c.accdeffunc_s());
