...
// *****************************
obj.getDate = function (): Date {
    return this.date;
}
Assert.expectEq("*** add the method to a dynamic object ***", 1, 1);
var year = 1969;
if (getTimeZoneDiff() >= 0) {
    var year = 1970;
}

Assert.expectEq("obj.getDate()", year, obj.getDate().getFullYear());
...
Assert.expectEq("*** try to extract the new method ***", 1, 1);
Assert.expectEq("obj.getDate() == mc()", null, mc());
