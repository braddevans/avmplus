...
dynamic class DynExtPublicClassFinInner extends PublicClass {
    ...
    private final function privFinSubSetArray(a: Array) {
        this.setFinArray(a);
    }
    ...
    private virtual function virPrivSubGetDPArray(): Array {
        return this.finArray;
    }

    private virtual function virPrivSubSetDPArray(a: Array) {
        this.finArray = a;
    }
