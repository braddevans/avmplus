...
public function statSubSetArray(a: Array) {
    FinExtDynamicClassPubStat.statSubSetArray(a);
}

public function statSubGetArray(): Array {
    return FinExtDynamicClassPubStat.statSubGetArray();
}
...
public function testPrivStatSubArray(a: Array): Array {
    return EXTDCLASS.testPrivStatSubArray(a);
}
...
public function statSubSetDPArray(a: Array) {
    FinExtDynamicClassPubStat.statSubSetDPArray(a);
}

public function statSubGetDPArray(): Array {
    return FinExtDynamicClassPubStat.statSubGetDPArray();
}
...
public function pubStatSubSetDPArray(a: Array) {
    FinExtDynamicClassPubStat.pubStatSubSetDPArray(a);
}

public function pubStatSubGetDPArray(): Array {
    return FinExtDynamicClassPubStat.pubStatSubGetDPArray();
}
