...
//Assert.expectEq( "PubExtDynamicClassStat.setStatArray(arr), PubExtDynamicClassStat.statArray", arr,
...
Assert.expectEq("PubExtDynamicClassStat.testStatSubArray(arr)", arr, PubExtDynamicClassStat.testStatSubArray(arr));
...
Assert.expectEq("PubExtDynamicClassStat.pubStatSubSetArray(arr), PubExtDynamicClassStat.pubStatSubGetArray()", arr,
...
Assert.expectEq("EXTCLASS.testPrivStatSubArray(arr)", arr, EXTCLASS.testPrivStatSubArray(arr));
...
Assert.expectEq("PubExtDynamicClassStat.testStatSubPArray(arr)", arr, PubExtDynamicClassStat.testStatSubPArray(arr));
...
Assert.expectEq("PubExtDynamicClassStat.pubStatSubSetSPArray(arr), PubExtDynamicClassStat.pubStatSubGetSPArray()", arr,
