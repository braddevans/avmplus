...
class DefaultProtClassInner {
    ...
    protected function setProtArray(a: Array) {
        protArray = a;
    }

    protected function setProtBoolean(b: Boolean) {
        protBoolean = b;
    }

    protected function setProtDate(d: Date) {
        protDate = d;
    }

    protected function setProtFunction(f: Function) {
        protFunction = f;
    }

    protected function setProtMath(m: Math) {
        protMath = m;
    }

    protected function setProtNumber(n: Number) {
        protNumber = n;
    }

    protected function setProtObject(o: Object) {
        protObject = o;
    }

    protected function setProtString(s: String) {
        protString = s;
    }

    //protected function setProtSimple( s:Simple ) { protSimple = s; }

    protected function getProtArray(): Array {
        return this.protArray;
    }

    protected function getProtBoolean(): Boolean {
        return this.protBoolean;
    }

    protected function getProtDate(): Date {
        return this.protDate;
    }

    protected function getProtFunction(): Function {
        return this.protFunction;
    }

    protected function getProtMath(): Math {
        return this.protMath;
    }

    protected function getProtNumber(): Number {
        return this.protNumber;
    }

    protected function getProtObject(): Object {
        return this.protObject;
    }

    protected function getProtString(): String {
    ...
    protected static function setProtStatArray(a: Array) {
        protStatArray = a;
    }

    protected static function setProtStatBoolean(b: Boolean) {
        protStatBoolean = b;
    }

    protected static function getProtStatArray() {
        return protStatArray;
    }
    ...
    protected function protOverLoad() {
        return "This is the parent class";
    }

    protected static function protStatOverLoad() {
        return "This is the parent class";
    }
}
