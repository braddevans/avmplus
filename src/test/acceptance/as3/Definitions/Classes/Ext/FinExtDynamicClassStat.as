...
Assert.expectEq("*** Access static method of parent class from outside of class ***", 1, 1);
// Assert.expectEq( "setStatArray(arr), getStatArray()", arr, ( setStatArray( arr ), getStatArray() ) );
