...
dynamic class DynExtDynamicClassFinInner extends DynamicClass {
    ...
    private final function finPrivSubSetArray(a: Array) {
        this.setFinArray(a);
    }
    ...
    public virtual function privVirSubGetDPArray(): Array {
        return finArray;
    }

    public virtual function privVirSubSetDPArray(a: Array) {
        finArray = a;
    }
