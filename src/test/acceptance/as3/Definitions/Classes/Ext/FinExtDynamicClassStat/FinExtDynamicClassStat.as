...
public function statSubSetArray(a: Array) {
    FinExtDynamicClassStat.statSubSetArray(a);
}

public function statSubGetArray(): Array {
    return FinExtDynamicClassStat.statSubGetArray();
}
...
public function testPrivStatSubArray(a: Array): Array {
    return FinExtDynamicClassStat.testPrivStatSubArray(a);
}


// The static method of the sub class.
public function finStatSubSetArray(a: Array) {
    FinExtDynamicClassStat.finStatSubSetArray(a);
}

public function finStatSubGetArray(): Array {
    return FinExtDynamicClassStat.finStatSubGetArray();
}
...
public function statSubSetDPArray(a: Array) {
    FinExtDynamicClassStat.statSubSetDPArray(a);
}

public function statSubGetDPArray(): Array {
    return FinExtDynamicClassStat.statSubGetDPArray();
}
...
public function pubStatSubSetDPArray(a: Array) {
    FinExtDynamicClassStat.pubStatSubSetDPArray(a);
}

public function pubStatSubGetDPArray(): Array {
    return FinExtDynamicClassStat.pubStatSubGetDPArray();
}
