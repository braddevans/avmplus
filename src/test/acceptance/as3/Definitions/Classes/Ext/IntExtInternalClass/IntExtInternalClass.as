...
internal class InternalClass {
    ...
    internal function getBoolean(): Boolean {
        return boolean;
    }
    ...
    internal function getFunction(): Function {
        return myFunction;
    }
    ...
    internal function getNumber(): Number {
        return number;
    }
    ...
    internal function getString(): String {
        return string;
    }

    //function getSimple() : Simple { return simple; }

    internal function setArray(a: Array) {
        array = a;
    }

    function setBoolean(b: Boolean) {
        boolean = b;
    }

    internal function setDate(d: Date) {
        date = d;
    }

    function setFunction(f: Function) {
        myFunction = f;
    }

    internal function setMath(m: Math) {
        math = m;
    }
    ...
    internal function setObject(o: Object) {
        object = o;
    }
    ...
    public function setPubBoolean(b: Boolean) {
        pubBoolean = b;
    }

    public function setPubDate(d: Date) {
        pubDate = d;
    }

    public function setPubFunction(f: Function) {
        pubFunction = f;
    }

    public function setPubMath(m: Math) {
        pubMath = m;
    }

    public function setPubNumber(n: Number) {
        pubNumber = n;
    }

    public function setPubObject(o: Object) {
        pubObject = o;
    }

    public function setPubString(s: String) {
        pubString = s;
    }

    //public function setPubSimple( s:Simple ) { pubSimple = s; }

    public function getPubArray(): Array {
        return this.pubArray;
    }

    public function getPubBoolean(): Boolean {
        return this.pubBoolean;
    }

    public function getPubDate(): Date {
        return this.pubDate;
    }

    public function getPubFunction(): Function {
        return this.pubFunction;
    }

    public function getPubMath(): Math {
        return this.pubMath;
    }

    public function getPubNumber(): Number {
        return this.pubNumber;
    }

    public function getPubObject(): Object {
        return this.pubObject;
    }

    public function getPubString(): String {
    ...
    private function getPrivArray(): Array {
        return privArray;
    }

    private function getPrivBoolean(): Boolean {
        return privBoolean;
    }

    private function getPrivDate(): Date {
        return privDate;
    }

    private function getPrivFunction(): Function {
        return privFunction;
    }

    private function getPrivMath(): Math {
        return privMath;
    }

    private function getPrivNumber(): Number {
        return privNumber;
    }

    private function getPrivObject(): Object {
        return privObject;
    }

    private function getPrivString(): String {
        return privString;
    }

    //private function getPrivSimple() : Simple { return privSimple; }

    private function setPrivArray(a: Array) {
        privArray = a;
    }

    private function setPrivBoolean(b: Boolean) {
        privBoolean = b;
    }

    private function setPrivDate(d: Date) {
        privDate = d;
    }

    private function setPrivFunction(f: Function) {
        privFunction = f;
    }

    private function setPrivMath(m: Math) {
        privMath = m;
    }

    private function setPrivNumber(n: Number) {
        privNumber = n;
    }

    private function setPrivObject(o: Object) {
        privObject = o;
    }

    private function setPrivString(s: String) {
        privString = s;
    }
    ...
    static function setStatArray(a: Array) {
        statArray = a;
    }

    static function setStatBoolean(b: Boolean) {
        statBoolean = b;
    }

    static function getStatArray() {
        return statArray;
    }
    ...
    final function setFinArray(a: Array) {
        finArray = a;
    }

    final function getFinArray() {
        return finArray;
    }
    ...
    public static function setPubStatArray(a: Array) {
        pubStatArray = a;
    }

    public static function setPubStatBoolean(b: Boolean) {
        pubStatBoolean = b;
    }

    public static function getPubStatArray() {
        return pubStatArray;
    }
    ...
    private static function setPrivStatArray(a: Array) {
        privStatArray = a;
    }

    private static function setPrivStatBoolean(b: Boolean) {
        privStatBoolean = b;
    }

    private static function getPrivStatArray() {
        return privStatArray;
    }
    ...
    public function pubOverLoad() {
        return "This is the parent class";
    }

    private function privOverLoad() {
        return "This is the parent class";
    }

    static function statOverLoad() {
        return "This is the parent class";
    }

    public static function pubStatOverLoad() {
        return "This is the parent class";
    }

    private static function privStatOverLoad() {
        return "This is the parent class";
    }
}
...
internal class IntExtInternalClassTest extends InternalClass {
    ...
    internal function subGetArray(): Array {
    ...
    internal final function finSubGetArray(): Array {
        return this.getArray();
    }
    ...
    public final function pubFinSubGetArray(): Array {
        return this.getArray();
    }

    final public function pubFinSubSetArray(a: Array) {
        this.setArray(a);
    }
    ...
    private final function privFinSubGetArray(): Array {
        return this.getArray();
    }

    final private function privFinSubSetArray(a: Array) {
        this.setArray(a);
    }
    ...
    internal virtual function virtSubGetArray(): Array {
        return this.getArray();
    }

    virtual function virtSubSetArray(a: Array) {
        this.setArray(a);
    }
    ...
    virtual public function pubVirtSubGetArray(): Array {
        return this.getArray();
    }

    public virtual function pubVirtSubSetArray(a: Array) {
        this.setArray(a);
    }
    ...
    virtual private function privVirtSubGetArray(): Array {
        return this.getArray();
    }

    private virtual function privVirtSubSetArray(a: Array) {
        this.setArray(a);
    }
    ...
    internal static function statSubGetArray(): Array {
        return getArray();
    }

    static public function pubStatSubGetArray(): Array {
    ...
    internal function subGetDPArray(): Array {
        return array;
    }
    ...
    internal final function finSubGetDPArray(): Array {
        return array;
    }
    ...
    internal virtual function virtSubGetDPArray(): Array {
        return array;
    }

    virtual function virtSubSetDPArray(a: Array) {
        array = a;
    }
    ...
    public final function pubFinSubGetDPArray(): Array {
        return this.array;
    }

    final public function pubFinSubSetDPArray(a: Array) {
        this.array = a;
    }
    ...
    public virtual function pubVirtSubGetDPArray(): Array {
        return this.array;
    }

    virtual public function pubVirtSubSetDPArray(a: Array) {
        this.array = a;
    }
    ...
    private final function privFinSubGetDPArray(): Array {
        return this.array;
    }

    final private function privFinSubSetDPArray(a: Array) {
        this.array = a;
    }
    ...
    private virtual function privVirtSubGetDPArray(): Array {
        return this.array;
    }

    virtual private function privVirtSubSetDPArray(a: Array) {
        this.array = a;
    }
