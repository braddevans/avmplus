...
Assert.expectEq("FinalPublicClass.setPubStatObject(ob), FinalPublicClass.getPubStatObject()", ob, (FinalPublicClass.setPubStatObject(ob), FinalPublicClass.getPubStatObject()));
...
Assert.expectEq("FinalPublicClass.pubStatObject = ob, FinalPublicClass.pubStatObject", ob, (FinalPublicClass.pubStatObject = ob, FinalPublicClass.pubStatObject));
...
Assert.expectEq("FinalPublicClass.pubFinalStaticNumber = 10, FinalPublicClass.pubFinalStaticNumber", 10, (FinalPublicClass.pubFinalStaticNumber = 10, FinalPublicClass.pubFinalStaticNumber));
