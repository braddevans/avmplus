...
final public class FinalPublicClass {
    ...
    static function setStatFunction(f: Function) {
        FinalPublicClass.statFunction = f;
    }
    ...
    private static function setPrivStatString(s: String) {
        FinalPublicClass.privStatString = s;
    }

    private static function getPrivStatString() {
        return FinalPublicClass.privStatString;
    }
    ...
    public static function setPubStatObject(o: Object) {
        FinalPublicClass.pubStatObject = o;
    }

    public static function getPubStatObject() {
        return FinalPublicClass.pubStatObject;
    }
