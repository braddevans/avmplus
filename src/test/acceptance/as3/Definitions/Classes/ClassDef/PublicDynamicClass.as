...
Assert.expectEq("var foo = new PublicDynamicClass(), PublicDynamicClass.constructorCount", 2, (foo = new PublicDynamicClass(), PublicDynamicClass.constructorCount));
Assert.expectEq("*** No param constructor test ***", 1, 1);
Assert.expectEq("var foo = new PublicDynamicClass, PublicDynamicClass.constructorCount", 3, (foo = new PublicDynamicClass, PublicDynamicClass.constructorCount));
...
Assert.expectEq("PublicDynamicClass.setPubStatObject(ob), PublicDynamicClass.getPubStatObject()", ob, (PublicDynamicClass.setPubStatObject(ob), PublicDynamicClass.getPubStatObject()));
...
Assert.expectEq("PublicDynamicClass.pubStatObject = ob, PublicDynamicClass.pubStatObject", ob, (PublicDynamicClass.pubStatObject = ob, PublicDynamicClass.pubStatObject));
...
Assert.expectEq("PublicDynamicClass.pubFinalStaticNumber = 10, PublicDynamicClass.pubFinalStaticNumber", 10, (PublicDynamicClass.pubFinalStaticNumber = 10, PublicDynamicClass.pubFinalStaticNumber));
