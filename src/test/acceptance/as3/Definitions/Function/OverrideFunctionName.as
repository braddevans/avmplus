...
class OverrideFunctionNameClassBase {
    ...
    function abcdefghijklmnopqrstuvwxyz0123456789$_() {
        return null;
    }
}
...
class OverrideFunctionNameClass extends OverrideFunctionNameClassBase {
    ...
    // not the constructor but looks like it
    override function overrideFunctionNameClass() {
        return "not the constructor"
    }

    override function a1() {
        return "a1";
    }

    override function a_1() {
        return "a_1";
    }

    override function _a1() {
        return "_a1";
    }

    override function __a1() {
        return "__a1";
    }

    override function _a1_() {
        return "_a1_";
    }

    override function __a1__() {
        return "__a1__";
    }
    ...
    override function abcdefghijklmnopqrstuvwxyz0123456789$_() {
        return "all";
    }
}
