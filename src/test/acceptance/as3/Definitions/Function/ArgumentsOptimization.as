...
/* Acceptance test for arguments array optimization.  We measure two
   ...
   This acceptance test may start failing if:
    ...
    - allocation and object initialization speeds improve so much that
      arguments array allocation starts to become affordable
...
Assert.expectEq("Arguments array optimization (not enabled with the debugger!)", true, (m1 / m2 > 5.0));
