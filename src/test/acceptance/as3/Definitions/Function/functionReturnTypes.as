...
funcArr[0] = function (arg): String {
    return arg;
}
funcArr[1] = function (arg): Number {
    return arg;
}
funcArr[2] = function (arg): int {
    return arg;
}
funcArr[3] = function (arg): uint {
    return arg;
}
funcArr[4] = function (arg): Boolean {
    return arg;
}
funcArr[5] = function (arg): Object {
    return arg;
}
funcArr[6] = function (arg): Function {
    return arg;
}
funcArr[7] = function (arg): TestClassA {
    return arg;
}
funcArr[8] = function (arg): TestClassB {
    return arg;
}
funcArr[9] = function (arg): TestClassC {
    return arg;
}
funcArr[10] = function (arg): Date {
    return arg;
}
