...
function returnStringNoPackage(s: String = "outside package and outside class", ...rest): String {
    return s;
}

function returnBooleanNoPackage(b: Boolean = true, ...rest): Boolean {
    return b;
}

function returnNumberNoPackage(n: Number = 10, ...rest): Number {
    return n;
}
