...
class PrivateFunctionBodyClass {
    private function noReturnNoParamsInner() {
        return "noReturnNoParams";
    }

    private function noReturnParamsInner(s: String, b: Boolean) {
        return s;
    }

    private function noReturnCustomParamInner(c: Custom) {
        return new Custom();
    }

    private function returnNoParamsInner(): String {
        return "returnNoParams";
    }

    private function returnParamsInner(s: String, b: Boolean): String {
        return s;
    }

    private function returnCustomNoParamsInner(): Custom {
        return new Custom();
    }

    public function noReturnNoParams() {
        return noReturnNoParamsInner();
    }

    public function noReturnParams(s: String, b: Boolean) {
        return noReturnParamsInner(s, b);
    }

    public function noReturnCustomParam(c: Custom) {
        return noReturnCustomParamInner(c);
    }
    ...
    public function returnParams(s: String, b: Boolean): String {
        return returnParamsInner(s, b);
    }

    public function returnCustomNoParams(): Custom {
        return returnCustomNoParamsInner();
    }
}
...
var TESTOBJ;
var s: String = String("this is a test");
