...
class PublicFunctionNameClass {
    // constructor
    function PublicFunctionNameClass() {
        res = "EmptyName";
    }
    ...
    public function __a1() {
        return "__a1";
    }

    public function _a1_() {
        return "_a1_";
    }

    public function __a1__() {
        return "__a1__";
    }
    ...
    public function abcdefghijklmnopqrstuvwxyz0123456789$_() {
        return "all";
    }
}
...
function abbcdefghijklmnopqrstuvwxyz0123456789$_() {
    return "ball";
}
...
Assert.expectEq("outside class inside package function Name A1()", "C1", pubC1());
Assert.expectEq("outside class inside package function Name cases()", "cases", pubcases());
Assert.expectEq("outside class inside package function Name Cases()", "Cases", pubCases());
Assert.expectEq("outside class inside package function Name all()", "all", puball());
...
Assert.expectEq("inside class outside package function Name constructor different case", "not the constructor", TESTOBJ.publicFunctionNameClass());
