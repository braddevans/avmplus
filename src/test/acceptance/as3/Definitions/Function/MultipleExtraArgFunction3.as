...
Assert.expectEq("TESTOBJ.returnRest()", 6, TESTOBJ.returnRest({}, [20, 30], 40, 10, false, "hello", [123], [345]));

// inside package outside of class
Assert.expectEq("returnRest()", 7, returnRest("Str", [1, 2, 3], [10, 11, 12], false, "hello", {}, [123], [345], "hello"));

// outside package inside class
Assert.expectEq("TESTOBJ1.returnRest()", 6, TESTOBJ1.returnRest({}, [1, 2, 3], 10, {}, "hello", {}, [123], [345]));

// outside package and outside class
Assert.expectEq("returnRestNoPackage()", 6, returnRestNoPackage("Str", 1000, {}, 10, "str2", "hello", {}, [123], [345]));
