...
// inside class inside package
Assert.expectEq("Object TESTOBJ.returnRest()", 1, TESTOBJ.returnRest({}));

// inside package outside of class
Assert.expectEq("Object returnRest()", 1, returnRest({}));

// outside package inside class
Assert.expectEq("Object TESTOBJ1.returnRest()", 1, TESTOBJ1.returnRest({}));

// outside package and outside class
Assert.expectEq("Object returnRestNoPackage()", 1, returnRestNoPackage({}));
