...
internal class GetSetProtectedInternal {
    ...
    protected function get boolean(): Boolean {
        return _b;
    }

    protected function set boolean(b: Boolean): void {
        _b = b;
    }

    protected function get u(): uint {
        return _u;
    }

    protected function set u(u: uint): void {
        _u = u;
    }
    ...
    protected function set n(num: Number): void {
        _n = num;
    }

    protected function get string(): String {
        return _s;
    }

    protected function set string(s: String): void {
        _s = s;
    }

    protected function get noType() {
        return _nt;
    }

    protected function set noType(nt): void {
        _nt = nt;
    }
