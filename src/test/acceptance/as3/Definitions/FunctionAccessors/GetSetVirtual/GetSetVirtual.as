...
public class GetSetVirtual {
    ...
    public virtual function get boolean(): Boolean {
        return _b;
    }

    public virtual function set boolean(b: Boolean) {
        _b = b;
    }

    public virtual function get u(): uint {
        return _u;
    }

    public virtual function set u(ui: uint) {
        _u = ui;
    }

    public virtual function get string(): String {
        return _s;
    }

    public virtual function set string(s: String) {
        _s = s;
    }

    public virtual function get noType(): String {
        return _nt;
    }

    public virtual function set noType(nt) {
        _nt = nt;
    }
    ...
    public virtual function get sfs1(): Number {
        return _sfs1;
    }

    public virtual function get sfs2(): int {
        return _sfs2;
    }
    ...
    public virtual function get sfg1(): String {
        return _sfg1;
    }
    ...
    public virtual function set sfg1(s: String) {
        _sfg1 = s;
    }

    public virtual function set sfg2(ui: uint) {
        _sfg2 = ui;
    }
    ...
    public virtual function get noSetter() {
        return _nosetter;
    }
    ...
    public virtual function set noGetter(s) {
        _nogetter = s;
    }
