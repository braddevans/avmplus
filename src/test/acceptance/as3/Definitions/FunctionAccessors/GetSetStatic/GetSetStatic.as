...
public class GetSetStatic {
    ...
    public static function set boolean(b: Boolean) {
        _b = b;
    }
    ...
    public static function set u(ui: uint) {
        _u = ui;
    }
    ...
    public static function set string(s: String) {
        _s = s;
    }

    public static function get noType(): String {
        return _s;
    }

    public static function set noType(nt) {
        _nt = nt;
    }
    ...
    public static function get sfs1(): Number {
        return _sfs1;
    }

    public static function get sfs2(): int {
        return _sfs2;
    }
    ...
    public static function get sfg1(): String {
        return _sfg1;
    }
    ...
    public static function set sfg1(s: String) {
        _sfg1 = s;
    }

    public static function set sfg2(ui: uint) {
        _sfg2 = ui;
    }
    ...
    public static function get noSetter() {
        return _nosetter;
    }
    ...
    public static function set noGetter(s) {
        _nogetter = s;
    }
