...
flt4 = -flt4;
AddStrictTestCase("unary minus on float4(1f).x", -1
f, flt4.x
)

AddStrictTestCase("unary minus on float4(1f).y", -1
f, flt4.y
)

AddStrictTestCase("unary minus on float4(1f).z", -1
f, flt4.z
)

AddStrictTestCase("unary minus on float4(1f).w", -1
f, flt4.w
)
