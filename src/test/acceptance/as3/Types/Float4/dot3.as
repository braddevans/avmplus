...
AddStrictTestCase("float4.dot3((1f, 2f, 3f, 4f), (4f, 3f, 2f, 1f))", new float(16
f
),
float4.dot3(flt4_a, flt4_b)
)
...
AddStrictTestCase("float4.dot3((1f, 2f, 3f, 100f), (4f, 3f, 2f, 100f))", new float(16
f
),
float4.dot3(flt4_a, flt4_b)
)
