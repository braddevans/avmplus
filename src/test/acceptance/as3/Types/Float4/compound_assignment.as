...
Assert.expectEq("flt4 *= 3", float4(6
f
),
flt4 *= 3
)

Assert.expectEq("flt4 *= 2", float4(12
f
),
flt4 *= 2
)
...
Assert.expectEq("flt4 %= 5", float4(3
f
),
flt4 %= 5
)

Assert.expectEq("flt4 %= 2", float4(1
f
),
flt4 %= 2
)
...
Assert.expectEq("flt4 /= 3", float4(4
f
),
flt4 /= 3
)

Assert.expectEq("flt4 /= 2", float4(2
f
),
flt4 /= 2
)
