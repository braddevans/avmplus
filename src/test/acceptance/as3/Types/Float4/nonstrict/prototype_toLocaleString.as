...
var test_flt4: float4 = new float4(3.14131211
f
)
...
var test_obj: Object = {};
Assert.expectError("float4.prototype.toLocaleString() on Object throws TypeError ", Utils.TYPEERROR, function () {
    test_obj.public::toLocaleString();
});
// we test that it throws TypeError, not RangeError
Assert.expectError("float4.prototype.toLocaleString(357) on Object throws TypeError", Utils.TYPEERROR, function () {
    test_obj.public::toLocaleString(357);
});
...
Assert.expectError("float4.prototype.toLocaleString() non-generic= throws TypeError", Utils.TYPEERROR, function () {
    test_num.public::toLocaleString();
});
Assert.expectError("float4.prototype.toLocaleString(357) non-generic= throws TypeError", Utils.TYPEERROR, function () {
    test_num.public::toLocaleString(357);
});
