...
var test_obj: Object = {};
Assert.expectError("float4.prototype.toString() on Object throws TypeError ", Utils.TYPEERROR, function () {
    test_obj.public::toString();
});
// we test that it throws TypeError, not RangeError
Assert.expectError("float4.prototype.toString(357) on Object throws TypeError", Utils.TYPEERROR, function () {
...
Assert.expectError("float4.prototype.toString() on Number throws TypeError", Utils.TYPEERROR, function () {
...
// we test that it throws TypeError, not RangeError
Assert.expectError("float4.prototype.toString(357) on Number throws TypeError", Utils.TYPEERROR, function () {
