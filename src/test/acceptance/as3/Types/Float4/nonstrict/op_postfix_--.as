...
var flt4: float4 = new float4(1.125
f
)

var flt4_minus_1: float4 = flt4 - float4(1.0
f
)
...
Assert.expectEq("postfix -- on Object (that converts to float4 through ToPrimitive)", o, flt4_minus_1)
