...
var test_obj: Object = {};
Assert.expectError("float4.prototype.valueOf() on Object throws TypeError ", Utils.TYPEERROR, function () {
    test_obj.public::valueOf();
});
...
Assert.expectError("float4.prototype.valueOf() on Number throws TypeError", Utils.TYPEERROR, function () {
    test_num.public::valueOf();
});
// we test that it throws TypeError, not ArgumentError
Assert.expectError("float4.prototype.valueOf(357) on Number throws TypeError", Utils.TYPEERROR, function () {
    test_num.public::valueOf(357);
});
