...
Assert.expectEq("function float4(1f) == float4(1f)", true, check(float4(1
f
),
float4(1
f
...
Assert.expectEq("function float4(0f) == float4(0f)", true, check(float4(0
f
),
float4(0
f
...
Assert.expectEq("function float4(1f) == float4(2f)", false, check(float4(1
f
),
float4(2
f
...
Assert.expectEq("function float4(2f) == float4(1f)", false, check(float4(2
f
),
float4(1
f
...
Assert.expectEq("float4(1f, 1f, 3f, 4f) == float4(0f, 2f, 3f, 4f)", false, float4(1
f, 2
f, 3
f, 4
f
...
Assert.expectEq("float4(1f, 2f, 2f, 4f) == float4(0f, 2f, 3f, 4f)", false, float4(1
f, 2
f, 3
f, 4
f
...
Assert.expectEq("float4(1f, 2f, 3f, 5f) == float4(0f, 2f, 3f, 4f)", false, float4(1
f, 2
f, 3
f, 4
f
...
Assert.expectEq("function float4(1f, 2f, 3f, 4f) == float4(0f, 2f, 3f, 4f)", false, check(float4(1
f, 2
f, 3
f, 4
f
...
Assert.expectEq("function float4(1f, 1f, 3f, 4f) == float4(0f, 2f, 3f, 4f)", false, check(float4(1
f, 2
f, 3
f, 4
f
...
Assert.expectEq("function float4(1f, 2f, 2f, 4f) == float4(0f, 2f, 3f, 4f)", false, check(float4(1
f, 2
f, 3
f, 4
f
...
Assert.expectEq("function float4(1f, 2f, 3f, 5f) == float4(0f, 2f, 3f, 4f)", false, check(float4(1
f, 2
f, 3
f, 4
f
