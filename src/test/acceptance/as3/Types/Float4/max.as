...
AddStrictTestCase("float4.max((1f, 1f, 1f, 1f), (0f, 0f, 0f, 0f))", new float4(1
f
),
float4.max(flt4_a, flt4_b)
)
...
AddStrictTestCase("float4.max((1f, 1f, 1f, 1f), (2f, 2f, 2f, 2f))", new float4(2
f
),
float4.max(flt4_a, flt4_b)
)
