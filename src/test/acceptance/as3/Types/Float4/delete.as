...
Assert.expectError("delete an out-of-range element of a float4 (negative)", "ReferenceError: Error #1120", function () {
    delete flt4[-1]
});
Assert.expectError("delete an out-of-range element of a float4 (non-integer)", "ReferenceError: Error #1120", function () {
    delete flt4["4.75"]
});
Assert.expectError("delete an out-of-range element of a float4 (non-number)", "ReferenceError: Error #1120", function () {
    delete flt4["zappa"]
});
