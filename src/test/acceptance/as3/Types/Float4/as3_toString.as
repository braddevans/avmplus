...
var test_flt4: float4 = new float4(2.7182818284e5
f
)
...
test_flt4 = new float4(1
f
)

Assert.expectError("float4.AS3::toString: range errors toString(37)", Utils.RANGEERROR, function () {
    test_flt4.AS3::toString(37)
});
Assert.expectError("float4.AS3::toString: range errors toString(1)", Utils.RANGEERROR, function () {
    test_flt4.AS3::toString(1)
});
Assert.expectError("float4.AS3::toString: range errors toString(null)", Utils.RANGEERROR, function () {
    test_flt4.AS3::toString(null)
});
Assert.expectError("float4.AS3::toString: range errors toString(undefined)", Utils.RANGEERROR, function () {
    test_flt4.AS3::toString(undefined)
});
Assert.expectError("float4.AS3::toString: range errors toString(float.NaN)", Utils.RANGEERROR, function () {
    test_flt4.AS3::toString(float.NaN)
});
Assert.expectError("float4.AS3::toString: range errors toString(Infinity)", Utils.RANGEERROR, function () {
    test_flt4.AS3::toString(Infinity)
});
Assert.expectError("float4.AS3::toString: range errors toString(-Infinity)", Utils.RANGEERROR, function () {
    test_flt4.AS3::toString(-Infinity)
});

test_flt4 = new float4(2.7182818284e5
f
)
