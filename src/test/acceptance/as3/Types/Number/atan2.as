...
function check(param1: Number, param2: Number): Number {
    return Number.atan2(param1, param2);
}
...
Assert.expectError("Number.atan2() with no args", Utils.ARGUMENTERROR + 1063, function () {
    Number.atan2();
});
Assert.expectError("Number.atan2(0) with one args", Utils.ARGUMENTERROR + 1063, function () {
    Number.atan2(0);
});
