...
AddStrictTestCase("float.floor(0f)", 0
f, float.floor(0
f
))

AddStrictTestCase("float.floor(0f) sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / float.floor(0
f
))

AddStrictTestCase("float.floor(0f) check()", 0
f, check(0
f
))

AddStrictTestCase("float.floor(0f) check() sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / check(0
f
))

AddStrictTestCase("float.floor(null)", 0
f, float.floor(null)
)
...
AddStrictTestCase("float.floor(-0f) sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / float.floor(-0
f
))
...
AddStrictTestCase("float.floor(-0f) check() sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / check(-0
f
))
...
AddStrictTestCase("float.floor(float.MIN_VALUE)", 0
f, float.floor(float.MIN_VALUE)
)

AddStrictTestCase("float.floor(0.5f)", 0
f, float.floor(0.5
f
))

AddStrictTestCase("float.floor(0.5f) sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / float.floor(0.5
f
))

AddStrictTestCase("float.floor(0.999f)", 0
f, float.floor(0.999
f
))

AddStrictTestCase("float.floor(0.999f) sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / float.floor(0.999
f
))

AddStrictTestCase("float.floor(0.5f) check()", 0
f, check(0.5
f
))

AddStrictTestCase("float.floor(0.5f) check() sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / check(0.5
f
))


// The value of float.floor(x) is the same as the value of -float.ceil(-x).
AddStrictTestCase("float.floor(3.124f) == -float.ceil(-3.124f)", -float.ceil(-3.124
f
),
float.floor(3.124
f
...
AddStrictTestCase("float.floor(-float.MIN_VALUE)", -1
f, float.floor(-float.MIN_VALUE)
)
...
var myfloat: float = 1
f;
AddStrictTestCase("float.floor(myfloat=1f)", float(1
f
),
float.floor(myfloat)
)
...
AddStrictTestCase("float.floor(1f) FloatLiteral", float(1), float.floor(1
f
))

AddStrictTestCase("float.floor(0f) FloatLiteral", float(0), float.floor(0
f
))
