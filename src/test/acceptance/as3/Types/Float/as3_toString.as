...
var test_flt: float = 2.7182818284e5
f;
...
Assert.expectEq("float.AS3::toString applied to float literal", test_flt.AS3::toString(), 2.7182818284e5
f.AS3::toString()
)
...
Assert.expectError("float.AS3::toString: range errors toString(37)", Utils.RANGEERROR, function () {
    test_flt.AS3::toString(37)
});
Assert.expectError("float.AS3::toString: range errors toString(1)", Utils.RANGEERROR, function () {
    test_flt.AS3::toString(1)
});
Assert.expectError("float.AS3::toString: range errors toString(null)", Utils.RANGEERROR, function () {
    test_flt.AS3::toString(null)
});
Assert.expectError("float.AS3::toString: range errors toString(undefined)", Utils.RANGEERROR, function () {
    test_flt.AS3::toString(undefined)
});
Assert.expectError("float.AS3::toString: range errors toString(float.NaN)", Utils.RANGEERROR, function () {
    test_flt.AS3::toString(float.NaN)
});
Assert.expectError("float.AS3::toString: range errors toString(Infinity)", Utils.RANGEERROR, function () {
    test_flt.AS3::toString(Infinity)
});
Assert.expectError("float.AS3::toString: range errors toString(-Infinity)", Utils.RANGEERROR, function () {
    test_flt.AS3::toString(-Infinity)
});
