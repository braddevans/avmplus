...
f;
test_num = test_flt;
Assert.expectEq("test float.AS3::toExponential float literal", test_num.AS3::toExponential(), 2.7182818284e5
f.AS3::toExponential()
)
...
Assert.expectError("float.AS3::toExponential(-1): RangeError", Utils.RANGEERROR, function () {
    test_flt.AS3::toExponential(-1)
});
Assert.expectError("float.AS3::toExponential(21): RangeError", Utils.RANGEERROR, function () {
    test_flt.AS3::toExponential(21)
});
