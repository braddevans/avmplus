...
Assert.expectEq("left shift on FloatLiteral", 4, 1
f << 2
)

Assert.expectEq("float left shift on float", -643303936, f1 << twof);
Assert.expectEq("FloatLiteral left shift on FloatLiteral", 4, 1
f << 2
f
)
...
Assert.expectEq("right shift on FloatLiteral", 25, 100
f >> 2
)

Assert.expectEq("float right shift on float", -308641952, f1 >> twof);
Assert.expectEq("FloatLiteral right shift on FloatLiteral", 25, 100
f >> 2
f
)
...
Assert.expectEq("right shift(unsigned) on FloatLiteral", 1073741799, -100
f >>> 2
)

Assert.expectEq("float right shift(unsigned) on float", 765099872, f1 >>> twof);
Assert.expectEq("FloatLiteral right shift(unsigned) on FloatLiteral", 1073741799, -100
f >>> 2
f
)
