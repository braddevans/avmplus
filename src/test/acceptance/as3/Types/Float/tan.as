...
var zero: float = 0
f;
AddStrictTestCase("float.tan(zero=0f)", 0
f, float.tan(zero)
)

AddStrictTestCase("float.tan(0f) FloatLiteral", 0
f, float.tan(0
f
))

AddStrictTestCase("float.tan(0f) sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / float.tan(0
f
))

AddStrictTestCase("float.tan(0f) check()", 0
f, check(0
f
))

AddStrictTestCase("float.tan(0f) check() sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / check(0
f
))

AddStrictTestCase("float.tan(null)", 0
f, float.tan(null)
)
...
f;
AddStrictTestCase("float.tan(neg_zero)", -0
f, float.tan(neg_zero)
)
...
AddStrictTestCase("float.tan(-0f) FloatLiteral sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / float.tan(-0
f
))
...
AddStrictTestCase("float.tan(-0f) check() sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / check(-0
f
))
...
AddStrictTestCase("float.tan(float.PI/4f)", float(1), float.tan(float.PI / 4
f
))

AddStrictTestCase("float.tan(3f*float.PI/4f)", float(-1), float.tan(3
f * float.PI / 4
f
))

AddStrictTestCase("float.tan(float.PI)", -float.sin(float.PI), float.tan(float.PI));
AddStrictTestCase("float.tan(5f*float.PI/4f)", float(1.0000003576278687), float.tan(5
f * float.PI / 4
f
))
