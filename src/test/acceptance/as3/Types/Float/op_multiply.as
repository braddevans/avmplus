...
AddStrictTestCase("FloatLiteral multiplication result", float(8.078037504e+09), 1.2345678e9
f * 6.543210987
f
)
...
AddStrictTestCase("float.POSITIVE_INFINITY * FloatLiteral", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY * 1
f
)

AddStrictTestCase("FloatLiteral * float.POSITIVE_INFINITY", float.POSITIVE_INFINITY, 1
f * float.POSITIVE_INFINITY
)

AddStrictTestCase("float.NEGATIVE_INFINITY * FloatLiteral", float.NEGATIVE_INFINITY, float.NEGATIVE_INFINITY * 1
f
)

AddStrictTestCase("FloatLiteral * float.NEGATIVE_INFINITY", float.NEGATIVE_INFINITY, 1
f * float.NEGATIVE_INFINITY
)

AddStrictTestCase("float.POSITIVE_INFINITY * -FloatLiteral", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY * -1
f
)

AddStrictTestCase("-FloatLiteral * float.POSITIVE_INFINITY", float.NEGATIVE_INFINITY, -1
f * float.POSITIVE_INFINITY
)

AddStrictTestCase("float.NEGATIVE_INFINITY * -FloatLiteral", float.POSITIVE_INFINITY, float.NEGATIVE_INFINITY * -1
f
)

AddStrictTestCase("-FloatLiteral * float.NEGATIVE_INFINITY", float.POSITIVE_INFINITY, -1
f * float.NEGATIVE_INFINITY
)


AddStrictTestCase("check(float.POSITIVE_INFINITY, FloatLiteral)", float.POSITIVE_INFINITY, check(float.POSITIVE_INFINITY, 1
f
))

AddStrictTestCase("check(FloatLiteral, float.POSITIVE_INFINITY)", float.POSITIVE_INFINITY, check(1
f, float.POSITIVE_INFINITY
))

AddStrictTestCase("check(float.NEGATIVE_INFINITY, FloatLiteral)", float.NEGATIVE_INFINITY, check(float.NEGATIVE_INFINITY, 1
f
))

AddStrictTestCase("check(FloatLiteral, float.NEGATIVE_INFINITY)", float.NEGATIVE_INFINITY, check(1
f, float.NEGATIVE_INFINITY
))

AddStrictTestCase("check(float.POSITIVE_INFINITY, -FloatLiteral)", float.NEGATIVE_INFINITY, check(float.POSITIVE_INFINITY, -1
f
))

AddStrictTestCase("check(-FloatLiteral, float.POSITIVE_INFINITY)", float.NEGATIVE_INFINITY, check(-1
f, float.POSITIVE_INFINITY
))

AddStrictTestCase("check(float.NEGATIVE_INFINITY, -FloatLiteral)", float.POSITIVE_INFINITY, check(float.NEGATIVE_INFINITY, -1
f
))

AddStrictTestCase("check(-FloatLiteral, float.NEGATIVE_INFINITY)", float.POSITIVE_INFINITY, check(-1
f, float.NEGATIVE_INFINITY
))
