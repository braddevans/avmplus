...
f;
test_num = test_flt;
Assert.expectEq("test float.AS3::toFixed float literal", test_num.AS3::toFixed(), 2.7182818284e5
f.AS3::toFixed()
)
...
Assert.expectError("float.AS3::toFixed(-1): RangeError", Utils.RANGEERROR, function () {
    test_flt.AS3::toFixed(-1)
});
Assert.expectError("float.AS3::toFixed(21): RangeError", Utils.RANGEERROR, function () {
    test_flt.AS3::toFixed(21)
});
