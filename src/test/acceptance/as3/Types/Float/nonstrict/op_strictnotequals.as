...
Assert.expectEq("1f FloatLiteral !== 1 NumberLiteral", false, (1
f !== 1
))

Assert.expectEq("strictNotEquals() 1f FloatLiteral !== 1 NumberLiteral", true, strictNotEquals(1
f, 1
))

Assert.expectEq("1.1f !== 1.1", true, (1.1
f !== 1.1
))

Assert.expectEq("strictNotEquals() 1.1f !== 1.1", true, strictNotEquals(1.1
f, 1.1
))
...
Assert.expectEq("1 NumberLiteral !== 1f FloatLiteral", false, (1 !== 1
f
))

Assert.expectEq("strictNotEquals() 1 NumberLiteral !== 1f FloatLiteral", true, strictNotEquals(1, 1
f
))

Assert.expectEq("1.1 !== 1.1f", true, (1.1 !== 1.1
f
))

Assert.expectEq("strictNotEquals() 1.1 !== 1.1f", true, strictNotEquals(1.1, 1.1
f
))
...
Assert.expectEq("float.NaN !== 1f", true, (float.NaN !== 1
f
))
...
Assert.expectEq("1f !== float.NaN", true, (1
f !== float.NaN
))
...
Assert.expectEq("-float.NEGATIVE_INFINITY !== float.POSITIVE_INFINITY", false, (-float.NEGATIVE_INFINITY !== float.POSITIVE_INFINITY));
Assert.expectEq("onef !== 1f", false, (onef !== 1
f
))

Assert.expectEq("1f !== onef", false, (1
f !== onef
))

Assert.expectEq("float(0xFFFFFF00) !== float(0xFFFFFF01)", false, (float(0xFFFFFF00) !== float(0xFFFFFF01)));
Assert.expectEq("1.1f !== 1.100000023841858f", false, (1.1
f !== 1.100000023841858
f
))

Assert.expectEq("strictNotEquals() 1.1f !== 1.100000023841858f", false, strictNotEquals(1.1
f, 1.100000023841858
f
))
...
Assert.expectEq("0f !== -0f", false, (0
f !== -0
f
))

Assert.expectEq("strictNotEquals() 0f !== -0f", false, strictNotEquals(0
f, -0
f
))
...
Assert.expectEq("-1f !== 1f", true, (-1
f !== 1
f
))

Assert.expectEq("strictNotEquals() -1f !== 1f", true, strictNotEquals(-1
f, 1
f
))
...
Assert.expectEq("new MyObject(1f)  !== new MyObject(1f)", true, (new MyObject(1
f
)  !==
new MyObject(1
f
...
Assert.expectEq(" '!==' , evaluation order", false, (nvo + 1
f
) !==
(zerof + nvo)
)
