...
var test_obj: Object = {};
Assert.expectError("float.prototype.toString() on Object throws TypeError ", Utils.TYPEERROR, function () {
    test_obj.public::toString();
});
// we test that it throws TypeError, not RangeError
Assert.expectError("float.prototype.toString(357) on Object throws TypeError", Utils.TYPEERROR, function () {
    test_obj.public::toString(357);
});
...
Assert.expectError("float.prototype.toString() on Number throws TypeError", Utils.TYPEERROR, function () {
    test_num.public::toString();
});
Assert.expectError("float.prototype.toString() on Number throws TypeError", Utils.TYPEERROR, function () {
    Number.prototype.toString.AS3::call(test_num);
});
// we test that it throws TypeError, not RangeError
Assert.expectError("float.prototype.toString(357) on Number throws TypeError", Utils.TYPEERROR, function () {
    test_num.public::toString(357);
});
Assert.expectError("float.prototype.toString() on Number throws TypeError", Utils.TYPEERROR, function () {
    Number.prototype.toString.AS3::call(test_num, 357);
});
