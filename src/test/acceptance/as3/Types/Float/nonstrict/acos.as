...
Assert.expectError("float.acos() with no args", Utils.ARGUMENTERROR + 1063, function () {
    float.acos();
});
...
AddStrictTestCase("float.acos(true)", 0
f, float.acos(true)
)

AddStrictTestCase("float.acos(false)", float.PI / 2.0
f, float.acos(false)
)


AddStrictTestCase("float.acos('1')", 0
f, float.acos('1')
)

AddStrictTestCase("float.acos('0')", float.PI / 2.0
f, float.acos('0')
)
