...
var test_obj: Object = {};
Assert.expectError("float.prototype.toLocaleString() on Object throws TypeError ", Utils.TYPEERROR, function () {
    test_obj.public::toLocaleString();
});
// we test that it throws TypeError, not RangeError
Assert.expectError("float.prototype.toLocaleString(357) on Object throws TypeError", Utils.TYPEERROR, function () {
...
Assert.expectError("float.prototype.toLocaleString() non-generic= throws TypeError", Utils.TYPEERROR, function () {
    test_num.public::toLocaleString();
});
Assert.expectError("float.prototype.toLocaleString(357) non-generic= throws TypeError", Utils.TYPEERROR, function () {
