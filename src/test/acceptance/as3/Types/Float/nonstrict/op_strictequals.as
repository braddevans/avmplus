...
Assert.expectEq("1f FloatLiteral === 1 NumberLiteral", true, (1
f === 1
))

Assert.expectEq("strictEquals() 1f FloatLiteral === 1 NumberLiteral", false, strictEquals(1
f, 1
))

Assert.expectEq("1.1f === 1.1", false, (1.1
f === 1.1
))

Assert.expectEq("strictEquals() 1.1f === 1.1", false, strictEquals(1.1
f, 1.1
))
...
Assert.expectEq("1 NumberLiteral === 1f FloatLiteral", true, (1 === 1
f
))

Assert.expectEq("strictEquals() 1 NumberLiteral === 1f FloatLiteral", false, strictEquals(1, 1
f
))

Assert.expectEq("1.1 === 1.1f", false, (1.1 === 1.1
f
))

Assert.expectEq("strictEquals() 1.1 === 1.1f", false, strictEquals(1.1, 1.1
f
))
...
Assert.expectEq("float.NaN === 1f", false, (float.NaN === 1
f
))
...
Assert.expectEq("1f === float.NaN", false, (1
f === float.NaN
))
...
Assert.expectEq("-float.NEGATIVE_INFINITY === float.POSITIVE_INFINITY", true, (-float.NEGATIVE_INFINITY === float.POSITIVE_INFINITY));
Assert.expectEq("onef === 1f", true, (onef === 1
f
))

Assert.expectEq("1f === onef", true, (1
f === onef
))

Assert.expectEq("float(0xFFFFFF00) === float(0xFFFFFF01)", true, (float(0xFFFFFF00) === float(0xFFFFFF01)));
Assert.expectEq("1.1f === 1.100000023841858f", true, (1.1
f === 1.100000023841858
f
))

Assert.expectEq("strictEquals() 1.1f === 1.100000023841858f", true, strictEquals(1.1
f, 1.100000023841858
f
))
...
Assert.expectEq("0f === -0f", true, (0
f === -0
f
))

Assert.expectEq("stictEquals() 0f === -0f", true, strictEquals(0
f, -0
f
))
...
Assert.expectEq("strictEquals() -0f === 0f", true, strictEquals(-0
f, 0
f
))
...
Assert.expectEq("-1f === 1f", false, (-1
f === 1
f
))

Assert.expectEq("strictEquals() -1f === 1f", false, strictEquals(-1
f, 1
f
))
...
Assert.expectEq("new MyObject(1f)  === new MyObject(1f)", false, (new MyObject(1
f
)  ===
new MyObject(1
f
...
Assert.expectEq("Evaluation order: '===' ", true, (zerof + nvo) === (nvo - 1
f
))
