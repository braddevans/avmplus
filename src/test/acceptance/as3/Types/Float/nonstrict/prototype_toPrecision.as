...
Assert.expectError("float.prototype.toPrecision() on String throws RangeError", Utils.RANGEERROR, function () {
    test_str.public::toPrecision()
});
...
Assert.expectError("float.prototype.toPrecision - accepts 'undefined' for precision", Utils.RANGEERROR, function () {
    test_str.public::toPrecision(undefined);
});
...
Assert.expectError("float.prototype.toPrecision = invokes AS3::toPrecision", expectedRangeErr, function () {
    test_flt.public::toPrecision()
});
