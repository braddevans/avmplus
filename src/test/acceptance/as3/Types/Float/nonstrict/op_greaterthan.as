...
Assert.expectEq("0.0f FloatLiteral >-0.0f FloatLiteral (false)", false, 0
f > (-0
f
))
...
Assert.expectEq("-0f FloatLiteral>-float.MIN_VALUE (true)", true, (-0
f
)>
(-float.MIN_VALUE)
)

Assert.expectEq("float.MIN_VALUE>float.MIN_VALUE (false)", false, float.MIN_VALUE > float.MIN_VALUE);
