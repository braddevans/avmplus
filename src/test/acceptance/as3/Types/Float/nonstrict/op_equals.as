...
Assert.expectEq("equals() 0f == -0f", true, equals(0
f, -0
f
))
...
Assert.expectEq("Number.MIN_VALUE == 0f", false, (Number.MIN_VALUE == 0
f
))

Assert.expectEq("float(Number.MIN_VALUE) == 0f", true, (float(Number.MIN_VALUE) == 0
f
))
...
// If this comparision is true, then Number.MIN_VALUE was converted to float
Assert.expectEq("0f == Number.MIN_VALUE", false, (0
f == Number.MIN_VALUE
))

Assert.expectEq("0f == float(Number.MIN_VALUE)", true, (0
