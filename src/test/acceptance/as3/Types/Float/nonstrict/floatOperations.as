...
class FltAnyOps implements IFloatOps {
    ...
    public function sub(value: float): float {
        return value - _val;
    }

    public function mul(value: float): float {
        return _val * value;
    }

    public function div(value: float): float {
        return value / _val;
    }

    public function mod(value: float): float {
        return _val % value;
    }

    public function uminus(): float {
        return -_val;
    }

    public function uplus(): float {
        return +_val;
    }

    public function gt(value: float): Boolean {
        return _val > value;
    }

    public function gte(value: float): Boolean {
        return value >= _val;
    }

    public function lt(value: float): Boolean {
        return value < _val;
    }

    public function lte(value: float): Boolean {
        return _val <= value;
    }

    public function eq(value: float): Boolean {
        return value == _val;
    }

    public function seq(value: float): Boolean {
        return _val === value;
    }

    public function neq(value: float): Boolean {
        return value != _val;
    }

    public function sneq(value: float): Boolean {
        return _val !== value;
    }
}
class FltFltOps implements IFloatOps {
    ...
    public function FltFltOps(v: float) {
        _val = v;
    }
...
class FltNumOps implements IFloatOps {
    ...
    public function FltNumOps(v: Number) {
        _val = v;
    }
...
class FltIntOps implements IFloatOps {
    ...
    public function FltIntOps(v: int) {
        _val = v;
    }
...
function initFltAnyTests() {
    var obj: IFloatOps = new FltAnyOps(3.14
    f
)
    ...
    STEP = "FltAnyOps UMINUS";
    EQ(-3.14
    f, obj.uminus()
)

    STEP = "FltAnyOps UPLUS";
    EQ(3.14
    f, obj.uplus()
)

    STEP = "FltAnyOps GT";
    EQ(false, obj.gt(31.4
    f
))
    EQ(false, obj.gt(3.14
    f
))
    EQ(true, obj.gt(.314
    f
    ...
    STEP = "FltAnyOps GTE";
    EQ(true, obj.gte(31.4
    f
))
    EQ(true, obj.gte(3.14
    f
))
    EQ(false, obj.gte(.314
    f
))

    STEP = "FltAnyOps LT";
    EQ(false, obj.lt(31.4
    f
))
    EQ(false, obj.lt(3.14
    f
))
    EQ(true, obj.lt(.314
    f
    ...
    STEP = "FltAnyOps LTE";
    EQ(true, obj.lte(31.4
    f
))
    EQ(true, obj.lte(3.14
    f
))
    EQ(false, obj.lte(.314
    f
))

    STEP = "FltAnyOps EQ";
    EQ(false, obj.eq(31.4
    f
))
    EQ(true, obj.eq(3.14
    f
    ...
    STEP = "FltAnyOps SEQ";
    EQ(false, obj.seq(31.4
    f
))
    EQ(true, obj.seq(3.14
    f
))

    STEP = "FltAnyOps NEQ";
    EQ(true, obj.neq(31.4
    f
))
    EQ(false, obj.neq(3.14
    f
))

    STEP = "FltAnyOps SNEQ";
    EQ(true, obj.sneq(31.4
    f
))
    EQ(false, obj.sneq(3.14
    f
))
...
function initFltFltTests() {
    var obj: IFloatOps = new FltFltOps(3.14
    f
)
    ...
    STEP = "FltFltOps UMINUS";
    EQ(-3.14
    f, obj.uminus()
)

    STEP = "FltFltOps UMINU2";
    EQ(-3.14
    f, obj.uminus()
)

    STEP = "FltFltOps UPLUS";
    EQ(3.14
    f, obj.uplus()
)

    STEP = "FltFltOps UPLUS2";
    EQ(3.14
    f, obj.uplus()
)
...
function initFltNumTests() {
    ...
    STEP = "FltNumOps UMINUS";
    EQ(-3.14
    f, obj.uminus()
)

    STEP = "FltNumOps UPLUS";
    EQ(3.14
    f, obj.uplus()
)
...
function initFltIntTests() {
    ...
    STEP = "FltIntOps UMINUS";
    EQ(-3
    f, obj.uminus()
)

    STEP = "FltIntOps UPLUS";
    EQ(3
    f, obj.uplus()
)

    STEP = "FltIntOps GT";
    EQ(true, obj.gt(3.0001
    f
))
    EQ(false, obj.gt(3
    f
))
    EQ(false, obj.gt(2.999
    f
))

    STEP = "FltIntOps GTE";
    EQ(false, obj.gte(3.0001
    f
))
    EQ(true, obj.gte(3
    f
))
    EQ(true, obj.gte(2.999
    f
))

    STEP = "FltIntOps LT";
    EQ(true, obj.lt(3.0001
    f
))
    EQ(false, obj.lt(3
    f
))
    EQ(false, obj.lt(2.999
    f
))

    STEP = "FltIntOps LTE";
    EQ(false, obj.lte(3.0001
    f
))
    EQ(true, obj.lte(3
    f
))
    EQ(true, obj.lte(2.999
    f
))

    STEP = "FltIntOps EQ";
    EQ(false, obj.eq(3.0001
    f
))
    EQ(true, obj.eq(3
    f
...
function initFltAr() {
    ...
    APPROX_EQ(6.283240318
    f, x1
)

    APPROX_EQ(2.427746773
    f, y1
)

    APPROX_EQ(-10.50044727
    f, z1
)
    ...
    if (x2 < y2)
        ...
        cmpres = "y2<=z2";
    else if (z2 > Number(x2))
        cmpres = "z2>x2";
    else if (y2 >= x2)
        cmpres = "y2>=x2";
    else if (z2 == y2)
        cmpres = "z2==y2";
    else if (Number(z2) === x2)
        cmpres = "z2===x2";
    else {
        x2 = float(y2++);
        z2 = float(--y2);
