...
Assert.expectError("float.asin() with no args", Utils.ARGUMENTERROR + 1063, function () {
    float.asin();
});

AddStrictTestCase("float.asin(undefined)", float.NaN, float.asin(undefined));
AddStrictTestCase("float.asin(true)", float.PI / 2
f, float.asin(true)
)

AddStrictTestCase("float.asin(false)", 0
f, float.asin(false)
)


AddStrictTestCase("float.asin('1')", float.PI / 2
f, float.asin('1')
)

AddStrictTestCase("float.asin('0')", 0
f, float.asin('0')
)
