...
var flt_max: float = 3.402823466e+38
f; //TODO: spec says 3.4028236e38 !! (but this leads to"Infinity")
...
Assert.expectError("float.MAX_VALUE - ReadOnly", Utils.REFERENCEERROR + 1074, function () {
    float.MAX_VALUE = 0;
});
