...
Assert.expectEq("notEquals() 0f != -0f", false, notEquals(0
f, -0
f
))
...
Assert.expectEq("Number.MIN_VALUE != 0f", true, (Number.MIN_VALUE != 0
f
))

Assert.expectEq("float(Number.MIN_VALUE) != 0f", false, (float(Number.MIN_VALUE) != 0
f
))
...
// If this comparision is false, then Number.MIN_VALUE was converted to float
Assert.expectEq("0f != Number.MIN_VALUE", true, (0
f != Number.MIN_VALUE
))

Assert.expectEq("0f != float(Number.MIN_VALUE)", false, (0
f != float(Number.MIN_VALUE)
))
...
Assert.expectEq("0f == new MyObject(Number.MIN_VALUE)", false, (0
f == new MyObject(Number.MIN_VALUE)
))
...
// If this comparision is true, then Number.MIN_VALUE was converted to float
Assert.expectEq("new MyObject(Number.MIN_VALUE) == 0f", false, (new MyObject(Number.MIN_VALUE) == 0
f
))
