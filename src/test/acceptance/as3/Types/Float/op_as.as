...
AddStrictTestCase("3.14f FloatLiteral as float", float(3.14), 3.14
f as float
)

AddStrictTestCase("3.14f as Number", null, pi_float as Number);
AddStrictTestCase("3.14f FloatLiteral as Number", null, 3.14
f as Number
)

AddStrictTestCase("2.1f as Object", float(2.1), float(2.1) as Object);
AddStrictTestCase("2.1f FloatLiteral as Object", float(2.1), 2.1
f as Object
)

Assert.expectEq("3.14f as int", null, pi_float as int);
Assert.expectEq("3.14f FloatLiteral as int", null, 3.14
f as int
)

AddStrictTestCase("3f as int", null, three as int);
AddStrictTestCase("3f FloatLiteral as int", null, 3
f as int
)

Assert.expectEq("-3f as int", null, minus_three as int);
Assert.expectEq("-3f FloatLiteral as int", null, -3
f as int
)

Assert.expectEq("3.14f as uint", null, pi_float as uint);
Assert.expectEq("3.14f FloatLiteral as uint", null, 3.14
f as uint
)

Assert.expectEq("3f as uint", null, three as uint);
Assert.expectEq("3f FloatLiteral as uint", null, 3
f as uint
)
...
Assert.expectEq("0f FloatLiteral as String", null, 0
f as String
)

Assert.expectEq("0f as Boolean", null, zero as Boolean);
Assert.expectEq("0f FloatLiteral as Boolean", null, 0
f as Boolean
)

Assert.expectEq("0f as Error", null, zero as Error);
Assert.expectEq("0f FloatLiteral as Error", null, 0
f as Error
)
...
AddStrictTestCase("Number(float.MAX_VALUE) as float", null, (Number(float.MAX_VALUE)) as float);
AddStrictTestCase("Number(float.MIN_VALUE) as float", null, (Number(float.MIN_VALUE)) as float);
