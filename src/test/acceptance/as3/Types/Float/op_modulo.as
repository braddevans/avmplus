...
Assert.expectEq("FloatLiteral modulo result", float(7.874126434326171875e-01), 1.2345678e9
f % 6.543210987
f
)
...
AddStrictTestCase("FloatLiteral % Number", 0, check(1
f, 1
))

AddStrictTestCase("Number % float", 0, check(1, onef));
AddStrictTestCase("Number % FloatLiteral", 0, check(1, 1
f
))
