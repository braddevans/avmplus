...
var obj2: Object = {1.0f
:
"bar"
}

Assert.expectEq("delete on FloatLiteral property index", true, delete (obj2[1.0
f
]))

Assert.expectEq("delete on FloatLiteral property index", undefined, obj2[1.0
f
])
