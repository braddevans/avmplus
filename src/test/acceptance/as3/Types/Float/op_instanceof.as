...
Assert.expectEq("FloatLiteral is instanceof float", true, 1
f instanceof float
)
...
Assert.expectEq("FloatLiteral is instanceof Object", true, 1
f instanceof Object
)
...
Assert.expectEq("FloatLiteral is not instanceof Number", false, 1
f instanceof Number
)
...
Assert.expectEq("FloatLiteral is not instanceof int", false, 1
f instanceof int
)
...
Assert.expectEq("FloatLiteral is not instanceof uint", false, 1
f instanceof uint
)
...
Assert.expectEq("FloatLiteral is not instanceof String", false, 1
f instanceof String
)

Assert.expectEq("float instance is not instanceof String", false, onef instanceof String);

Assert.expectError("AS: TypeError if datatype is not Class or Function", Utils.TYPEERROR, function () {
    return 1
    f instanceof 1
    f;
});
