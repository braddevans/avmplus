...
AddStrictTestCase("float.exp(0f)", 1
f, float.exp(0
f
))

AddStrictTestCase("float.exp(0f) check()", 1
f, check(0
f
))
...
AddStrictTestCase("float.exp(float.NEGATIVE_INFINITY)", 0
f, float.exp(float.NEGATIVE_INFINITY)
)
...
AddStrictTestCase("float.exp(float.NEGATIVE_INFINITY) check()", 0
...
AddStrictTestCase("float.exp(null)", 1
f, float.exp(null)
)
...
AddStrictTestCase("float.exp(1) check()", float.E, check(1
f
))


AddStrictTestCase("float.exp(float.MIN_VALUE)", 1
f, float.exp(float.MIN_VALUE)
)
