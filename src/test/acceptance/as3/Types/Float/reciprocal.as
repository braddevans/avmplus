...
function check(param: float): float {
    return float.reciprocal(param);
}

AddStrictTestCase("float.reciprocal() returns a float", "float", getQualifiedClassName(float.reciprocal(12.345
f
)))
...
AddStrictTestCase("float.reciprocal(float.POSITIVE_INFINITY) sign check", float.POSITIVE_INFINITY, 1
f / float.reciprocal(float.POSITIVE_INFINITY)
)

AddStrictTestCase("float.reciprocal(float.POSITIVE_INFINITY) check()", float(0), float.reciprocal(float.POSITIVE_INFINITY));
AddStrictTestCase("float.reciprocal(float.POSITIVE_INFINITY) check() sign check", float.POSITIVE_INFINITY, 1
...
AddStrictTestCase("float.reciprocal(float.NEGATIVE_INFINITY) sign check", float.NEGATIVE_INFINITY, 1
f / float.reciprocal(float.NEGATIVE_INFINITY)
)

AddStrictTestCase("float.reciprocal(float.NEGATIVE_INFINITY) check()", float(-0), check(float.NEGATIVE_INFINITY));
AddStrictTestCase("float.reciprocal(float.NEGATIVE_INFINITY) check() sign check", float.NEGATIVE_INFINITY, 1
f / check(float.NEGATIVE_INFINITY)
)


// If x is +0, the result is +Infinity
AddStrictTestCase("float.reciprocal(0f)", float.POSITIVE_INFINITY, float.reciprocal(0
f
))

AddStrictTestCase("float.reciprocal(0f) check()", float.POSITIVE_INFINITY, check(0
f
))


// If x us -0, the result is -Infinity
AddStrictTestCase("float.reciprocal(-0f)", float.NEGATIVE_INFINITY, float.reciprocal(-0
f
))

AddStrictTestCase("float.reciprocal(-0f) check", float.NEGATIVE_INFINITY, check(-0
f
))
