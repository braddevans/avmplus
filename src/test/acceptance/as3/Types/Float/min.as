...
AddStrictTestCase("float.min(undefined, 2.1f, 3.2f)", float.NaN, float.min(undefined, 2.1
f, 3.2
f
))

AddStrictTestCase("float.min(2.1f, undefined, 3.2f)", float.NaN, float.min(2.1
f, undefined, 3.2
f
))

AddStrictTestCase("float.min(2.1f, 3.2f, undefined)", float.NaN, float.min(2.1
f, 3.2
f, undefined
))


AddStrictTestCase("float.min('string', 2.1f, 3.2f)", float.NaN, float.min('string', 2.1
f, 3.2
f
))

AddStrictTestCase("float.min(2.1f, 'string', 3.2f)", float.NaN, float.min(2.1
f, 'string', 3.2
f
))

AddStrictTestCase("float.min(2.1f, 3.2f, 'string')", float.NaN, float.min(2.1
f, 3.2
f, 'string'
))


AddStrictTestCase("float.min(Number.NaN, 2.1f, 3.2f)", float.NaN, float.min(Number.NaN, 2.1
f, 3.2
f
))

AddStrictTestCase("float.min(2.1f, Number.NaN, 3.2f)", float.NaN, float.min(2.1
f, Number.NaN, 3.2
f
))

AddStrictTestCase("float.min(2.1f, 3.2f, Number.NaN)", float.NaN, float.min(2.1
f, 3.2
f, Number.NaN
))


AddStrictTestCase("float.min(float.NaN, 2.1f, 3.2f)", float.NaN, float.min(float.NaN, 2.1
f, 3.2
f
))

AddStrictTestCase("float.min(2.1f, float.NaN, 3.2f)", float.NaN, float.min(2.1
f, float.NaN, 3.2
f
))

AddStrictTestCase("float.min(2.1f, 3.2f, float.NaN)", float.NaN, float.min(2.1
f, 3.2
f, float.NaN
))
...
AddStrictTestCase("float.min(1f, 1f)", 1
f, float.min(1
f, 1
f
))

AddStrictTestCase("float.min(1f, 0f)", 0
f, float.min(1
f, 0
f
))

AddStrictTestCase("float.min(0f, 1f)", 0
f, float.min(0
f, 1
f
))
...
AddStrictTestCase("float.min( 0f,  0f)", 0
f, float.min(0
f, 0
f
))

AddStrictTestCase("float.min( 0f,  0f) check sign", true, isPositive(float.min(0
f, 0
f
)))
...
AddStrictTestCase("float.min(-0f, -0f) check sign", false, isPositive(float.min(-0
f, -0
f
)))
...
AddStrictTestCase("float.min(null, 1f)", 0
f, float.min(null, 1
f
))

AddStrictTestCase("float.min(-1f, null)", -1
f, float.min(-1
f, null
))

AddStrictTestCase("float.min(false, true)", 0
f, float.min(false, true)
)
...
AddStrictTestCase("float.min(float.MIN_VALUE, 0f)", 0
f, float.min(float.MIN_VALUE, 0
f
))

AddStrictTestCase("float.min(float.MIN_VALUE, 1.401298464324819e-45f)", float.MIN_VALUE, float.min(float.MIN_VALUE, 1.401298464324819e-45
f
))

AddStrictTestCase("float.min(float.MIN_VALUE, 1.401298464324820e-45f)", float.MIN_VALUE, float.min(float.MIN_VALUE, 1.401298464324820e-45
f
))
...
AddStrictTestCase("float.min('2', true, 3.1, -3.124f) literals", myfloat, float.min('2', true, 3.1, -3.124
f
))

AddStrictTestCase("float.min('2', true, 3.1, -3.124f, '-24')", -24
f, float.min(myString, myBool, myNum, myfloat, String('-24'))
)

AddStrictTestCase("float.min('2', true, 3.1, -3.124f, '24') literals", myfloat, float.min('2', true, 3.1, -3.124
f, '24'
))
