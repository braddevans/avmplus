...
Assert.expectEq("unary minus on float.MAX_VALUE", -3.40282346638528e+38
f, -float.MAX_VALUE
)

Assert.expectEq("unary minus on float.MIN_VALUE", -1.401298464324817e-45
f, -float.MIN_VALUE
)
