...
Assert.expectEq("float constructor default value is NOT -0.0f", true, FloatRawBits(result) != FloatRawBits(-0.0
f
))
 // FloatRawBits(-0.0f) is not 0.

var resultf: float = new float();
Assert.expectEq("typed float as function default value +0.0f", 0, FloatRawBits(resultf));
Assert.expectEq("typed float as function default value is NOT -0.0f", true, FloatRawBits(resultf) != FloatRawBits(-0.0
f
))
 // FloatRawBits(-0.0f) is not 0.
