...
AddStrictTestCase("float.sqrt(-0.1f)", float.NaN, float.sqrt(-0.1
f
))

AddStrictTestCase("float.sqrt(-0.1f) check()", float.NaN, check(-0.1
f
))
...
var zero: float = 0
f;
AddStrictTestCase("float.sqrt(zero=0f)", 0
f, float.sqrt(zero)
)

AddStrictTestCase("float.sqrt(0f) FloatLiteral", 0
f, float.sqrt(0
f
))

AddStrictTestCase("float.sqrt(0f) sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / float.sqrt(0
f
))

AddStrictTestCase("float.sqrt(0f) check()", 0
f, check(0
f
))

AddStrictTestCase("float.sqrt(0f) check() sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / check(0
f
))

AddStrictTestCase("float.sqrt(null)", 0
f, float.sqrt(null)
)
...
f;
AddStrictTestCase("float.sqrt(neg_zero=-0f)", -0
f, float.sqrt(neg_zero)
)
...
AddStrictTestCase("float.sqrt(-0f) sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / float.sqrt(-0
f
))
...
AddStrictTestCase("float.sqrt(-0f) check() sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / check(-0
f
))
...
AddStrictTestCase("float.sqrt(2f)", float.SQRT2, float.sqrt(2
f
))

AddStrictTestCase("float.sqrt(0.5f)", float.SQRT1_2, float.sqrt(0.5
f
))
