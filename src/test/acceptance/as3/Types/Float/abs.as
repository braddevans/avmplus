...
AddStrictTestCase("float.abs(0.0f)", 0
f, float.abs(0.0
f
))

AddStrictTestCase("float.POSITIVE_INFINITY/float.abs(0.0f)", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / float.abs(0.0
f
))
...
AddStrictTestCase("float.POSITIVE_INFINITY/check(-0.0f)", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / check(-0.0
f
))
...
AddStrictTestCase("float.abs(null)", 0
f, float.abs(null)
)
