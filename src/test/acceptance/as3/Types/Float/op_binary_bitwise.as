...
Assert.expectEq("Bitwise AND on FloatLiteral returns a int", "int", getQualifiedClassName(-1.2345678e9
f & 3.1223
f
))
...
AddStrictTestCase("Bitwise AND on FloatLiteral 5f and 3f", 1, 5
f & 3
f
)
...
AddStrictTestCase("Bitwise AND on FloatLiteral 3.125f and 2.1f", 2, 3.125
f & 2.1
f
)
...
AddStrictTestCase("Bitwise AND on FloatLiteral 0.62e-1f and 1.3125e+1f", 4, 0.62e+1
f & 131.25e-1
f
)
...
Assert.expectEq("Bitwise XOR on FloatLiteral returns a int", "int", getQualifiedClassName(2
f ^ 2
f
))
...
AddStrictTestCase("Bitwise XOR on FloatLiteral 5f and 3f", 6, 5
f ^ 3
f
)
...
AddStrictTestCase("Bitwise XOR on FloatLiteral 3.125f and 2.1f", 1, 3.125
f ^ 2.1
f
)
...
AddStrictTestCase("Bitwise XOR on FloatLiteral 0.62e-1f and 1.3125e+1f", 11, 0.62e+1
f ^ 131.25e-1
f
)
...
Assert.expectEq("Bitwise OR on FloatLiteral returns a int", "int", getQualifiedClassName(2
f | 2
f
))
...
AddStrictTestCase("Bitwise OR on FloatLiteral 5f and 3f", 7, 5
f | 3
f
)
...
AddStrictTestCase("Bitwise OR on FloatLiteral 3.125f and 2.1f", 3, 3.125
f | 2.1
f
)
...
AddStrictTestCase("Bitwise OR on FloatLiteral 0.62e-1f and 1.3125e+1f", 15, 0.62e+1
f | 131.25e-1
f
)
