...
Assert.expectEq("FloatLiteral addition result", float(1.234633216e+09), 1.2345678e9
f + 65432.10987
f
)
...
AddStrictTestCase("FloatLiteral + Number", 2, check(1
f, 1
))

AddStrictTestCase("Number + float", 2, check(1, onef));
AddStrictTestCase("Number + FloatLiteral", 2, check(1, 1
f
))
