...
AddStrictTestCase("float.log(-1f)", float.NaN, float.log(-1
f
))

AddStrictTestCase("float.log(-1f) check()", float.NaN, check(-1
f
))
...
AddStrictTestCase("float.log(0f)", float.NEGATIVE_INFINITY, float.log(0
f
))

AddStrictTestCase("float.log(0f) check()", float.NEGATIVE_INFINITY, check(0
f
))
...
AddStrictTestCase("float.log(1f)", 0
f, float.log(1
f
))

AddStrictTestCase("float.log(1f) check()", 0
f, check(1
f
))

AddStrictTestCase("float.log(1f) is +0f", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / float.log(1
f
))

AddStrictTestCase("float.log(1f) is +0f check()", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / check(1
f
))
...
var myfloat: float = 1.0e-6
f;
AddStrictTestCase("float.log(-1.0e-6f)", float.NaN, float.log(-myfloat));
AddStrictTestCase("float.log(1.0e-6f)", -13.8155107498168945
f, float.log(myfloat)
)

AddStrictTestCase("float.log(-1.0e-6f) FloatLiteral", float.NaN, float.log(-1.0e-6
f
))

AddStrictTestCase("float.log(1.0e-6f) FloatLiteral", -13.8155107498168945
f, float.log(1.0e-6
f
))
...
AddStrictTestCase("float.log(-1f) FloatLiteral", float.NaN, float.log(-1
f
))

AddStrictTestCase("float.log(1f) FloatLiteral", 0
f, float.log(1
f
))
