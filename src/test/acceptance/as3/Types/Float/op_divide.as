...
AddStrictTestCase("FloatLiteral division result", float(1.886792e+08), 1.2345678e9
f / 6.543210987
f
)
...
var val1: float = 4.734612e3
f;
var val2: float = 5.417242e5
f;
AddStrictTestCase("multiplication of 2 floats", 2.564853760e9
f, val1 * val2
)
...
f * 5.417242e5
f;
AddStrictTestCase("multiplication of 2 FloatLiterals", 2.564853760e9
f, val3
)
...
AddStrictTestCase("FloatLiteral / Number", 1, check(1
f, 1
))

AddStrictTestCase("Number / float", 1, check(1, onef));
AddStrictTestCase("Number / FloatLiteral", 1, check(1, 1
f
))
...
Assert.expectEq("float.NaN / FloatLiteral", float.NaN, float.NaN / 1
f
)

Assert.expectEq("isNaN float.NaN / FloatLiteral", true, isNaN(float.NaN / 1
f
))

Assert.expectEq("FloatLiteral / float.NaN", float.NaN, 1
f / float.NaN
)

Assert.expectEq("isNaN FloatLiteral / float.NaN", true, isNaN(1
f / float.NaN
))

Assert.expectEq("check(float.NaN, FloatLiteral)", float.NaN, check(float.NaN, 1
f
))

Assert.expectEq("isNaN check(float.NaN, FloatLiteral)", true, isNaN(check(float.NaN, 1
f
)))

Assert.expectEq("check(FloatLiteral, float.NaN)", float.NaN, check(1
f, float.NaN
))

Assert.expectEq("isNaN check(FloatLiteral, float.NaN)", true, isNaN(check(1
f, float.NaN
)))


// result is positive if both have same sign, negative if they differ
AddStrictTestCase("float / float", 1
f, 1
f / 1
f
)
...
AddStrictTestCase("check(float, float)", 1
f, check(1
f, 1
f
))
...
AddStrictTestCase("float.POSITIVE_INFINITY / float", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / 0
f
)

AddStrictTestCase("check(float.POSITIVE_INFINITY, float)", float.POSITIVE_INFINITY, check(float.POSITIVE_INFINITY, 0
f
))

AddStrictTestCase("float.POSITIVE_INFINITY / -float", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / -0
f
)

AddStrictTestCase("check(float.POSITIVE_INFINITY, -float)", float.NEGATIVE_INFINITY, check(float.POSITIVE_INFINITY, -0
f
))

AddStrictTestCase("float.NEGATIVE_INFINITY / float", float.NEGATIVE_INFINITY, float.NEGATIVE_INFINITY / 0
f
)

AddStrictTestCase("check(float.NEGATIVE_INFINITY, float)", float.NEGATIVE_INFINITY, check(float.NEGATIVE_INFINITY, 0
f
))

AddStrictTestCase("float.NEGATIVE_INFINITY / -float", float.POSITIVE_INFINITY, float.NEGATIVE_INFINITY / -0
f
)

AddStrictTestCase("check(float.NEGATIVE_INFINITY, -float)", float.POSITIVE_INFINITY, check(float.NEGATIVE_INFINITY, -0
f
))
...
AddStrictTestCase("float.POSITIVE_INFINITY / float", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / 1
f
)

AddStrictTestCase("check(float.POSITIVE_INFINITY, float)", float.POSITIVE_INFINITY, check(float.POSITIVE_INFINITY, 1
f
))

AddStrictTestCase("float.POSITIVE_INFINITY / -float", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / -1
f
)

AddStrictTestCase("check(float.POSITIVE_INFINITY, -float)", float.NEGATIVE_INFINITY, check(float.POSITIVE_INFINITY, -1
f
))

AddStrictTestCase("float.NEGATIVE_INFINITY / float", float.NEGATIVE_INFINITY, float.NEGATIVE_INFINITY / 1
f
)

AddStrictTestCase("check(float.NEGATIVE_INFINITY, float)", float.NEGATIVE_INFINITY, check(float.NEGATIVE_INFINITY, 1
f
))

AddStrictTestCase("float.NEGATIVE_INFINITY / -float", float.POSITIVE_INFINITY, float.NEGATIVE_INFINITY / -1
f
)

AddStrictTestCase("check(float.NEGATIVE_INFINITY, -float)", float.POSITIVE_INFINITY, check(float.NEGATIVE_INFINITY, -1
f
))
...
AddStrictTestCase("float / float.POSITIVE_INFINITY", 0
f, 1
f / float.POSITIVE_INFINITY
)

AddStrictTestCase("float / float.POSITIVE_INFINITY sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / (1
f / float.POSITIVE_INFINITY
))

AddStrictTestCase("check(float, float.POSITIVE_INFINITY)", 0
f, check(1
f, float.POSITIVE_INFINITY
))
...
AddStrictTestCase("-float / float.POSITIVE_INFINITY sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / (-1
f / float.POSITIVE_INFINITY
))
...
AddStrictTestCase("float / float.NEGATIVE_INFINITY", -0
f, 1
f / float.NEGATIVE_INFINITY
)

AddStrictTestCase("float / float.NEGATIVE_INFINITY sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / (1
f / float.NEGATIVE_INFINITY
))

AddStrictTestCase("check(float, float.NEGATIVE_INFINITY)", -0
f, check(1
f, float.NEGATIVE_INFINITY
))
...
AddStrictTestCase("0f / 1f", 0
f, 0
f / 1
f
)

AddStrictTestCase("0f / 1f sign check", float.POSITIVE_INFINITY, float.POSITIVE_INFINITY / (0
f / 1
f
))

AddStrictTestCase("check(0f, 1f)", 0
f, check(0
f, 1
f
))
...
AddStrictTestCase("0f / -1f sign check", float.NEGATIVE_INFINITY, float.POSITIVE_INFINITY / (0
f / -1
f
))
...
AddStrictTestCase("1f / 0f", float.POSITIVE_INFINITY, 1
f / 0
f
)

AddStrictTestCase("-1f / 0f", float.NEGATIVE_INFINITY, -1
f / 0
f
)
...
AddStrictTestCase("check(1f, 0f)", float.POSITIVE_INFINITY, check(1
f, 0
f
))

AddStrictTestCase("check(-1f, 0f)", float.NEGATIVE_INFINITY, check(-1
f, 0
f
))
