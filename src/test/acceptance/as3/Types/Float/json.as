...
Assert.expectEq("float serializes as number", "37.5", JSON.stringify(37.5
f
))


Assert.expectEq("float can be used to denote spaces", "[\n    37\n]", JSON.stringify([37], null, 4
f
))


Assert.expectEq("float can be used as a property name in the replacer array", "{\"1\":\"b\",\"3\":\"d\"}", JSON.stringify({
    0: "a",
    1: "b",
    2: "c",
    3: "d"
...
float.prototype.toJSON = float.prototype.toJSON = function (k) {
    return this + 5
};
