...
Assert.expectEq("3.14f FloatLiteral is float", true, 3.14
f is float
)

Assert.expectEq("3.14f is NOT Number", false, pi_float is Number);
Assert.expectEq("3.14f FloatLiteral is NOT Number", false, 3.14
f is Number
)

Assert.expectEq("3.14f is Object", true, pi_float is Object);
Assert.expectEq("2.1f FloatLiteral is Object", true, 2.1
f is Object
)

Assert.expectEq("3.14f is NOT int", false, pi_float is int);
Assert.expectEq("3.14f FloatLiteral is NOT int", false, 3.14
f is int
)
...
Assert.expectEq("3f FloatLiteral is NOT int", false, 3
f is int
)


var minus_three: float = -3
f;
...
Assert.expectEq("3.14f FloatLiterl is NOT uint", false, 3.14
f is uint
)

Assert.expectEq("3f is NOT uint", false, three is uint);
Assert.expectEq("3f FloatLiteral is NOT uint", false, 3
f is uint
)
...
Assert.expectEq("0f FloatLiteral is NOT uint", false, 0
f is uint
)
...
Assert.expectEq("0f FloatLiteral is NOT String,", false, 0
f is String
)

Assert.expectEq("0f FloatLiteral is NOT Boolean", false, 0
f is Boolean
)

Assert.expectEq("0f FloatLiteral is NOT Error", false, 0
f is Error
)
...
Assert.expectEq("Number(float.MAX_VALUE) is NOT float", false, (Number(float.MAX_VALUE)) is float);
Assert.expectEq("Number(float.MIN_VALUE) is NOT float", false, (Number(float.MIN_VALUE)) is float);
Assert.expectEq("Number(Infinity) is NOT float", false, (Number(Infinity)) is float);
