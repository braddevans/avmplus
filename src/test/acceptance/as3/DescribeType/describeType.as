...
public class Foo extends FooBase implements IFoo {
    ...
    function Foo(q: int, s: String = "") {
        z = q;
    }

    [metahere(foo="blah")]
    public function yah(d: Number): String {
        return String(z + d);
    }

    ns function yah(d: Number): String {
        return String(z + d);
    }
...
public class Foo2 extends Foo implements IFoo {
    ...
    override public function yah(d: Number): String {
        return String(z + d + 1);
    }
...
var xv =
    <type name="__AS3__.vec::Vector.&lt;String&gt;" base="__AS3__.vec::Vector.&lt;*&gt;" isDynamic="true"
...
Assert.expectEq("getQualifiedClassName(new Object)", "Object", getQualifiedClassName({}));
...
Assert.expectEq("getQualifiedSuperclassName(new Object)", null, getQualifiedSuperclassName({}));
