...
Assert.expectError("si8(Domain.MIN_DOMAIN_MEMORY_LENGTH) prior to initMemory()",
    Utils.RANGEERROR + 1506,
    function () {
        SI8(0x01, Domain.MIN_DOMAIN_MEMORY_LENGTH);
    });
...
clearMemory();
Assert.expectError("si8(0x01, -1)", Utils.RANGEERROR + 1506, function () {
    SI8(0x01, -1);
});
Assert.expectError("si8(0x01, mem.length)", Utils.RANGEERROR + 1506, function () {
    SI8(0x01, mem.length);
});
