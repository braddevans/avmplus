...
Assert.expectError("sf32(Domain.MIN_DOMAIN_MEMORY_LENGTH) prior to initMemory()",
    ...
    function () {
        SF32(0x41460200, Domain.MIN_DOMAIN_MEMORY_LENGTH);
    });
...
clearMemory();
Assert.expectError("sf32(0x41460200, -1)", Utils.RANGEERROR + 1506, function () {
    SF32(0x41460200, -1);
});
Assert.expectError("sf32(0x41460200, mem.length)", Utils.RANGEERROR + 1506, function () {
    SF32(0x41460200, mem.length);
});
Assert.expectError("sf32(0x41460200, mem.length-1)", Utils.RANGEERROR + 1506, function () {
    SF32(0x41460200, mem.length - 1);
});
Assert.expectError("sf32(0x41460200, mem.length-2)", Utils.RANGEERROR + 1506, function () {
    SF32(0x41460200, mem.length - 2);
});
Assert.expectError("sf32(0x41460200, mem.length-3)", Utils.RANGEERROR + 1506, function () {
    SF32(0x41460200, mem.length - 3);
});
