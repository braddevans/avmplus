...
try {
    currentDomain.domainMemory = function (i: int): int {
        return i;
    };
    wrongObj3Ok = true;
} catch (e: *) {
...
function writeTestByte(salt: int): Boolean {
    return writeTest(salt, 1,
        function (a: int, b: int): Boolean {
            return (a & 0xff) == (b & 0xff);
        },
        currentDomain.domainMemory.readUnsignedByte,
        function (v: int, n: int): void {
            SI8(v, n);
        }
    );
}
...
function rangeReadTestByte(): Boolean {
    return rangeTest(1, function (n: int): void {
        LI8(n);
    });
}
...
function rangeOffsReadTestByte(): Boolean {
    return rangeTest(1, function (n: int): void {
        ...
        rangeTest(1, function (n: int): void {
            var k: int = n + 4;
            LI8(SUBTRACT_I(k, 4));
        }) &&
        rangeTest(1, function (n: int): void {
...
function rangeReadTestShort(): Boolean {
    return rangeTest(2, function (n: int): void {
        LI16(n);
    });
}
...
function rangeOffsReadTestShort(): Boolean {
    return rangeTest(2, function (n: int): void {
        ...
        rangeTest(2, function (n: int): void {
            var k: int = n + 4;
            LI16(SUBTRACT_I(k, 4));
        }) &&
        rangeTest(2, function (n: int): void {
...
function rangeReadTestInt(): Boolean {
    return rangeTest(4, function (n: int): void {
        LI32(n);
    });
}
...
function rangeOffsReadTestInt(): Boolean {
    return rangeTest(4, function (n: int): void {
        ...
        rangeTest(4, function (n: int): void {
            var k: int = n + 4;
            LI32(SUBTRACT_I(k, 4));
        }) &&
        rangeTest(4, function (n: int): void {
...
function rangeReadTestDouble(): Boolean {
    return rangeTest(8, function (n: int): void {
        LF64(n);
    });
}
...
function rangeOffsReadTestDouble(): Boolean {
    return rangeTest(8, function (n: int): void {
        ...
        rangeTest(8, function (n: int): void {
            var k: int = n + 4;
            LF64(SUBTRACT_I(k, 4));
        }) &&
        rangeTest(8, function (n: int): void {
