...
Assert.expectError("si32(Domain.MIN_DOMAIN_MEMORY_LENGTH) prior to initMemory()",
    ...
    function () {
        SI32(0x01110101, Domain.MIN_DOMAIN_MEMORY_LENGTH);
    });
...
clearMemory();
Assert.expectError("si32(0x01010101, -1)", Utils.RANGEERROR + 1506, function () {
    SI32(0x01010101, -1);
});
Assert.expectError("si32(0x01010101, mem.length)", Utils.RANGEERROR + 1506, function () {
    SI32(0x01010101, mem.length);
});
Assert.expectError("si32(0x01010101, mem.length-1)", Utils.RANGEERROR + 1506, function () {
    SI32(0x01010101, mem.length - 1);
});
Assert.expectError("si32(0x01010101, mem.length-2)", Utils.RANGEERROR + 1506, function () {
    SI32(0x01010101, mem.length - 2);
});
Assert.expectError("si32(0x01010101, mem.length-3)", Utils.RANGEERROR + 1506, function () {
    SI32(0x01010101, mem.length - 3);
});
