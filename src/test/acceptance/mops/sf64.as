...
Assert.expectError("sf64(Domain.MIN_DOMAIN_MEMORY_LENGTH) prior to initMemory()",
    ...
    function () {
        SF64(2.8846085099489688873291015625E6, Domain.MIN_DOMAIN_MEMORY_LENGTH);
    });
...
clearMemory();
Assert.expectError("sf64(0x4146020041460200, -1)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, -1);
});
Assert.expectError("sf64(0x4146020041460200, mem.length)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length);
});
Assert.expectError("sf64(0x4146020041460200, mem.length-1)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length - 1);
});
Assert.expectError("sf64(0x4146020041460200, mem.length-2)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length - 2);
});
Assert.expectError("sf64(0x4146020041460200, mem.length-3)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length - 3);
});
Assert.expectError("sf64(0x4146020041460200, mem.length-4)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length - 4);
});
Assert.expectError("sf64(0x4146020041460200, mem.length-5)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length - 5);
});
Assert.expectError("sf64(0x4146020041460200, mem.length-6)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length - 6);
});
Assert.expectError("sf64(0x4146020041460200, mem.length-7)", Utils.RANGEERROR + 1506, function () {
    SF64(2.8846085099489688873291015625E6, mem.length - 7);
});
