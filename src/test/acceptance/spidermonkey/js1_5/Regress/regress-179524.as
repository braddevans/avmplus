...
//status = inSection(17);
actual = function () {
    str.match(new RegExp('a', 'i'), 'g').toString()
};
expect = 'ArgumentError: Error #1063';
Assert.expectError(status, expect, actual);
...
//status = inSection(18);
actual = function () {
    str.match(new RegExp('a', 'ig'), {}).toString()
};
expect = 'ArgumentError: Error #1063';
Assert.expectError(status, expect, actual);
...
//status = inSection(19);
actual = function () {
    str.match(new RegExp('\\s', 'm'), 999).toString()
};
expect = 'ArgumentError: Error #1063';
Assert.expectError(status, expect, actual);
