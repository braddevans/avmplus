...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("Number(new String())", 0, Number(String()));
    array[item++] = Assert.expectEq("Number('')", 0, Number(""));
    ...
    array[item++] = Assert.expectEq("Number(new String('Number.POSITIVE_INFINITY')", Infinity, Number(String(Number.POSITIVE_INFINITY)));
