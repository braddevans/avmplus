...
CompareSplit(String("hello"));

var origNumberSplit = Number.prototype.split;
Number.prototype.split = String.prototype.split;

CompareSplit(Number(100111122133144155), 1);
CompareSplitWithLimit(Number(100111122133144155), 1, 1);

CompareSplitWithLimit(Number(100111122133144155), 1, 2);
CompareSplitWithLimit(Number(100111122133144155), 1, 0);
CompareSplitWithLimit(Number(100111122133144155), 1, 100);
CompareSplitWithLimit(Number(100111122133144155), 1, void 0);
CompareSplitWithLimit(Number(100111122133144155), 1, Math.pow(2, 32) - 1);
CompareSplitWithLimit(Number(100111122133144155), 1, "boo");
CompareSplitWithLimit(Number(100111122133144155), 1, -(Math.pow(2, 32) - 1));
