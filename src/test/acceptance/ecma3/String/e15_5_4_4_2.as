...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("x = new String(); x.charAt(0)", "", (x = String(), x.charAt(0)));
    array[item++] = Assert.expectEq("x = new String(); x.charAt(1)", "", (x = String(), x.charAt(1)));
    array[item++] = Assert.expectEq("x = new String(); x.charAt(-1)", "", (x = String(), x.charAt(-1)));

    array[item++] = Assert.expectEq("x = new String(); x.charAt(NaN)", "", (x = String(), x.charAt(Number.NaN)));
    array[item++] = Assert.expectEq("x = new String(); x.charAt(Number.POSITIVE_INFINITY)", "", (x = String(), x.charAt(Number.POSITIVE_INFINITY)));
    array[item++] = Assert.expectEq("x = new String(); x.charAt(Number.NEGATIVE_INFINITY)", "", (x = String(), x.charAt(Number.NEGATIVE_INFINITY)));
