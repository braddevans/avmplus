...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        TEST_STRING.length,
        (s = String(TEST_STRING), s.split('').length));
    ...
    for (var i = 0; i < TEST_STRING.length; i++) {
        ...
        array[item++] = Assert.expectEq(
            ...
            (s = String(TEST_STRING), s.split('')[i]));
    }
    ...
    array[item++] = Assert.expectEq(
        ...
        EXPECT_STRING.length,
        (s = String(TEST_STRING), s.split(null).length));

    for (var i = 0; i < EXPECT_STRING.length; i++) {
        array[item++] = Assert.expectEq(
            "var s = new String( " + TEST_STRING + " ); s.split(null)[" + i + "]",
            EXPECT_STRING[i],
            (s = String(TEST_STRING), s.split(null)[i]));
    }
    ...
    array[item++] = Assert.expectEq(
        ...
        EXPECT_STRING.length,
        (s = String(TEST_STRING), s.split(true).length));

    for (var i = 0; i < EXPECT_STRING.length; i++) {
        array[item++] = Assert.expectEq(
            "var s = new String( " + TEST_STRING + " ); s.split(true)[" + i + "]",
            EXPECT_STRING[i],
            (s = String(TEST_STRING), s.split(true)[i]));
    }
    ...
    array[item++] = Assert.expectEq(
        ...
        EXPECT_STRING.length,
        (s = String(TEST_STRING), s.split(123).length));

    for (var i = 0; i < EXPECT_STRING.length; i++) {
        array[item++] = Assert.expectEq(
            "var s = new String( " + TEST_STRING + " ); s.split(123)[" + i + "]",
            EXPECT_STRING[i],
            (s = String(TEST_STRING), s.split(123)[i]));
    }
    ...
    array[item++] = Assert.expectEq(
        ...
        TEST_STRING,
        (s = String(TEST_STRING), s.split(':')[0]));
    ...
    array[item++] = Assert.expectEq(
        ...
        1,
        (s = String(TEST_STRING), s.split('strings').length));

    array[item++] = Assert.expectEq(
        "var s = new String( " + TEST_STRING + " ); s.split('strings')[0]",
        TEST_STRING,
        (s = String(TEST_STRING), s.split('strings')[0]));
    ...
    array[item++] = Assert.expectEq(
        ...
        2,
        (s = String(TEST_STRING), s.split('string').length));

    for (var i = 0; i < EXPECT_STRING.length; i++) {
        array[item++] = Assert.expectEq(
            "var s = new String( " + TEST_STRING + " ); s.split('string')[" + i + "]",
            EXPECT_STRING[i],
            (s = String(TEST_STRING), s.split('string')[i]));
    }
    return array;
}
