...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        "this is a string object",
        (s = String('this is a string object'), s.substr(NaN)));


    array[item++] = Assert.expectEq(
        "var s = new String('this is a string object'); s.substr(-0.01)",
        "this is a string object",
        (s = String('this is a string object'), s.substr(-0.01)));


    array[item++] = Assert.expectEq(
        "var s = new String('this is a string object'); s.substr(s.length)",
        "",
        (s = String('this is a string object'), s.substr(s.length)));

    array[item++] = Assert.expectEq(
        "var s = new String('this is a string object'); s.substr(s.length+1)",
        "",
        (s = String('this is a string object'), s.substr(s.length + 1)));


    array[item++] = Assert.expectEq(
        "var s = new String('this is a string object'); s.substr(Infinity)",
        "",
        (s = String('this is a string object'), s.substr(Infinity)));
