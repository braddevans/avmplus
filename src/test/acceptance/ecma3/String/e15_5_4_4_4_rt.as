 ...
 */
    ...
    array[item++] = Assert.expectEq("x = new Array(1,2,3); x.charAt = String.prototype.charAt; x.charAt(0)", "1", (x = [1, 2, 3], x.charAt = String.prototype.charAt, x.charAt(0)));
    array[item++] = Assert.expectEq("x = new Array(1,2,3); x.charAt = String.prototype.charAt; x.charAt(1)", ",", (x = [1, 2, 3], x.charAt = String.prototype.charAt, x.charAt(1)));
    array[item++] = Assert.expectEq("x = new Array(1,2,3); x.charAt = String.prototype.charAt; x.charAt(2)", "2", (x = [1, 2, 3], x.charAt = String.prototype.charAt, x.charAt(2)));
    array[item++] = Assert.expectEq("x = new Array(1,2,3); x.charAt = String.prototype.charAt; x.charAt(3)", ",", (x = [1, 2, 3], x.charAt = String.prototype.charAt, x.charAt(3)));
    array[item++] = Assert.expectEq("x = new Array(1,2,3); x.charAt = String.prototype.charAt; x.charAt(4)", "3", (x = [1, 2, 3], x.charAt = String.prototype.charAt, x.charAt(4)));

    array[item++] = Assert.expectEq("x = new Array(); x.charAt = String.prototype.charAt; x.charAt(0)", "", (x = [], x.charAt = String.prototype.charAt, x.charAt(0)));
    ...
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(0)", "[", (x = {}, x.charAt = String.prototype.charAt, x.charAt(0)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(1)", "o", (x = {}, x.charAt = String.prototype.charAt, x.charAt(1)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(2)", "b", (x = {}, x.charAt = String.prototype.charAt, x.charAt(2)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(3)", "j", (x = {}, x.charAt = String.prototype.charAt, x.charAt(3)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(4)", "e", (x = {}, x.charAt = String.prototype.charAt, x.charAt(4)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(5)", "c", (x = {}, x.charAt = String.prototype.charAt, x.charAt(5)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(6)", "t", (x = {}, x.charAt = String.prototype.charAt, x.charAt(6)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(7)", " ", (x = {}, x.charAt = String.prototype.charAt, x.charAt(7)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(8)", "O", (x = {}, x.charAt = String.prototype.charAt, x.charAt(8)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(9)", "b", (x = {}, x.charAt = String.prototype.charAt, x.charAt(9)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(10)", "j", (x = {}, x.charAt = String.prototype.charAt, x.charAt(10)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(11)", "e", (x = {}, x.charAt = String.prototype.charAt, x.charAt(11)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(12)", "c", (x = {}, x.charAt = String.prototype.charAt, x.charAt(12)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(13)", "t", (x = {}, x.charAt = String.prototype.charAt, x.charAt(13)));
    array[item++] = Assert.expectEq("x = new Object(); x.charAt = String.prototype.charAt; x.charAt(14)", "]", (x = {}, x.charAt = String.prototype.charAt, x.charAt(14)));
