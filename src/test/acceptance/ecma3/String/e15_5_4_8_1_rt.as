...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        "object",
        (s = String('this is a string object'), typeof s.split()));

    array[item++] = Assert.expectEq(
        "var s = new String('this is a string object'); Array.prototype.getClass = Object.prototype.toString; (s.split()).getClass()",
        "[object Array]",
        (s = String('this is a string object'), Array.prototype.getClass = Object.prototype.toString, (s.split()).getClass()));

    array[item++] = Assert.expectEq(
        "var s = new String('this is a string object'); s.split().length",
        1,
        (s = String('this is a string object'), s.split().length));


    array[item++] = Assert.expectEq(
        "var s = new String('this is a string object'); s.split()[0]",
        "this is a string object",
        (s = String('this is a string object'), s.split()[0]));
    ...
    array[item++] = Assert.expectEq(
        ...
        "object",
        (obj = {}, obj.split = String.prototype.split, typeof obj.split()));

    array[item++] = Assert.expectEq(
        "var obj = new Object(); obj.split = String.prototype.split; Array.prototype.getClass = Object.prototype.toString; obj.getClass()",
        "[object Array]",
        (obj = {}, obj.split = String.prototype.split, Array.prototype.getClass = Object.prototype.toString, obj.split().getClass()));

    array[item++] = Assert.expectEq(
        "var obj = new Object(); obj.split = String.prototype.split; obj.split().length",
        1,
        (obj = {}, obj.split = String.prototype.split, obj.split().length));

    array[item++] = Assert.expectEq(
        "var obj = new Object(); obj.split = String.prototype.split; obj.split()[0]",
        "[object Object]",
        (obj = {}, obj.split = String.prototype.split, obj.split()[0]));
    ...
    array[item++] = Assert.expectEq(
        ...
        "object",
        (obj = function () {
        }, obj.split = String.prototype.split, typeof obj.split()));
    ...
    array[item++] = Assert.expectEq(
        ...
        1,
        (obj = function () {
        }, obj.split = String.prototype.split, obj.split().length));
    ...
    array[item++] = Assert.expectEq(
        ...
        "object",
        (obj = [1, 2, 3, 4, 5], obj.split = String.prototype.split, typeof obj.split()));
    ...
    array[item++] = Assert.expectEq(
        ...
        "[object Array]",
        (obj = [1, 2, 3, 4, 5], obj.split = String.prototype.split, Array.prototype.getClass = Object.prototype.toString, obj.split().getClass()));

    array[item++] = Assert.expectEq(
        "var obj = new Array(1,2,3,4,5); obj.split = String.prototype.split; obj.split().length",
        1,
        (obj = [1, 2, 3, 4, 5], obj.split = String.prototype.split, obj.split().length));

    array[item++] = Assert.expectEq(
        "var obj = new Array(1,2,3,4,5); obj.split = String.prototype.split; obj.split()[0]",
        "1,2,3,4,5",
        (obj = [1, 2, 3, 4, 5], obj.split = String.prototype.split, obj.split()[0]));
