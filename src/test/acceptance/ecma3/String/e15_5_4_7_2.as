...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("var s = new String(''), s.lastIndexOf('', 0)", LastIndexOf("", "", 0), (s = String(''), s.lastIndexOf('', 0)));
    array[item++] = Assert.expectEq("var s = new String(''), s.lastIndexOf('')", LastIndexOf("", ""), (s = String(''), s.lastIndexOf('')));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('', 0)", LastIndexOf("hello", "", 0), (s = String('hello'), s.lastIndexOf('', 0)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('')", LastIndexOf("hello", ""), (s = String('hello'), s.lastIndexOf('')));

    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll')", LastIndexOf("hello", "ll"), (s = String('hello'), s.lastIndexOf('ll')));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 0)", LastIndexOf("hello", "ll", 0), (s = String('hello'), s.lastIndexOf('ll', 0)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 1)", LastIndexOf("hello", "ll", 1), (s = String('hello'), s.lastIndexOf('ll', 1)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 2)", LastIndexOf("hello", "ll", 2), (s = String('hello'), s.lastIndexOf('ll', 2)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 3)", LastIndexOf("hello", "ll", 3), (s = String('hello'), s.lastIndexOf('ll', 3)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 4)", LastIndexOf("hello", "ll", 4), (s = String('hello'), s.lastIndexOf('ll', 4)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 5)", LastIndexOf("hello", "ll", 5), (s = String('hello'), s.lastIndexOf('ll', 5)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 6)", LastIndexOf("hello", "ll", 6), (s = String('hello'), s.lastIndexOf('ll', 6)));

    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 1.5)", LastIndexOf('hello', 'll', 1.5), (s = String('hello'), s.lastIndexOf('ll', 1.5)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', 2.5)", LastIndexOf('hello', 'll', 2.5), (s = String('hello'), s.lastIndexOf('ll', 2.5)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', -1)", LastIndexOf('hello', 'll', -1), (s = String('hello'), s.lastIndexOf('ll', -1)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', -1.5)", LastIndexOf('hello', 'll', -1.5), (s = String('hello'), s.lastIndexOf('ll', -1.5)));


    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', -Infinity)", LastIndexOf("hello", "ll", -Infinity), (s = String('hello'), s.lastIndexOf('ll', -Infinity)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', Infinity)", LastIndexOf("hello", "ll", Infinity), (s = String('hello'), s.lastIndexOf('ll', Infinity)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', NaN)", LastIndexOf("hello", "ll", NaN), (s = String('hello'), s.lastIndexOf('ll', NaN)));
    array[item++] = Assert.expectEq("var s = new String('hello'), s.lastIndexOf('ll', -0)", LastIndexOf("hello", "ll", -0), (s = String('hello'), s.lastIndexOf('ll', -0)));
    ...
    for (var i = 0; i < ("[object Object]").length; i++) {
        array[item++] = Assert.expectEq(
            ...
            (i < 2 ? -1 : (i < 9 ? 2 : 9)),
            (o = {}, o.lastIndexOf = String.prototype.lastIndexOf, o.lastIndexOf('b', i)));
    }
    ...
    for (var i = 0; i < 9; i++) {
        array[item++] = Assert.expectEq(
            ...
            (i < 3 ? -1 : (i < 5 ? 3 : 5)),
            (n = Number(Infinity), n.lastIndexOf('i', i)));
    }
