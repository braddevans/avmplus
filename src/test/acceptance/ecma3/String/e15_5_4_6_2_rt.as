...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("var s = new String(), s.indexOf()", -1, (s = String(), s.indexOf()));
    ...
    array[item++] = Assert.expectEq(
        ...
        true,
        (f = function () {
        }, f.toString = Object.prototype.toString, f.indexOf = String.prototype.indexOf, f.indexOf('[object Function-')) == 0 ||
        (f = function () {
        }, f.toString = Object.prototype.toString, f.indexOf = String.prototype.indexOf, f.indexOf('[object null]')) == 0
    );
    ...
    try {
        var m = Math;
        m.indexOf = String.prototype.indexOf;
        m.indexOf('Math');
    } catch (e8) {
