...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        "1,2,3,4,5",
        (s = [1, 2, 3, 4, 5], s.substring = String.prototype.substring, s.substring(Infinity, -Infinity)));

    array[item++] = Assert.expectEq(
        "var s = new Array(1,2,3,4,5); s.substring = String.prototype.substring; s.substring(9,-Infinity)",
        "1,2,3,4,5",
        (s = [1, 2, 3, 4, 5], s.substring = String.prototype.substring, s.substring(9, -Infinity)));


    array[item++] = Assert.expectEq(
        "var s = new Array(1,2,3,4,5); s.substring = String.prototype.substring; s.substring(true, false)",
        "1",
        (s = [1, 2, 3, 4, 5], s.substring = String.prototype.substring, s.substring(true, false)));

    array[item++] = Assert.expectEq(
        "var s = new Array(1,2,3,4,5); s.substring = String.prototype.substring; s.substring('4', '5')",
        "3",
        (s = [1, 2, 3, 4, 5], s.substring = String.prototype.substring, s.substring('4', '5')));
    ...
    array[item++] = Assert.expectEq(
        ...
        "[object ",
        (obj = {}, obj.substring = String.prototype.substring, obj.substring(8, 0)));

    array[item++] = Assert.expectEq(
        "var obj = new Object(); obj.substring = String.prototype.substring; obj.substring(8,obj.toString().length)",
        "Object]",
        (obj = {}, obj.substring = String.prototype.substring, obj.substring(8, obj.toString().length)));
    ...
    array[item++] = Assert.expectEq(
        ...
        " Function() {}",
        (obj = function () {
        }, obj.substring = String.prototype.substring, obj.substring(8, Infinity)));
