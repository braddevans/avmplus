...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        "[object ",
        (obj = {}, obj.toString = Object.prototype.toString, obj.slice = String.prototype.slice, obj.slice(0, 8)));

    array[item++] = Assert.expectEq(
        "var obj = new Object(); obj.slice = String.prototype.slice; obj.slice(8,obj.toString().length)",
        "Object]",
        (obj = {}, obj.slice = String.prototype.slice, obj.slice(8, obj.toString().length)));
    ...
    array[item++] = Assert.expectEq(
        ...
        " Function() {}",
        (obj = function () {
        }, obj.slice = String.prototype.slice, obj.slice(8, Infinity) + ""));
