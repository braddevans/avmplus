...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        true,
        (TESTSTRING = String(), TESTSTRING.valueOf() == TESTSTRING.toString()));
    array[item++] = Assert.expectEq(
        "TESTSTRING = new String(true),TESTSTRING.valueOf() == TESTSTRING.toString()",
        true,
        (TESTSTRING = String(true), TESTSTRING.valueOf() == TESTSTRING.toString()));
    array[item++] = Assert.expectEq(
        "TESTSTRING = new String(false),TESTSTRING.valueOf() == TESTSTRING.toString()",
        true,
        (TESTSTRING = String(false), TESTSTRING.valueOf() == TESTSTRING.toString()));
    array[item++] = Assert.expectEq(
        "TESTSTRING = new String(Math.PI),TESTSTRING.valueOf() == TESTSTRING.toString()",
        true,
        (TESTSTRING = String(Math.PI), TESTSTRING.valueOf() == TESTSTRING.toString()));
    array[item++] = Assert.expectEq(
        "TESTSTRING = new String(),TESTSTRING.valueOf() == TESTSTRING.toString()",
        true,
        (TESTSTRING = String(), TESTSTRING.valueOf() == TESTSTRING.toString()));
