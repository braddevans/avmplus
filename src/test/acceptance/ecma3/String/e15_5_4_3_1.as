...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("(new String(\"\")).valueOf()", "", (String("")).valueOf());
    array[item++] = Assert.expectEq("(new String( String() )).valueOf()", "", (String(String())).valueOf());
    array[item++] = Assert.expectEq("(new String( \"h e l l o\" )).valueOf()", "h e l l o", (String("h e l l o")).valueOf());
    array[item++] = Assert.expectEq("(new String( 0 )).valueOf()", "0", (String(0)).valueOf());
    return (array);
}
