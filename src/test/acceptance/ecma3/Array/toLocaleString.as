...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("(new Array()).toLocaleString()", "", ([]).toLocaleString());
    array[item++] = Assert.expectEq("(new Array(2)).toLocaleString()", ",", (new Array(2)).toLocaleString());
    array[item++] = Assert.expectEq("(new Array(0,1)).toLocaleString()", "0,1", ([0, 1]).toLocaleString());
    array[item++] = Assert.expectEq("(new Array( Number.NaN, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY)).toLocaleString()", "NaN,Infinity,-Infinity", ([Number.NaN, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY]).toLocaleString());
    array[item++] = Assert.expectEq("(new Array(Boolean(1), Boolean(0))).toLocaleString()", "[object Boolean],[object Boolean]", ([Boolean(1), Boolean(0)]).toLocaleString());
    array[item++] = Assert.expectEq("(new Array(void 0,null)).toLocaleString()", ",", ([void 0, null]).toLocaleString());
