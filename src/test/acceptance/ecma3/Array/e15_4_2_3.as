...
function getTestCases() {
    ...
    var item = 0;
    var arr;
    array[item++] = Assert.expectEq("new   Array() +''", "", ([]) + "");
    array[item++] = Assert.expectEq("typeof new Array()", "object", (typeof []));
    array[item++] = Assert.expectEq(
        "var arr = new Array(); arr.getClass = Object.prototype.toString; arr.getClass()",
        "[object Array]",
        (arr = [], arr.getClass = Object.prototype.toString, arr.getClass()));

    array[item++] = Assert.expectEq("(new Array()).length", 0, ([]).length);
    array[item++] = Assert.expectEq("(new Array()).toString == Array.prototype.toString", true, ([]).toString == Array.prototype.toString);
