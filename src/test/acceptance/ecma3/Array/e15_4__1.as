...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        "hi",
        (myarr = [], myarr[Math.pow(2, 31)] = 'hi', myarr[Math.pow(2, 31)])
    );
    array[item++] = Assert.expectEq(
        "var myarr = new Array(); myarr[Math.pow(2,31)]='hi'; myarr.length",
        (Math.pow(2, 31) + 1),
        (myarr = [], myarr[Math.pow(2, 31)] = 'hi', myarr.length)
    );

    array[item++] = Assert.expectEq(
        "var myarr = new Array(); myarr[Math.pow(2,30)-2]='hi'; myarr[Math.pow(2,30)-2]",
        "hi",
        (myarr = [], myarr[Math.pow(2, 30) - 2] = 'hi', myarr[Math.pow(2, 30) - 2])
    );
    array[item++] = Assert.expectEq(
        "var myarr = new Array(); myarr[Math.pow(2,30)-2]='hi'; myarr.length",
        (Math.pow(2, 30) - 1),
        (myarr = [], myarr[Math.pow(2, 30) - 2] = 'hi', myarr.length)
    );
    return (array);
}
