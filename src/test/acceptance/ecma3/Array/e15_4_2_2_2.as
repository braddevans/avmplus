...
function getTestCases() {
    ...
    */
    array[item++] = Assert.expectEq("(new Array(new Number(1073741823))).length", 1073741823, (new Array(Number(1073741823))).length);
    array[item++] = Assert.expectEq("(new Array(new Number(0))).length", 0, (new Array(Number(0))).length);
    array[item++] = Assert.expectEq("(new Array(new Number(1000))).length", 1000, (new Array(Number(1000))).length);
    ...
    array[item++] = Assert.expectEq("(new Array(new Boolean(true)).length", 1, (new Array(Boolean(true))).length);
    array[item++] = Assert.expectEq("(new Array(new Boolean(false)).length", 1, (new Array(Boolean(false))).length);
    return (array);
}
