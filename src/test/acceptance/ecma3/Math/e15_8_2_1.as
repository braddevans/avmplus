...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("Math.abs( string object )", Number.NaN, Math.abs(String('a String object')));
    ...
    array[item++] = Assert.expectEq("Math.abs( new Number( -1 ) )", 1, Math.abs(Number(-1)));
    array[item++] = Assert.expectEq("Math.abs( 1 )", 1, Math.abs(1));
