...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("escape( new Boolean(true) )", "true", escape(Boolean(true)));
    array[item++] = Assert.expectEq("escape( new Boolean(false) )", "false", escape(Boolean(false)));
