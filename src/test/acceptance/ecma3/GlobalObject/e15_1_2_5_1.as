...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("unescape( new Boolean(true) )", "true", unescape(Boolean(true)));
    array[item++] = Assert.expectEq("unescape( new Boolean(false) )", "false", unescape(Boolean(false)));
