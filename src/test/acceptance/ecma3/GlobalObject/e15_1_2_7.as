...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("isFinite( new Boolean(true) )", true, isFinite(Boolean(true)));
    array[item++] = Assert.expectEq("isFinite( new Boolean(false) )", true, isFinite(Boolean(false)));
    ...
    array[item++] = Assert.expectEq("isFinite( new String('Infinity') )", false, isFinite(String("Infinity")));
    array[item++] = Assert.expectEq("isFinite( new String('-Infinity') )", false, isFinite(String("-Infinity")));
