...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("parseFloat.length", 1, parseFloat.length);
    ...
    try {
        ...
        array[item++] = Assert.expectEq("parseFloat.length = null", "ReferenceError: Error #1074", Utils.referenceError(thisError));
    }

    array[item++] = Assert.expectEq("delete parseFloat.length", false, delete parseFloat.length);

    //array[item++] = Assert.expectEq(  "delete parseFloat.length; parseFloat.length",   1,      eval("delete parseFloat.length; parseFloat.length") );

    delete parseFloat.length;
    array[item++] = Assert.expectEq("delete parseFloat.length; parseFloat.length", 1, parseFloat.length);
    ...
    array[item++] = Assert.expectEq("var MYPROPS='', for ( var p in parseFloat ) { MYPROPS += p }, MYPROPS", "", MYPROPS);

    array[item++] = Assert.expectEq("parseFloat()", Number.NaN, parseFloat());
    array[item++] = Assert.expectEq("parseFloat('')", Number.NaN, parseFloat(''));
    ...
    array[item++] = Assert.expectEq("parseFloat('  Infinity')", Infinity, parseFloat("Infinity"));
    array[item++] = Assert.expectEq("parseFloat('  Infinity  ')", Infinity, parseFloat('  Infinity  '));
    array[item++] = Assert.expectEq("parseFloat('  Infinity  ')", Infinity, parseFloat(" Infinity "));
    array[item++] = Assert.expectEq("parseFloat('Infinity')", Infinity, parseFloat("Infinity"));
    array[item++] = Assert.expectEq("parseFloat(Infinity)", Infinity, parseFloat(Infinity));
    ...
    /*    array[item++] = Assert.expectEq(   "parseFloat(0x0)",        0,          parseFloat(0x0));
        array[item++] = Assert.expectEq(   "parseFloat(0x1)",        1,          parseFloat(0x1));
        array[item++] = Assert.expectEq(   "parseFloat(0x2)",        2,          parseFloat(0x2));
        array[item++] = Assert.expectEq(   "parseFloat(0x3)",        3,          parseFloat(0x3));
        array[item++] = Assert.expectEq(   "parseFloat(0x4)",        4,          parseFloat(0x4));
        array[item++] = Assert.expectEq(   "parseFloat(0x5)",        5,          parseFloat(0x5));
        array[item++] = Assert.expectEq(   "parseFloat(0x6)",        6,          parseFloat(0x6));
        array[item++] = Assert.expectEq(   "parseFloat(0x7)",        7,          parseFloat(0x7));
        array[item++] = Assert.expectEq(   "parseFloat(0x8)",        8,          parseFloat(0x8));
        array[item++] = Assert.expectEq(   "parseFloat(0x9)",        9,          parseFloat(0x9));
        array[item++] = Assert.expectEq(   "parseFloat(0xa)",        10,         parseFloat(0xa));
        array[item++] = Assert.expectEq(   "parseFloat(0xb)",        11,         parseFloat(0xb));
        array[item++] = Assert.expectEq(   "parseFloat(0xc)",        12,         parseFloat(0xc));
        array[item++] = Assert.expectEq(   "parseFloat(0xd)",        13,         parseFloat(0xd));
        array[item++] = Assert.expectEq(   "parseFloat(0xe)",        14,         parseFloat(0xe));
        array[item++] = Assert.expectEq(   "parseFloat(0xf)",        15,         parseFloat(0xf));
        array[item++] = Assert.expectEq(   "parseFloat(0xA)",        10,         parseFloat(0xA));
        array[item++] = Assert.expectEq(   "parseFloat(0xB)",        11,         parseFloat(0xB));
        array[item++] = Assert.expectEq(   "parseFloat(0xC)",        12,         parseFloat(0xC));
        array[item++] = Assert.expectEq(   "parseFloat(0xD)",        13,         parseFloat(0xD));
        ...
        array[item++] = Assert.expectEq(   "parseFloat(06)",        6,         parseFloat(06));
        array[item++] = Assert.expectEq(   "parseFloat(07)",        7,         parseFloat(07));
        array[item++] = Assert.expectEq(   "parseFloat(010)",       8,        parseFloat(010));
        array[item++] = Assert.expectEq(   "parseFloat(011)",       9,        parseFloat(011));
