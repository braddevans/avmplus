...
function getTestCases() {
    ...
    // Dates around 2000
    array[item++] = Assert.expectEq("Date(1999,11,15,59,59)", true, compareDate((new Date()).toString(), Date(1999, 11, 15, 59, 59)));
    array[item++] = Assert.expectEq("Date(1999,11,16,0,0,0)", true, compareDate((new Date()).toString(), Date(1999, 11, 16, 0, 0, 0)));
    array[item++] = Assert.expectEq("Date(1999,11,31,23,59,59)", true, compareDate((new Date()).toString(), Date(1999, 11, 31, 23, 59, 59)));
    array[item++] = Assert.expectEq("Date(2000,0,1,0,0,0)", true, compareDate((new Date()).toString(), Date(2000, 0, 0, 0, 0, 0)));
    array[item++] = Assert.expectEq("Date(2000,0,1,0,0,1)", true, compareDate((new Date()).toString(), Date(2000, 0, 0, 0, 0, 1)));

    // Dates around 1900

    array[item++] = Assert.expectEq("Date(1899,11,31,23,59,59)", true, compareDate((new Date()).toString(), Date(1899, 11, 31, 23, 59, 59)));
    array[item++] = Assert.expectEq("Date(1900,0,1,0,0,0)", true, compareDate((new Date()).toString(), Date(1900, 0, 1, 0, 0, 0)));
    array[item++] = Assert.expectEq("Date(1900,0,1,0,0,1)", true, compareDate((new Date()).toString(), Date(1900, 0, 1, 0, 0, 1)));
    array[item++] = Assert.expectEq("Date(1899,11,31,16,0,0,0)", true, compareDate((new Date()).toString(), Date(1899, 11, 31, 16, 0, 0, 0)));

    // Dates around feb 29, 2000

    array[item++] = Assert.expectEq("Date( 2000,1,29,0,0,0)", true, compareDate((new Date()).toString(), Date(2000, 1, 29, 0, 0, 0)));
    array[item++] = Assert.expectEq("Date( 2000,1,28,23,59,59)", true, compareDate((new Date()).toString(), Date(2000, 1, 28, 23, 59, 59)));
    array[item++] = Assert.expectEq("Date( 2000,1,27,16,0,0)", true, compareDate((new Date()).toString(), Date(2000, 1, 27, 16, 0, 0)));

    // Dates around jan 1, 2005
    array[item++] = Assert.expectEq("Date(2004,11,31,23,59,59)", true, compareDate((new Date()).toString(), Date(2004, 11, 31, 23, 59, 59)));
    array[item++] = Assert.expectEq("Date(2005,0,1,0,0,0)", true, compareDate((new Date()).toString(), Date(2005, 0, 1, 0, 0, 0)));
    array[item++] = Assert.expectEq("Date(2005,0,1,0,0,1)", true, compareDate((new Date()).toString(), Date(2005, 0, 1, 0, 0, 1)));
    array[item++] = Assert.expectEq("Date(2004,11,31,16,0,0,0)", true, compareDate((new Date()).toString(), Date(2004, 11, 31, 16, 0, 0, 0)));

    // Dates around jan 1, 2032
    array[item++] = Assert.expectEq("Date(2031,11,31,23,59,59)", true, compareDate((new Date()).toString(), Date(2031, 11, 31, 23, 59, 59)));
    array[item++] = Assert.expectEq("Date(2032,0,1,0,0,0)", true, compareDate((new Date()).toString(), Date(2032, 0, 1, 0, 0, 0)));
    array[item++] = Assert.expectEq("Date(2032,0,1,0,0,1)", true, compareDate((new Date()).toString(), Date(2032, 0, 1, 0, 0, 1)));
    array[item++] = Assert.expectEq("Date(2031,11,31,16,0,0,0)", true, compareDate((new Date()).toString(), Date(2031, 11, 31, 16, 0, 0, 0)));
    return (array);
}
