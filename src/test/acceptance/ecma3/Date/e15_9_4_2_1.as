...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("new Date('1/1/1999 12:30 AM').toString()",
        new Date(1999, 0, 1, 0, 30).toString(),
        new Date('1/1/1999 12:30 AM').toString());

    array[item++] = Assert.expectEq("new Date('1/1/1999 12:30 PM').toString()",
        new Date(1999, 0, 1, 12, 30).toString(),
        new Date('1/1/1999 12:30 PM').toString());

    array[item++] = Assert.expectEq("new Date('1/1/1999 13:30 AM')",
        "Invalid Date",
        new Date('1/1/1999 13:30 AM').toString());


    array[item++] = Assert.expectEq("new Date('1/1/1999 13:30 PM')",
        "Invalid Date",
