...
function getTestCases() {
    ...
    function addNewTestCase(DateCase, DateString, ExpectDate) {
        ...
        array[item++] = Assert.expectEq(DateString, ExpectDate.value, DateCase);
        array[item++] = Assert.expectEq(DateString, ExpectDate.value, DateCase);
        /*

            array[item++] = Assert.expectEq(  DateString+".getUTCFullYear()",        ExpectDate.year,   DateCase.getUTCFullYear() );
            array[item++] = Assert.expectEq(  DateString+".getUTCMonth()",         ExpectDate.month,  DateCase.getUTCMonth() );
            array[item++] = Assert.expectEq(  DateString+".getUTCDate()",          ExpectDate.date,   DateCase.getUTCDate() );
            array[item++] = Assert.expectEq(  DateString+".getUTCDay()",           ExpectDate.day,    DateCase.getUTCDay() );
            array[item++] = Assert.expectEq(  DateString+".getUTCHours()",         ExpectDate.hours,  DateCase.getUTCHours() );
            array[item++] = Assert.expectEq(  DateString+".getUTCMinutes()",       ExpectDate.minutes,DateCase.getUTCMinutes() );
            array[item++] = Assert.expectEq(  DateString+".getUTCSeconds()",       ExpectDate.seconds,DateCase.getUTCSeconds() );
            array[item++] = Assert.expectEq(  DateString+".getUTCMilliseconds()",  ExpectDate.ms,     DateCase.getUTCMilliseconds() );

            array[item++] = Assert.expectEq(  DateString+".getFullYear()",             ExpectDate.year,            DateCase.getFullYear() );
            array[item++] = Assert.expectEq(  DateString+".getMonth()",            ExpectDate.month,      DateCase.getMonth() );
            array[item++] = Assert.expectEq(  DateString+".getDate()",             ExpectDate.date,       DateCase.getDate() );
        //    array[item++] = Assert.expectEq(  DateString+".getDay()",              ExpectDate.day,        DateCase.getDay() );
            array[item++] = Assert.expectEq(  DateString+".getHours()",            ExpectDate.hours,      DateCase.getHours() );
            array[item++] = Assert.expectEq(  DateString+".getMinutes()",          ExpectDate.minutes,    DateCase.getMinutes() );
            array[item++] = Assert.expectEq(  DateString+".getSeconds()",          ExpectDate.seconds,    DateCase.getSeconds() );
            array[item++] = Assert.expectEq(  DateString+".getMilliseconds()",     ExpectDate.ms,         DateCase.getMilliseconds() );
        */
    }
