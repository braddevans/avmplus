...
function getTestCases() {
    ...
    function addNewTestCase(DateString, UTCDate, LocalDate) {
        ...
        array[item++] = Assert.expectEq("Date.getTime()", UTCDate.value, DateCase.getTime());
        array[item++] = Assert.expectEq("Date.valueOf()", UTCDate.value, DateCase.valueOf());

        array[item++] = Assert.expectEq("Date.getUTCFullYear()", UTCDate.year, DateCase.getUTCFullYear());
        array[item++] = Assert.expectEq("Date.getUTCMonth()", UTCDate.month, DateCase.getUTCMonth());
        array[item++] = Assert.expectEq("Date.getUTCDate()", UTCDate.date, DateCase.getUTCDate());
        array[item++] = Assert.expectEq("Date.getUTCDay()", UTCDate.day, DateCase.getUTCDay());
        array[item++] = Assert.expectEq("Date.getUTCHours()", UTCDate.hours, DateCase.getUTCHours());
        array[item++] = Assert.expectEq("Date.getUTCMinutes()", UTCDate.minutes, DateCase.getUTCMinutes());
        array[item++] = Assert.expectEq("Date.getUTCSeconds()", UTCDate.seconds, DateCase.getUTCSeconds());
        array[item++] = Assert.expectEq("Date.getUTCMilliseconds()", UTCDate.ms, DateCase.getUTCMilliseconds());

        array[item++] = Assert.expectEq("Date.getFullYear()", LocalDate.year, DateCase.getFullYear());
        array[item++] = Assert.expectEq("Date.getMonth()", LocalDate.month, DateCase.getMonth());
        array[item++] = Assert.expectEq("Date.getDate()", LocalDate.date, DateCase.getDate());
        array[item++] = Assert.expectEq("Date.getDay()", LocalDate.day, DateCase.getDay());
        array[item++] = Assert.expectEq("Date.getHours()", LocalDate.hours, DateCase.getHours());
        array[item++] = Assert.expectEq("Date.getMinutes()", LocalDate.minutes, DateCase.getMinutes());
        array[item++] = Assert.expectEq("Date.getSeconds()", LocalDate.seconds, DateCase.getSeconds());
        array[item++] = Assert.expectEq("Date.getMilliseconds()", LocalDate.ms, DateCase.getMilliseconds());
