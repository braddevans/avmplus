...
//    addNewTestCase( "TDATE = new Date(0);(TDATE).setUTCMonth(3,4);TDATE",
    ...
    function addNewTestCase(DateString, UTCDate, LocalDate) {
        ...
        array[item++] = Assert.expectEq(DateString + ".getDate()", LocalDate.date, date);

        var day = DateCase.getDay();
        if (LocalDate.day == (day + 1)) day++;
        array[item++] = Assert.expectEq(DateString + ".getDay()", LocalDate.day, day);
        ...
        array[item++] = Assert.expectEq(DateString + ".getHours()", LocalDate.hours, hours);
