...
function getTestCases() {
    ...
    for (M_SECS = 0, CURRENT_YEAR = 1970;
        ...
        array[item++] = Assert.expectEq("new Date(" + M_SECS + ")", CURRENT_YEAR, (new Date(M_SECS)).getUTCFullYear());
    }

    array[item++] = Assert.expectEq("new Date(Number.NaN)", NaN, (new Date(Number.NaN)).getUTCFullYear());
