...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("x = new Boolean(true); y = x; z = x; z == y", true, (x = Boolean(true), y = x, z = x, z == y));
    array[item++] = Assert.expectEq("x = new Boolean(false); y = x; z = x; z == y", true, (x = Boolean(false), y = x, z = x, z == y));
