...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("new Boolean(true) < new Boolean(false)", false, Boolean(true) < Boolean(false));
    array[item++] = Assert.expectEq("new Boolean(false) < new Boolean(true)", true, Boolean(false) < Boolean(true));
