...
function getTestCases() {
    ...
    function Gen3(value) {
        ...
        this.toString = function () {
            return "Gen" + this.generation + " instance"
        };
    }

    Gen3.name = 3;
    var origPrototypeToString = Gen3.constructor.prototype.toString;
    Gen3.constructor.prototype.toString = function () {
    ...
    function GenA(value) {
        ...
        this.generation = "A";
        this.toString = function () {
            return "instance of Gen" + this.generation
        };
    ...
    InstanceOf(Boolean(false), Boolean, true, array, item++);
