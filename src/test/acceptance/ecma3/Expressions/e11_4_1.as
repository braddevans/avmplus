...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("delete(new String( 'string object' ) )", true, delete (String("string object")));
    array[item++] = Assert.expectEq("delete(new Number(12345))", true, delete (Number(12345)));
