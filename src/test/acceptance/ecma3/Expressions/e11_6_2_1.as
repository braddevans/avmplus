...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq(
        ...
        NaN,
        EXP_1 - EXP_2);
    var EXP_1 = new MyValuelessObject(Boolean(true));
    var EXP_2 = new MyValuelessObject(Boolean(false));
    array[item++] = Assert.expectEq(
    ...
    array[item++] = Assert.expectEq(
        ...
        99,
        EXP_1 - EXP_2);
    var EXP_1 = new Object(Number(100));
    var EXP_2 = new Object(Number(1));
    array[item++] = Assert.expectEq(
        "var EXP_1 = new Object(new Number(100)); var EXP_2 = new Object(new Number(1)); EXP_1 - EXP_2",
        99,
        EXP_1 - EXP_2);
    var EXP_1 = new MyObject(100);
    var EXP_2 = new MyObject(1);
    array[item++] = Assert.expectEq(
        "var EXP_1 = new MyObject(100); var EXP_2 = new MyObject(1); EXP_1 - EXP_2",
        99,
        EXP_1 - EXP_2);
    var EXP_1 = new MyObject(Number(100));
    var EXP_2 = new MyObject(Number(1));
    array[item++] = Assert.expectEq(
        "var EXP_1 = new MyObject(new Number(100)); var EXP_2 = new MyObject(new Number(1)); EXP_1 - EXP_2",
        99,
        EXP_1 - EXP_2);
    var EXP_1 = new MyOtherObject(Number(100));
    var EXP_2 = new MyOtherObject(Number(1));
    array[item++] = Assert.expectEq(
    ...
    var EXP_1 = new MyOtherObject(String('0xff'));
    var EXP_2 = new MyOtherObject(String('1'));
    array[item++] = Assert.expectEq(
