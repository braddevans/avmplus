...
function getTestCases() {
    ...
    PROPERTY[p++] = new Property(String("hi"), "hi", "hi", NaN);
    PROPERTY[p++] = new Property(Number(NaN), NaN, "NaN", NaN);
    PROPERTY[p++] = new Property(Number(3), 3, "3", 3);
    PROPERTY[p++] = new Property(Boolean(true), true, "true", 1);
    PROPERTY[p++] = new Property(Boolean(false), false, "false", 0);
