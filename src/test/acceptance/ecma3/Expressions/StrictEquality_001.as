...
function getTestCases() {
    ...
    StrictEquality(true, Boolean(true), true, array, item++);
    StrictEquality(Boolean(), false, true, array, item++);
    StrictEquality("", String(), true, array, item++);
    StrictEquality(String("hi"), "hi", true, array, item++);
