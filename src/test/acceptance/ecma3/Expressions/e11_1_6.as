...
function getTestCases() {
    ...
    array[item++] = Assert.expectEq("typeof(new Object())", "object", typeof ({}));
    ...
    array[item++] = Assert.expectEq("delete(new String('hi'));", true, delete (String('hi')));

    array[item++] = Assert.expectEq("delete(new Date(0));", true, delete (new Date(0)));

    array[item++] = Assert.expectEq("delete(new Number(10));", true, delete (Number(10)));

    array[item++] = Assert.expectEq("delete(new Object());", true, delete ({}));
