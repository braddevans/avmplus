...
var DESC = "Read object of type C from Vector<C> with int index, store in local with type C.";
include "driver.as"
...
function mingle(c1: C, c2: C, c3: C, c4: C, c5: C): C {
    return c3
}

function vector_read_obj(iter: int, a: Vector.<C>): C {
