...
var DESC = "Multiple literal regexes in a loop, do not fit in regex cache";
include "driver.as"
...
function matchloop(): Array {
    ...
    for (var i: int = 0; i < 1000; i++) {
        ...
        var re5: RegExp = /gall?i/;    /* not "g", we want searching to start at the beginning */
        x = re2.exec(s);
        x = re3.exec(s);
        x = re4.exec(s);
        x = re5.exec(s);
