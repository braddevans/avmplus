...
var DESC = "Read int from Vector<int> with int index, store in local with type Number.";
include "driver.as"

function vector_read_int(iter: int, a: Vector.<int>): Number {
