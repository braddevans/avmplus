...
var DESC = "Check index prop present in array via operator 'in', compare to operator[]";
...
TEST(do_lookup_both, "lookup-array-in-1");
// TEST(do_lookup_dense,  "lookup-array-in-1:dense");
// TEST(do_lookup_sparse, "lookup-array-in-1:sparse");
