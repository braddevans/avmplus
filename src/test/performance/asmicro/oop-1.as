    ...
    makePrototype(Object.prototype,
        {
            ...
            move: function (xrel, yrel, zrel) {
                this._x += xrel;
                this._y += yrel;
                this._z += zrel
            },
            volume: function () {
                throw new Error("Obj.volume is abstract")
            },
            toString: function () {
                return "(OBJ " + this.x() + " " + this.y() + " " + this.z() + ")"
            }
        });
    ...
    makePrototype(Obj.prototype,
        {
            ...
            toString: function () {
                return "(SPHERE " + this.x() + " " + this.y() + " " + this.z() + " " + this.r() + ")"
            }
        });
    ...
    makePrototype(Obj.prototype,
        {
            ...
            toString: function () {
                return "(BOX " + this.x() + " " + this.y() + " " + this.z() + " " + this.l() + ")"
            }
        });
...
Composite.prototype =
    makePrototype(Obj.prototype,
        {
            volume: function () {
                return this.o1().volume() + this.o2().volume()
            },
            move: function (x, y, z) {
                this.o1().move(x, y, z);
                this.o2().move(x, y, z)
            ...
            toString: function () {
                return "(COMPOSITE " + this.o1() + " " + this.o2() + ")"
            }
        });
