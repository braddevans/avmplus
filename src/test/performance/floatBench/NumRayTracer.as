...
public final class vector3 {
    ...
    public function vector3(a_X: Number, a_Y: Number, a_Z: Number) {
        x = a_X;
        y = a_Y;
        z = a_Z;
    }

    public function scalarMultiply(val: Number): vector3 {
        x *= val;
        y *= val;
        z *= val;
        return this;
    ...
    public function Set(a_X: Number, a_Y: Number, a_Z: Number): void {
        x = a_X;
        y = a_Y;
        z = a_Z;
    }
...
public function sqrtf(v: Number): Number {
    return Number(Math.sqrt(v));
}

public function DOT(A: vector3, B: vector3): Number {
...
public function ADD_SCALED(A: vector3, B: vector3, s: Number): vector3 {
    return new vector3(A.x + s * B.x, A.y + s * B.y, A.z + s * B.z);
}

public function SCALAR_MULTIPLY(s: Number, A: vector3): vector3 {
...
public final class plane {
    ...
    public function plane(a_Normal: vector3, a_D: Number) {
        N = a_Normal;
        D = a_D;
    }
}
...
public final class Material {
    public function Material() {
        m_Color = new vector3(0.2, 0.2, 0.2);
        m_Refl = 0;
        m_Diff = 0.2;
    }
    ...
    public final function SetDiffuse(a_Diff: Number): void {
        m_Diff = a_Diff;
    }

    public final function SetReflection(a_Refl: Number): void {
        m_Refl = a_Refl;
    }

    public final function GetSpecular(): Number {
        return 1.0 - m_Diff;
    }

    public final function GetDiffuse(): Number {
        return m_Diff;
    }

    public final function GetReflection(): Number {
        return m_Refl;
    }
...
public class Primitive {
    ...
    public virtual function Intersect(a_Ray: Ray, a_Dist: NumberRef): int {
        throw Error("abstract method");
        return 0;
    }
...
public final class Sphere extends Primitive {
    ...
    public final function GetSqRadius(): Number {
        return m_SqRadius;
    }
...
public final class PlanePrim extends Primitive {
    ...
    public function PlanePrim(a_Normal: vector3, a_D: Number) {
...
public final class Engine {
    ...
    // renderer data
    private var m_WX1: Number, m_WY1: Number, m_WX2: Number, m_WY2: Number, m_DX: Number, m_DY: Number, m_SX: Number,
        m_SY: Number;
