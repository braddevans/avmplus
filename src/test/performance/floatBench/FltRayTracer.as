...
public final class vector3 {
    ...
    public function vector3(a_X: float, a_Y: float, a_Z: float) {
        x = a_X;
        y = a_Y;
        z = a_Z;
    }

    public function scalarMultiply(val: float): vector3 {
        x *= val;
        y *= val;
        z *= val;
        return this;
    ...
    public function Multiply(val: vector3): vector3 {
        x *= val.x;
        y *= val.y;
        z *= val.z;
        return this;
    ...
    public function Add(val: vector3): vector3 {
        x += val.x;
        y += val.y;
        z += val.z;
        return this;
    ...
    public function Subtract(val: vector3): vector3 {
        x -= val.x;
        y -= val.y;
        z -= val.z;
        return this;
    ...
    public function Set(a_X: float, a_Y: float, a_Z: float): void {
        x = a_X;
        y = a_Y;
        z = a_Z;
    }
...
public function sqrtf(v: float): float {
    return float(Math.sqrt(v));
}

public function DOT(A: vector3, B: vector3): float {
    return (A.x * B.x + A.y * B.y + A.z * B.z);
}

public function NORMALIZE(A: vector3): void {
    var l: float = 1.0
    f / sqrtf(A.x * A.x + A.y * A.y + A.z * A.z);
    A.x *= l;
    A.y *= l;
    A.z *= l;
}

public function SUBTRACT(A: vector3, B: vector3): vector3 {
    return new vector3(A.x - B.x, A.y - B.y, A.z - B.z);
}

public function ADD_SCALED(A: vector3, B: vector3, s: float): vector3 {
    return new vector3(A.x + s * B.x, A.y + s * B.y, A.z + s * B.z);
}

public function SCALAR_MULTIPLY(s: float, A: vector3): vector3 {
...
public final class plane {
    ...
    public function plane(a_Normal: vector3, a_D: float) {
        N = a_Normal;
        D = a_D;
    }
}
...
public final class Surface {
    ...
    public final function GetBuffer(): Vector.<uint> {
        return m_Buffer;
    }
...
public final class Material {
    ...
    public final function SetColor(a_Color: vector3): void {
        m_Color = a_Color;
    }

    public final function GetColor(): vector3 {
        return m_Color;
    }

    public final function SetDiffuse(a_Diff: float): void {
        m_Diff = a_Diff;
    }

    public final function SetReflection(a_Refl: float): void {
        m_Refl = a_Refl;
    }

    public final function GetSpecular(): float {
        return 1.0
        f - m_Diff;
    }

    public final function GetDiffuse(): float {
        return m_Diff;
    }

    public final function GetReflection(): float {
        return m_Refl;
    }
...
public class Primitive {
    ...
    public final function GetMaterial(): Material {
        return m_Material;
    }

    public final function SetMaterial(a_Mat: Material): void {
        m_Material = a_Mat;
    }

    public virtual function GetType(): int {
        throw Error("abstract method");
        return 0;
    }

    public virtual function Intersect(a_Ray: Ray, a_Dist: FloatRef): int {
        throw Error("abstract method");
        return 0;
    }

    public virtual function GetNormal(a_Pos: vector3): vector3 {
        throw Error("abstract method");
        return a_Pos;
    }

    public virtual function GetColor(a_Pos: vector3): vector3 {
        return m_Material.GetColor();
    }

    public virtual function Light(a_Light: Boolean): void {
        m_Light = a_Light;
    }

    public virtual function IsLight(): Boolean {
        return m_Light;
    }
...
public final class Sphere extends Primitive {
    ...
    override public virtual function GetType(): int {
    ...
    public final function GetCentre(): vector3 {
        return m_Centre;
    }

    public final function GetSqRadius(): float {
        return m_SqRadius;
    }
    ...
    override public virtual function GetNormal(a_Pos: vector3): vector3 {
        return SUBTRACT(a_Pos, m_Centre).scalarMultiply(m_RRadius);
    }
...
public final class PlanePrim extends Primitive {
    ...
    public function PlanePrim(a_Normal: vector3, a_D: float) {
        m_Plane = new plane(a_Normal, a_D);
    }
...
public final class Scene {
    ...
    public final function InitScene(): void {
        ...
        // ground plane
        m_Primitive[0] = new PlanePrim(new vector3(0
        f, 1
        f, 0
        f
    ),
...
//		m_Primitive[0]->SetName( "plane" );
        ...
        m_Primitive[0].GetMaterial().SetColor(new vector3(0.4
        f, 0.3
        f, 0.3
        f
    ) )
        ...
        // big sphere
        m_Primitive[1] = new Sphere(new vector3(1
        f, -0.8
        f, 3
        f
    ),
...
//		m_Primitive[1]->SetName( "big sphere" );
        ...
        m_Primitive[1].GetMaterial().SetColor(new vector3(0.7
        f, 0.7
        f, 0.7
        f
    ) )
        ...
        // small sphere
        m_Primitive[2] = new Sphere(new vector3(-5.5
        f, -0.5
        f, 7
        f
    ),
...
//		m_Primitive[2]->SetName( "small sphere" );
        ...
        m_Primitive[2].GetMaterial().SetColor(new vector3(0.7
        f, 0.7
        f, 1.0
        f
    ) )
        ...
        // light source 1
        m_Primitive[3] = new Sphere(new vector3(0
        f, 5
        f, 5
        f
    ),
        ...
        m_Primitive[3].GetMaterial().SetColor(new vector3(0.6
        f, 0.6
        f, 0.6
        f
    ) )
        ...
        // light source 2
        m_Primitive[4] = new Sphere(new vector3(2
        f, 5
        f, 1
        f
    ),
        ...
        m_Primitive[4].GetMaterial().SetColor(new vector3(0.7
        f, 0.7
        f, 0.9
        f
    ) )
    ...
    public function GetNrPrimitives(): int {
        return m_primitiveCount;
    }

    public function GetPrimitive(a_Idx: int): Primitive {
...
public final class Ray {
    public function Ray(a_Origin: vector3, a_Dir: vector3) {
        m_Origin = a_Origin;
        m_Direction = a_Dir;
    }

    public final function SetOrigin(a_Origin: vector3): void {
        m_Origin = a_Origin;
    }

    public final function SetDirection(a_Direction: vector3): void {
        m_Direction = a_Direction;
    }

    public final function GetOrigin(): vector3 {
        return m_Origin;
    }

    public final function GetDirection(): vector3 {
        return m_Direction;
    }
...
public final class Engine {
    ...
    public final function GetScene(): Scene {
        return m_Scene;
    }
    ...
    public final function Render(): uint {
        ...
        for (var y: int = 20; y < (m_Height - 20); y++) {
            ...
            for (var x: int = 0; x < m_Width; x++) {
                ...
                var dist: FloatRef = new FloatRef(0
                f
            )

                var prim: Primitive = Raytrace(r, acc, 1, 1.0
                f, dist
            )
    ...
    // renderer data
    private var m_WX1: float, m_WY1: float, m_WX2: float, m_WY2: float, m_DX: float, m_DY: float, m_SX: float,
        m_SY: float;
