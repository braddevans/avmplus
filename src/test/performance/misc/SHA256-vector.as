...
public class SHA256 {
    ...
    private static var k: Vector.<int> =
        Vector.<int>([0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5,
    ...
    public static function computeDigest(byteArray: ByteArray): String {
        ...
        var messagePadding: Vector.<int> = new Vector.<int>(paddingLength);
        ...
        var w: Vector.<int> = new Vector.<int>(64);    // message schedule, 64 32-bit words
...
var DESC = "SHA256 benchmark using Vector data";
include "driver.as";
...
if (result != "4c97962111c8040e7cab18539cd7f0fa2601dc5d3c625a7b63bfcd10d45fc9bc")
    print("SHA256-vector failed!");
else
    TEST(function () {
        mx.utils.SHA256.computeDigest(testinput)
    }, "SHA256-vector");
}
