...
var DESC = "Check index prop present in object via operator[], compare to operator 'in'";
...
TEST(do_lookup_both, "lookup-object-fetch-1");
// TEST(do_lookup_dense,  "lookup-object-fetch-1:dense");
// TEST(do_lookup_sparse, "lookup-object-fetch-1:sparse");
