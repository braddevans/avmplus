...
const char *const constantNames[] = {
    ...
    "rtqname",    // const int CONSTANT_RTQname      = 0x0F; // ns::name, var
               // qname, const name
    "@rtqname", // const int CONSTANT_RTQnameA        = 0x10; // @ns::name, var
                // qname, const name
    "rtqnamelate", // const int CONSTANT_RTQnameL     = 0x11; // ns::[], var
                   // qname
    "@rtqnamelate", // const int CONSTANT_RTQnameLA   = 0x12; // @ns::[], var
                    // qname
    "", // const int CONSTANT_NameL      = 0x13, // o.[], ns=public implied, rt
        // name
    "", // CONSTANT_NameLA       = 0x14, // o.@[], ns=public implied, rt
        // attr-name
    "namespaceset", // CONSTANT_NamespaceSet = 0x15
    "namespace", // PackageNamespace and Namespace are the same as far as the VM
                 // is concerned
    ...
    "multinamelate",   // const int CONSTANT_MultinameL        = 0x1B, // o.[],
                     // ns, rt name
    "@multinamelate", // CONSTANT_MultinameLA        = 0x1C, // o.@[], ns, rt
                      // attr-name
...
// For stack movement ("stk") only constant movement is accounted for; variable
// movement, as for arguments to CALL, CONSTRUCT, APPLYTYPE, et al, and for
// run-time parts of names, must be handled separately.

#define ABC_OP(operandCount, canThrow, stack, internalOnly, nameToken)         \
  {operandCount, canThrow, stack W(WOP_##nameToken) N(#nameToken)},
#define ABC_UNUSED_OP(operandCount, canThrow, stack, internalOnly, nameToken)  \
  {operandCount, canThrow, stack W(0) N(#nameToken)},
...
// Some static asserts to make sure the opcode enum in ActionBlockConstants.h is
// in good order.
