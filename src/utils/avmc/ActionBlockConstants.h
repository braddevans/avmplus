...
// NOTE.  This file has been copied from ../../core/ActionBlockConstants.h.
// It has been copied for reasons having to do with ActionBlockConstants.cpp.,
...
#define ABC_UNUSED_OP(operandCount, canThrow, stack, internalOnly, nameToken)  \
  ABC_OP(operandCount, canThrow, stack, internalOnly, nameToken)
...
struct AbcOpcodeInfo {
  ...
  int8_t stack; // stack movement not taking into account run-time names or
                // function arguments
