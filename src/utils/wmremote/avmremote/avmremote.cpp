...
STDAPI StartAVMShell(DWORD cbInput, BYTE *pInput, DWORD *pcbOutput,
  ...
  BOOL bResult =
      CreateProcess(wShell, wCmdline, NULL, NULL, FALSE, CREATE_NEW_CONSOLE,
...
STDAPI WaitForAVMShell(DWORD cbInput, BYTE *pInput, DWORD *pcbOutput,
                       BYTE **ppOutput, IRAPIStream *pIRAPIStream) {
...
STDAPI KillAVMShell(DWORD cbInput, BYTE *pInput, DWORD *pcbOutput,
                    BYTE **ppOutput, IRAPIStream *pIRAPIStream) {
...
STDAPI RunMemProfiler(DWORD cbInput, BYTE *pInput, DWORD *pcbOutput,
                      BYTE **ppOutput, IRAPIStream *pIRAPIStream) {
  HANDLE m_queue;
