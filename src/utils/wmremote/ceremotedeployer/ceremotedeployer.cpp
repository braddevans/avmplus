...
int _tmain(int argc, _TCHAR *argv[]) {
  ...
  HANDLE hFile = ::CreateFile(sourceFile, GENERIC_READ, FILE_SHARE_READ, NULL,
  ...
  DWORD dwmblen = ::MultiByteToWideChar(
      CP_ACP, MB_COMPOSITE, (const char *)sourceFile,
      strlen((const char *)sourceFile), ceFilename, MAX_PATH);
  ceFilename[dwmblen] = 0;

  HANDLE ceFile = CeCreateFile(destFile, GENERIC_WRITE, 0, NULL, CREATE_ALWAYS,
