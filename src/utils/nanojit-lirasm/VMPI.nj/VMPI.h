...
extern void VMPI_setPageProtection(void *address, size_t size,
                                   bool executableFlag, bool writeableFlag);

//  Keep this warning-set relatively in sync with
//  platform/win32/win32-platform.h in tamarin.
...
#pragma warning(default : 4263) // member function does not override any base
// class virtual member function
#pragma warning(                                                               \
...
// This part defined in avmshell.h but similarly required for a warning-free
// nanojit experience.
#ifdef _MSC_VER
...
#ifdef _MSC_VER
#pragma warning(                                                               \
    disable : 4291) // presence of a 'new' operator in nanojit/Allocator.h
// without matching 'delete'
#endif
