...
static cl::opt<bool>
    verifyFunctions("verify-functions",
                    cl::desc("Verify bitcode for each function"),
                    cl::init(false));
static cl::opt<string>
    dumpMatching("dump-matching",
                 cl::desc("dump IR for functions matching the given string"));
static cl::opt<bool> debugScopes(
    "debug-scopes", cl::Hidden,
    cl::desc("display information useful for debugging scope issues"));
}; // namespace options
...
#define DEFINE_STUB(name, ios_mangle, win_mangle, argDesc)                     \
  LLVMModule::StubInfo ios_stubinfo_##name = {#name, ios_mangle, argDesc,      \
                                              false, -1};                      \
  LLVMModule::StubInfo win_stubinfo_##name = {#name, win_mangle, argDesc,      \
                                              false, -1};

DEFINE_STUB(mop_rangeCheckFailed,
            "_ZN7avmplus20mop_rangeCheckFailedEPNS_9MethodEnvE",
            "?mop_rangeCheckFailed@avmplus@@YAXPAVMethodEnv@1@@Z",
            "v;*'avmplus::MethodEnv'");

#ifdef AVMPLUS_64BIT
DEFINE_STUB(coerceobj_atom,
            "_ZN7avmplus14coerceobj_atomEPNS_9MethodEnvExPNS_6TraitsE",
            "?coerceobj_atom@avmplus@@YAXPAVMethodEnv@1@HPAVTraits@1@@Z",
            "v;*'avmplus::MethodEnv';a;*'avmplus::Traits'");
DEFINE_STUB(compare, "_ZN7avmplus7AvmCore7compareExx",
            "?compare@AvmCore@avmplus@@SAHHH@Z", "a;a;a");
DEFINE_STUB(atomWriteBarrier,
            "_ZN7avmplus7AvmCore16atomWriteBarrierEPN4MMgc2GCEPKvPxx",
            "?atomWriteBarrier@AvmCore@avmplus@@SAXPAVGC@MMgc@@PBXPAHH@Z",
            "v;*'MMgc::GC';*'avmplus::ScriptObject';*a;a");
DEFINE_STUB(op_add_a_aa, "_ZN7avmplus11op_add_a_aaEPNS_7AvmCoreExx",
            "?op_add_a_aa@avmplus@@YAHPAVAvmCore@1@HH@Z",
            "a;*'avmplus::AvmCore';a;a");
DEFINE_STUB(hasnextproto, "_ZNK7avmplus9MethodEnv12hasnextprotoERxRi",
            "?hasnextproto@MethodEnv@avmplus@@QBAHAAH0@Z",
            "i;*'avmplus::MethodEnv';*a;*i");
#else
DEFINE_STUB(coerceobj_atom,
            "_ZN7avmplus14coerceobj_atomEPNS_9MethodEnvEiPNS_6TraitsE",
            "?coerceobj_atom@avmplus@@YAXPAVMethodEnv@1@HPAVTraits@1@@Z",
            "v;*'avmplus::MethodEnv';a;*'avmplus::Traits'");
DEFINE_STUB(compare, "_ZN7avmplus7AvmCore7compareEii",
            "?compare@AvmCore@avmplus@@SAHHH@Z", "a;a;a");
DEFINE_STUB(atomWriteBarrier,
            "_ZN7avmplus7AvmCore16atomWriteBarrierEPN4MMgc2GCEPKvPii",
            "?atomWriteBarrier@AvmCore@avmplus@@SAXPAVGC@MMgc@@PBXPAHH@Z",
            "v;*'MMgc::GC';*'avmplus::ScriptObject';*a;a");
DEFINE_STUB(op_add_a_aa, "_ZN7avmplus11op_add_a_aaEPNS_7AvmCoreEii",
            "?op_add_a_aa@avmplus@@YAHPAVAvmCore@1@HH@Z",
            "a;*'avmplus::AvmCore';a;a");
DEFINE_STUB(hasnextproto, "_ZNK7avmplus9MethodEnv12hasnextprotoERiS1_",
            "?hasnextproto@MethodEnv@avmplus@@QBAHAAH0@Z",
            "i;*'avmplus::MethodEnv';*a;*i");
#endif

DEFINE_STUB(llCreateRestHelper, "llCreateRestHelper", "llCreateRestHelper",
            "*'avmplus::ScriptObject';*'avmplus::MethodEnv';*a;i");
DEFINE_STUB(llCreateArgumentHelper, "llCreateArgumentHelper",
            "llCreateArgumentHelper",
            "*'avmplus::ScriptObject';*'avmplus::MethodEnv';*a;i");
DEFINE_STUB(doubleToInt32, "llDoubleToInt32", "llDoubleToInt32",
            "i;*'avmplus::AvmCore';d");
DEFINE_STUB(privateWriteBarrierRC,
            "_ZN4MMgc2GC21privateWriteBarrierRCEPKvS2_S2_",
            "?privateWriteBarrierRC@GC@MMgc@@QAAXPBX00@Z",
            "v;*'MMgc::GC';*'avmplus::ScriptObject';*c;*c");
DEFINE_STUB(intToAtom, "_ZN7avmplus7AvmCore9intToAtomEi",
            "?intToAtom@AvmCore@avmplus@@QAAHH@Z", "a;*'avmplus::AvmCore';i");
DEFINE_STUB(uintToAtom, "_ZN7avmplus7AvmCore10uintToAtomEj",
            "?uintToAtom@AvmCore@avmplus@@QAAHI@Z", "a;*'avmplus::AvmCore';i");
DEFINE_STUB(beginTry, "_ZN7avmplus14ExceptionFrame8beginTryEPNS_7AvmCoreE",
            "?beginTry@ExceptionFrame@avmplus@@QAAXPAVAvmCore@2@@Z",
            "v;*'avmplus::ExceptionFrame';*'avmplus::AvmCore'");
DEFINE_STUB(endTry, "_ZN7avmplus14ExceptionFrame6endTryEv",
            "?endTry@ExceptionFrame@avmplus@@QAAXXZ",
            "v;*'avmplus::ExceptionFrame'");
DEFINE_STUB(debugEnter,
            "_ZN7avmplus9MethodEnv10debugEnterEPKhPNS_13CallStackNodeEPNS_"
            "9FramePtr_EPVl",
            "?debugEnter@MethodEnv@avmplus@@QAAXPBEPAVCallStackNode@2@"
            "PAUFramePtr_@2@PCH@Z",
            "v;*'avmplus::MethodEnv';*c;*'avmplus::CallStackNode';*a;*i");
DEFINE_STUB(debugExit, "_ZN7avmplus9MethodEnv9debugExitEPNS_13CallStackNodeE",
            "?debugExit@MethodEnv@avmplus@@QAAXPAVCallStackNode@2@@Z",
            "v;*'avmplus::MethodEnv';*'avmplus::CallStackNode'");

DEFINE_STUB(createInstanceProc, 0, 0, "*'avmplus::ScriptObject';*c");
DEFINE_STUB(resolveInterfaceProc, 0, 0,
            "*'avmplus::MethodEnv';*'avmplus::MethodEnv';*'avmplus::MethodInfo'"
            ";*'avmplus::ScriptObject'");
DEFINE_STUB(doubleToAtom, "llDoubleToAtom", "llDoubleToAtom",
            "a;*'avmplus::AvmCore';d");
DEFINE_STUB(mod, "llMod", "llMod", "d;d;d");
DEFINE_STUB(llBeginCatch, "llBeginCatch", "llBeginCatch",
            "i;*'avmplus::MethodEnv';*'avmplus::ExceptionFrame';i;i;*'"
            "AOTExceptionDesc';**'avmplus::Traits';*a");
DEFINE_STUB(llGetString, "llGetString", "llGetString",
            "*'avmplus::String';*'avmplus::PoolObject';i");
DEFINE_STUB(llGetNamespace, "llGetNamespace", "llGetNamespace",
            "*'avmplus::Namespace';*'avmplus::PoolObject';i");
DEFINE_STUB(llGetMethodInfo, "llGetMethodInfo", "llGetMethodInfo",
            "*'avmplus::MethodInfo';*'avmplus::PoolObject';i");
DEFINE_STUB(llGetClassTraits, "llGetClassTraits", "llGetClassTraits",
            "*'avmplus::Traits';*'avmplus::PoolObject';i");
DEFINE_STUB(llGetScriptTraits, "llGetScriptTraits", "llGetScriptTraits",
            "*'avmplus::Traits';*'avmplus::PoolObject';i");
DEFINE_STUB(llLoadCatchTraits, "llLoadCatchTraits", "llLoadCatchTraits",
            "*'avmplus::Traits';*'avmplus::MethodEnv';*'AOTExceptionDesc'");
DEFINE_STUB(activationTraits, "_ZNK7avmplus10MethodInfo16activationTraitsEv",
            "?activationTraits@MethodInfo@avmplus@@QBEPAVTraits@2@XZ",
            "*'avmplus::Traits';*'avmplus::MethodInfo'");
DEFINE_STUB(llGetInterfaceTraitsFromPool, "llGetInterfaceTraitsFromPool",
            "llGetInterfaceTraitsFromPool",
            "*'avmplus::Traits';*'avmplus::PoolObject';i");
DEFINE_STUB(llNewClass, "llNewClass", "llNewClass",
            "*'avmplus::ScriptObject';*'avmplus::MethodEnv';i;**'avmplus::"
            "Traits';*'avmplus::ScriptObject';i;i;*a");
DEFINE_STUB(llNewFunction, "llNewFunction", "llNewFunction",
            "*'avmplus::ScriptObject';*'avmplus::MethodEnv';i;**'avmplus::"
            "Traits';i;i;*a");
DEFINE_STUB(llNewActivation, "llNewActivation", "llNewActivation",
            "*'avmplus::ScriptObject';*'avmplus::MethodEnv'");
DEFINE_STUB(llNPE, "llNPE", "llNPE", "v;*'avmplus::MethodEnv'");
DEFINE_STUB(llVerifyError, "llVerifyError", "llVerifyError",
            "v;*'avmplus::MethodEnv'");
DEFINE_STUB(llUPE, "llUPE", "llUPE", "v;*'avmplus::MethodEnv';a");

DEFINE_STUB(llGetVectorTraits, "llGetVectorTraits", "llGetVectorTraits",
            "*'avmplus::Traits';*'avmplus::Traits';*'avmplus::Namespace'");
DEFINE_STUB(llCoreTakeSample, "llCoreTakeSample", "llCoreTakeSample",
            "v;*'avmplus::AvmCore'");
DEFINE_STUB(
    finddef_miss,
    "_ZN7avmplus12finddef_missEPPNS_12ScriptObjectEPNS_11MethodFrameE",
    "?finddef_miss@avmplus@@YIPAVScriptObject@1@PAPAV21@PAVMethodFrame@1@@Z",
    "*'avmplus::ScriptObject';**'avmplus::ScriptObject';*'avmplus::"
    "MethodFrame'");
DEFINE_STUB(llGetPoolSameWorker, "llGetPoolSameWorker", "llGetPoolSameWorker",
            "*'avmplus::PoolObject';*'avmplus::PoolObject';*'AOTInfo'");
...
LLVMEmitter::LLVMEmitter(MethodInfo *method, InstrGraph *ir)
    : llvm::IRBuilder<>(method->pool()->poolInfo->modulep->getContext()),
      method(method), pool(method->pool()),
      core(static_cast<CompilerCore *>(pool->core)),
      module(*pool->poolInfo->modulep), signature(method->getMethodSignature()),
      ir(ir), coreAddr(0), gcAddr(0), currentFunction(0), entryBlock(0),
      epilogBlock(0), returnPhi(0), def_ins_(0), idToBlock_(0), env_param(0),
      argc_param(0), ap_param(0), method_frame_(0), params_(0),
      maxAtomParams_(0), maxAvmParamSize_(0), blocks_(0), num_blocks_(0),
      current_block_(0), max_argc_(0), npe_block(0), upe_block(0), upe_phi(0),
      have_catchblocks_(0), safepoint_space_(0), call_stack_node_(0),
      save_eip_(0), saved_eip_(0), exceptionFrame_(0), exceptionAtom_(0),
      catch_block_(0), enable_verbose_(true), isWindowsTriple(false),
      hasnextAtom_(0), hasnextCounter_(0) {
...
llvm::Value *LLVMEmitter::createMemberGEP(llvm::Value *ptr, FieldInfo *member,
                                          const llvm::Twine &name) {
  StructInfo *s = member->structInfo;
  llvm::Type *structPtrTy = s->type->getPointerTo();
  if (ptr->get_type() == module.scriptObjectPtrTy &&
      ptr->get_type() != structPtrTy) {
    // Cast scriptObjects to actual object type
    ptr = CreateBitCast(ptr, structPtrTy);
  }
  AvmAssert(ptr->get_type() == structPtrTy);
  if (s->traits) // Add a dependency on the slot layouts of the referenced
                 // object
    module.poolInfo->addDependency(s->traits);
  return CreateConstGEP2_32(ptr, 0, member->memberIx, name);
}

llvm::LoadInst *LLVMEmitter::loadMember(llvm::Value *ptr, FieldInfo *member,
                                        const llvm::Twine &name) {
  llvm::Value *ep = createMemberGEP(ptr, member);
  return CreateLoad(ep, name.isTriviallyEmpty() ? member->name : name);
}

llvm::Value *LLVMEmitter::storeMember(llvm::Value *val, llvm::Value *ptr,
                                      FieldInfo *member) {
  llvm::Value *ep =
      createMemberGEP(ptr, member, llvm::StringRef(member->name) + "&");
  return CreateStore(canUpcastTo(val->get_type(), member->type)
                         ? upcastTo(val, member->type)
                         : val,
                     ep);
}
...
llvm::CallInst *LLVMEmitter::callIns(const LLVMModule::StubInfo *stubinfo,
                                     uint32_t argc, ...) {
  va_list ap;
  va_start(ap, argc);
...
bool LLVMEmitter::needsMethodFrame(const LLVMModule::StubInfo *stubinfo) {
  ...
  if (stubinfo == STUBINFO(endTry) || stubinfo == STUBINFO(beginTry) ||
      STUBINFO(debugExit) || stubinfo == STUBINFO(llBeginCatch) ||
      stubinfo == STUBINFO(setjmp))
    return false;
...
llvm::CallInst *LLVMEmitter::acallIns(const LLVMModule::StubInfo *stubinfo,
                                      uint32_t argc, llvm::Value **args) {
  ...
  llvm::CallInst *ins =
      CreateCall(func, llvm::ArrayRef<llvm::Value *>(args, argc));
...
bool LLVMEmitter::neverReturns(const LLVMModule::StubInfo *call) {
  return call == STUBINFO(llNPE) || call == STUBINFO(llUPE) ||
...
bool LLVMEmitter::canUpcastTo(llvm::Type *from, llvm::Type *to) {
  ...
  // getGenericPointerTy functions as a void* but we use char* so you can
  // compute byte offsets in it without casting
...
bool LLVMEmitter::permissibleDowncast(llvm::Type *from, llvm::Type *to) {
  if (from == to)
    return true;
  // TODO: Should not allow casting from generic to whatever, but "for now" it
  // will do.
  if (from == module.genericPtrTy && to->isPointerTy())
    return true;
  // If someone tries to cast a ScriptObject to one of its subclasses, assume
  // it's OK.
...
llvm::Value *LLVMEmitter::coerceArg(llvm::Value *val, llvm::Type *to) {
  AvmAssert(canUpcastTo(val->get_type(), to) ||
            permissibleDowncast(val->get_type(), to));
  const char *suffix = "_cast";
  if (val->getName().endswith("_"))
    ++suffix;
  if ((val->get_type() == getInt1Ty() && to->isIntegerTy())
#ifdef AVMPLUS_64BIT
      || (val->get_type() == getInt32Ty() && to == getInt64Ty())
#endif
  )
    ...
    if (otherPool == traits->pool) {
      for (int j = 0, end = (int)otherPool->classCount(); j < end; ++j) {
        if (traits == otherPool->getClassTraits(j)) {
          llvm::Value *res =
              loadClassTraitsFromPool(getPoolLLVMValue(poolInfo), j);
          res->setName(name);
          return res;
        }
      }
...
llvm::Value *LLVMEmitter::generateGetCatchTraitsCall(Traits *traits) {
  ...
  exceptionDesc.init(module.aotExceptionDesc_nameIndex_member,
                     getInt32(name_index));
  llvm::Constant *exceptionDescs = exceptionDesc.create();
  llvm::Value *aotExceptionDescConst = CreateAlloca(
      module.aotExceptionDescTy, getInt32(1), "aotExceptionDescArray");
  llvm::Value *argLoc =
      CreateConstGEP1_32(aotExceptionDescConst, 0, "av" + llvm::Twine(0) + "&");
  CreateStore(exceptionDescs, argLoc);

  llvm::Value *res =
      callIns(STUBINFO(llLoadCatchTraits), 2, env_param, aotExceptionDescConst);
  res->setName(name);
  return res;
}

llvm::Value *LLVMEmitter::loadScriptTraitsFromPool(llvm::Value *pool,
                                                   int index) {
#if 0 // Slow, safe way to get the script traits. If something breaks, try this
      // instead.
    llvm::Value* res = callIns(STUBINFO(llGetScriptTraits), 2, pool, getInt32(index));
#else
  llvm::Value *scripts =
      createMemberGEP(pool, module.poolobject_scripts_member);
  llvm::Value *m_list = loadMember(scripts, module.traitsList_m_list_member);
  llvm::Value *entries =
      createMemberGEP(m_list, module.traitsTracedList_entries_member);
...
llvm::Value *LLVMEmitter::loadClassTraitsFromPool(llvm::Value *pool,
                                                  int index) {
#if 0 // Slow, safe way to get the class traits. If something breaks, try this
      // instead.
    llvm::Value* res = callIns(STUBINFO(llGetClassTraits), 2, pool, getInt32(index));
#else
  llvm::Value *classes =
      createMemberGEP(pool, module.poolobject_classes_member);
...
llvm::Value *LLVMEmitter::GetVectorTraitsValue(Traits *traits) {
  llvm::Value *res = callIns(STUBINFO(llGetVectorTraits), 2,
                             module.getTraitsValue(this, traits->m_paramTraits),
                             getNamespaceConstant(traits->ns()));
  return res;
}

// check valid pointer and unbox it (returns ScriptObject*)
llvm::Value *LLVMEmitter::downcast_obj(llvm::Value *atom, llvm::Value *env,
                                       Traits *t) {
  callIns(STUBINFO(coerceobj_atom), 3, env, atom,
          module.getTraitsValue(this, t));
...
llvm::Value *LLVMEmitter::nativeToAtom(llvm::Value *native, Traits *t) {
  ...
  case BUILTIN_int: {
    if (const llvm::ConstantInt *native_const =
            llvm::dyn_cast<llvm::ConstantInt>(native)) {
  ...
  case BUILTIN_uint: {
    if (llvm::ConstantInt *native_const =
            llvm::dyn_cast<llvm::ConstantInt>(native)) {
...
void LLVMEmitter::allocateTables() {
  ...
  idToBlock_ =
      new (alloc0) llvm::BasicBlock *[ir->size()]; // fixme: too sparse!
  ...
  for (ArrayRange<BlockStartInstr *> b(blocks_, num_blocks_); !b.empty();
    ...
    if (kind(b.front()) == HR_catchblock) {
      ...
      // If it were unreachable, there'd be no catchblock, and we don't want to
...
llvm::Value *LLVMEmitter::set_def_ins(Def *d, llvm::Value *ins) {
  AvmAssert(canUpcastTo(ins->get_type(), module.llvmType(d)));
  ...
  if (!ins->get_type()->isVoidTy() && ins->getName().empty() &&
      !llvm::isa<llvm::PHINode>(ins))
...
inline llvm::BasicBlock *LLVMEmitter::set_block(BlockStartInstr *i,
...
void LLVMEmitter::emitBegin() {
  ...
  currentFunction =
      llvm::Function::Create(methodType, llvm::GlobalValue::ExternalLinkage,
                             module.poolInfo->getFunctionName(method), &module);
  module.incrementFunctionCount();
  // Govind:Commenting this call to enable module spilitting during emit.
  // addMethod stores llvm::Function*
  // with PoolInfo and at the end while creating AOTInfo it is used to create
  // Array of Function pointers. So intead of adding concrete function in array
  // i am now using extern prototype, which resolves at link time.
  // module.poolInfo->addMethod(method, currentFunction);

  entryBlock =
      llvm::BasicBlock::Create(module.getContext(), "entry", currentFunction);
  ...
  // Epilog
  {
    epilogBlock = llvm::BasicBlock::Create(module.getContext(), "epilog",
                                           currentFunction);
  ...
  if (have_catchblocks_ || core->settings.telemetry_sampler ||
      (ir && ir->debugging()))
    getMethodFrame();
}
...
llvm::Value *LLVMEmitter::getMethodFrame() {
  ...
  // IMPORTANT!!!
  //
  // The MethodFrame must be emitted in front of the exception setup if there
  // are catches because the beginTry will cache core->methodFrame to restore it
  // un unwind. Inserting in front of params_ achieves that.
  //
  if (!method_frame_) {
    {
      // Emit the methodframe allocation and push just before the params_ temp
      // Same thing is being done @ void MethodFrame::enter(AvmCore* core,
      // MethodEnv* e)
      // Just need to call core->takeSample(); for telemetry
      PushBuilder push(this, params_);
      method_frame_ =
          CreateAlloca(module.methodFrameTy, getInt32(1), "methodFrame");
      ...
      llvm::Value *core_mf =
          createMemberGEP(coreAddr, module.avmcore_methodframe_member);
    ...
    }
    {
      ...
      llvm::Value *prevFrame =
          loadMember(method_frame_, module.methodframe_next_member);
...
llvm::Value *LLVMEmitter::getAtomConstant(Atom const_atom) {
  ...
  case kIntptrType:
    return getPtrSizeInt(const_atom);
  case kDoubleType: {
    // TODO: using a pooled constant _might_ be slightly better since it avoids
    // repeated allocations, though at the cost of added marking overhead. It
    // depends on how often we need boxed double constants.
...
// Halfmoon has object references that it thinks it can just hand off to the
// JIT, but those addresses are no good in a future instantiation of the
// runtime. So we have to relate the objects we have now to the corresponding
// objects in the subsequent runtime.
//
...
llvm::Value *LLVMEmitter::getStringConstant(String *str) {
  ...
  for (int i = 1, end = (int)pool->constantStringCount; i < end; ++i) {
    if (str->equals(pool->getString(i))) {
      llvm::Value *res =
          callIns(STUBINFO(llGetString), 2, poolAddr, getInt32(i));
  ...
  for (int i = 0; i < core->poolInfos.size(); i++) {
    ...
    for (int j = 1, end = (int)otherPool->constantStringCount; j < end; ++j) {
      if (str->equals(otherPool->getString(j))) {
        llvm::Value *res = callIns(STUBINFO(llGetString), 2,
                                   getPoolLLVMValue(poolInfo), getInt32(j));
        res->setName("str:" + llvm::Twine(strVal.c_str()));
        return res;
      }
    }
...
#if 0 // Slow, safe way to get the namespace. If something breaks, try this
      // instead.
    llvm::Value* res = callIns(STUBINFO(llGetNamespace), 2, poolValue, getInt32(nsIndex));
    res->setName("NS: " + llvm::Twine(nsName.c_str()));
#else
  llvm::Value *namespaces =
      createMemberGEP(poolValue, module.poolobject_namespaces_member);
  llvm::Value *m_list =
      loadMember(namespaces, module.namespaceRCList_m_list_member);
  llvm::Value *entries =
      createMemberGEP(m_list, module.namespaceList_entries_member);
...
static bool MultinameEqual(const Multiname *mn1, const Multiname *mn2) {
  ...
  if (mn1->isAnyNamespace() != mn2->isAnyNamespace())
    return false;
  if (!mn1->isAnyName() && !mn1->isRtname() &&
      !String::equalsWithNullChecks(mn1->getName(), mn2->getName()))
    return false;
  if (mn1->isParameterizedType() != mn2->isParameterizedType())
    return false;
  if (mn1->isParameterizedType() &&
      mn1->getTypeParameter() != mn2->getTypeParameter())
    return false;
...
public:
  MultinameDesc(AvmCore *core, const Multiname *name)
      : StUTF8String(name->isAnyName()
                         ? core->newStringLatin1("<any>")
...
llvm::Value *LLVMEmitter::getMultinameConstant(const Multiname *mn) {
  ...
  for (int i = 1, end = (int)pool->cpool_mn_offsets.length(); i < end; ++i) {
    if (MultinameEqual(mn, pool->precomputedMultiname(i))) {
      llvm::Value *escmn =
          loadMember(poolAddr, module.poolobject_escHeapMultiname_member);
      llvm::Value *elements =
          createMemberGEP(escmn, module.escHeapMultiname_elements_member);
      llvm::Value *res = CreateConstGEP2_32(
          elements, 0, i, "MN: " + llvm::Twine(nameStr.c_str()));
      return res;
    }
  }
...
#if 0 // Slow, safe way to get the methodinfo. If something breaks, try this
      // instead.
...
#else
  llvm::Value *methods =
      createMemberGEP(poolValue, module.poolobject_methods_member);
  llvm::Value *m_list =
      loadMember(methods, module.methodInfoGCList_m_list_member);
  llvm::Value *entries =
      createMemberGEP(m_list, module.methodInfoList_entries_member);
  llvm::Value *methodLoc = CreateConstGEP1_32(entries, methodIndex);
  llvm::Value *res =
      CreateLoad(methodLoc, "Method: " + llvm::Twine(methodName.c_str()));
#endif
  return res;
}

llvm::Value *LLVMEmitter::loadInterfaceTraitsFromPool(llvm::Value *pool,
                                                      int index) {
#if 0 // Slow, safe way to get the class traits. If something breaks, try this
      // instead.
...
void LLVMEmitter::emitAtomArgs(const Use *args_in, int argc) {
  ...
  for (int i = 0; i < argc; ++i) {
    llvm::Value *argLoc =
        CreateConstGEP1_32(params_, i, "av" + llvm::Twine(i) + "&");
...
llvm::Value *LLVMEmitter::emitLoadVTable(const Use &object) {
  ...
  if (obj->get_type() == module.arrayObjectPtrTy)
...
llvm::Value *LLVMEmitter::emitCompareLess(llvm::Value *lhs_in,
                                          llvm::Value *rhs_in) {
...
llvm::Value *LLVMEmitter::emitStore(const Use &value, const Type *value_type,
  ...
  // This function is used to store atom sized params. boolean, int32 should be
  // stored in Atom's space
...
llvm::BasicBlock *LLVMEmitter::getBlock(BlockStartInstr *bsi) {
  ...
  if (!bb) {
    ...
    bb = llvm::BasicBlock::Create(module.getContext(), name.c_str(),
                                  currentFunction);
    set_block(bsi, bb);
  }
  return bb;
...
llvm::Instruction *
LLVMEmitter::getNearestInsertionInsertPointForAllUses(llvm::DominatorTree &dt,
                                                      llvm::Value *def) {
  llvm::BasicBlock *nearest = 0;
  for (llvm::Value::use_iterator itUse = def->use_begin();
       itUse != def->use_end(); ++itUse) {
    if (llvm::Instruction *ins =
            llvm::dyn_cast<llvm::Instruction>((*itUse).getUser())) {
  ...
  for (llvm::Value::use_iterator itUse = def->use_begin();
    ...
    if (llvm::Instruction *ins =
      ...
      if (ins->getParent() == nearest) {
        for (llvm::BasicBlock::iterator itIns = nearest->begin(),
                                        end = nearest->end();
             itIns != end; ++itIns) {
          if (std::find(itIns->op_begin(), itIns->op_end(), def) !=
              itIns->op_end()) {
            return itIns;
          }
        }
...
void LLVMEmitter::removeIfNotUsedOtherwiseMoveNearestToFirstUse(
    llvm::DominatorTree &dt, llvm::Instruction *val) {
  llvm::Instruction *nearest =
      getNearestInsertionInsertPointForAllUses(dt, val);
...
void LLVMEmitter::finish() {
  ...
  if (params_) {
    ...
    // If params have been used for something besides atoms, make sure they're
    // aligned for doubles
    if (maxAvmParamSize_ > 0)
      params_->setAlignment(8);
  }

  // Remove pool, methodInfo, core and gc defs if not used, otherwise move them
  // as near as possible to their first uses to reduce the live range of the
  // values. Careful: order matters! Must be in reverse order of how they are
  // loaded.
  ...
  removeIfNotUsedOtherwiseMoveNearestToFirstUse(pass.getDomTree(),
                                                methodInfoAddr);
  ...
  bool matches = options::dumpMatching.length() > 0 &&
                 currentFunction->getName().str().find(options::dumpMatching) !=
                     std::string::npos;
...
void LLVMEmitter::do_if(IfInstr *instr) {
  ...
  if (!cond->get_type()->isIntegerTy(1))
...
void LLVMEmitter::do_switch(SwitchInstr *instr) {
  ...
  llvm::SwitchInst *switch_instr =
      CreateSwitch(selector, default_block, num_cases);
...
void LLVMEmitter::do_stub(Instr *instr, const LLVMModule::StubInfo *call) {
  ...
  uint32_t limit =
      (fixc == -1) ? MAXARGS : fixc + 1; // +1 is for the MethodFrame* arg
  ...
  for (ArrayRange<Use> u = useRange(instr); !u.empty(); s.popFront()) {
    ...
    if (argc < limit) {
      ...
      // It's likely that stubs have homogeneous arguments, so alignment
...
void LLVMEmitter::do_start(StartInstr *start) {
  ...
  if (method->needRestOrArguments() || method->needArgsArrInMethodSig()) {
    ...
    if (method->needRest()) {
      set_def_ins(start->data_param(paramIx++),
                  callIns(STUBINFO(llCreateRestHelper), 3, env_param, ap_param,
                          argc_param));
    } else if (method->needArguments()) {
      set_def_ins(start->data_param(paramIx++),
                  callIns(STUBINFO(llCreateArgumentHelper), 3, env_param,
                          ap_param, argc_param));
    }
    // needArgsArrInMethodSig is propogated to match function signature to avoid
    // MethodEnv* corruption. actually this fuction is not using "arguments" so
    // argc argv should be ignored.
  ...
  // End the entry block so that it's easy to add things to it and before the
  // main body.
  llvm::BasicBlock *startBlock =
      llvm::BasicBlock::Create(module.getContext(), "body", currentFunction);
  CreateBr(startBlock);
...
llvm::CallInst *LLVMEmitter::emitCall(MethodInfo *callee, llvm::Value *func,
                                      llvm::Value *callee_env,
                                      CallStmt2 *call) {
  // make sure we have a MethodFrame if we call anything
  getMethodFrame();
  ...
  for (; i < nParams; ++i) {
    if (i < actual_argc) {
      ...
      if (val->get_type() == module.arrayObjectPtrTy)
      ...
      case SST_scriptobject: {
        AvmAssert(AvmCore::isNull(a) && (atomKind(a) == kObjectType) &&
                  "Only null default values can be handled");
  ...
  if (callee->needRest()) {
    ...
    if (nVarargs < 0) // this can happen if there are missing optional params
                      // AND rest params
      nVarargs = 0;
  ...
  // env->createArguments in llCreateArgumentHelper. 'this' is used to setup
  // callee in arguments
  ...
  AvmAssert(isBottom(type(value_out)) ||
            model(type(value_out)) ==
                defaultModelKind(callee_sig->returnTraits()));
...
void LLVMEmitter::InsertPrintf(const char *s) {
  ...
  llvm::FunctionType *funcTy =
      llvm::FunctionType::get(getInt32Ty(), argTypes, /* isVarArg */ false);
  llvm::Value *func = module.getOrInsertFunction("printf", funcTy);

  // create its arguments
  llvm::Constant *str =
      llvm::ConstantDataArray::getString(module.getContext(), s);
  llvm::GlobalVariable *gStr =
      new llvm::GlobalVariable(module, str->get_type(), /*isConst*/ true,
                               llvm::GlobalValue::InternalLinkage, str, ".str");
...
void LLVMEmitter::do_callmethod(CallStmt2 *call) {
  ...
  llvm::Value *callee_info =
      loadMember(callee_env, module.methodenv_method_member);
  llvm::Value *native_info =
      createMemberGEP(callee_info, module.methodinfo_native_member);
  llvm::Value *func =
      loadMember(native_info, module.methodinfonative_handler_member);
...
void LLVMEmitter::do_callinterface(CallStmt2 *call) {
  //
  // This is a quick-and-dirty (and slow) implementation that boxes the
  // arguments, calls coerceEnter, then unboxes the results.
  //
  // Generating a direct call to method as now do_loadenv_interface always
  // provides a concrete methodInfo rather than ImtThunkEnv
  ...
  return;
    ...
    llvm::Type* argTypes[] = { module.methodEnvPtrTy, getInt32Ty(), module.atomPtrTy, methodInfo->get_type() };
    ...
    for (int i = 0; i < nParams; ++i) {
        ...
        llvm::Type* valType =val->get_type();
        ...
        if(llvm::Type::getDoubleTy(getContext()) == val->get_type()){
            offset += 8;
        }else{ //Atom type
            offset += sizeof(uintptr_t);
        }
...
void LLVMEmitter::do_greaterthan(BinaryExpr *instr) {
  ...
  // but the inner meaning here is that an AS compare can return true, false, or
  // undefined. Only "true" is true. So... as a result, a < b is not equivalent
  // to !(a >= b) since the values will differ when the result of tjhe compare
  // is undefined.
  llvm::Value *compare_atom =
      emitCompareLess(def_ins(instr->rhs_in()), def_ins(instr->lhs_in()));
  llvm::Value *bool_out =
      CreateICmpEQ(compare_atom, getAtomConstant(trueAtom), "greaterthan");
  set_def_ins(instr->value_out(), bool_out);
}

void LLVMEmitter::do_lessthan(BinaryExpr *instr) {
  llvm::Value *compare_atom =
      emitCompareLess(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  llvm::Value *bool_out =
      CreateICmpEQ(compare_atom, getAtomConstant(trueAtom), "lessthan");
  set_def_ins(instr->value_out(), bool_out);
}
...
void LLVMEmitter::do_cast(BinaryStmt *instr) {
  ...
  llvm::Value *result_ins =
      downcast_obj(value_ins, env_param, traitsVal(type(instr->lhs_in())));
...
void LLVMEmitter::do_addd(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateFAdd(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_subd(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateFSub(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_muld(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateFMul(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_divd(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateFDiv(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_addi(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateAdd(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_subi(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateSub(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_muli(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateMul(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_andi(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateAnd(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_ori(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateOr(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_xori(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateXor(def_ins(instr->lhs_in()), def_ins(instr->rhs_in()));
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_lshi(BinaryExpr *instr) {
  llvm::Value *value_masked =
      CreateAnd(def_ins(instr->rhs_in()), getInt32(0x1F));
...
void LLVMEmitter::do_eqi(BinaryExpr *instr) {
  llvm::Value *value_out =
      CreateZExt(CreateICmpEQ(upcastTo(def_ins(instr->lhs_in()), getInt32Ty()),
                              upcastTo(def_ins(instr->rhs_in()), getInt32Ty())),
                 getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_lti(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpSLT(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_lei(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpSLE(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_gti(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpSGT(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_gei(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpSGE(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_eqd(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateFCmpOEQ(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_ltd(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateFCmpOLT(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_led(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateFCmpOLE(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_gtd(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateFCmpOGT(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_ged(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateFCmpOGE(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_equi(BinaryExpr *instr) { do_eqi(instr); }

void LLVMEmitter::do_ltui(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpULT(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_leui(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpULE(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
void LLVMEmitter::do_gtui(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpUGT(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_geui(BinaryExpr *instr) {
  llvm::Value *value_out = CreateZExt(
      CreateICmpUGE(def_ins(instr->lhs_in()), def_ins(instr->rhs_in())),
      getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_eqb(BinaryExpr *instr) { do_eqi(instr); }

void LLVMEmitter::do_eqp(BinaryExpr *instr) {
  llvm::Value *lhs = def_ins(instr->lhs_in()), *rhs = def_ins(instr->rhs_in());
  if (lhs->get_type() != rhs->get_type()) {
    if (canUpcastTo(lhs->get_type(), rhs->get_type()))
      lhs = upcastTo(lhs, rhs->get_type());
    else if (canUpcastTo(rhs->get_type(), lhs->get_type()))
      rhs = upcastTo(rhs, lhs->get_type());
    else
...
void LLVMEmitter::do_i2d(UnaryExpr *instr) {
  llvm::Value *value_out =
      CreateSIToFP(def_ins(instr->value_in()), getDoubleTy());
  set_def_ins(instr->value_out(), value_out);
}

void LLVMEmitter::do_d2i(UnaryExpr *instr) {
  llvm::Value *value_out =
      CreateFPToSI(def_ins(instr->value_in()), getInt32Ty());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_u2d(UnaryExpr *instr) {
  llvm::Value *value_out =
      CreateUIToFP(def_ins(instr->value_in()), getDoubleTy());
  set_def_ins(instr->value_out(), value_out);
}
...
void LLVMEmitter::do_setslot(CallStmt2 *instr) {
  ...
  // IMPORTANT: ignore the lattice info about layouts since that applies to the
  // host architecture, not the target uint32_t offset =
  // ir->lattice.getSlotOffset(object_type, slot);
  ...
  case kModelAtom: {
    llvm::Value *ep =
        createMemberGEP(object, field, llvm::StringRef(field->name) + "&");
    callIns(STUBINFO(atomWriteBarrier), 4, gcAddr, object, ep,
            def_ins(value_in));
    break;
  }
  case kModelScriptObject:
  ...
  case kModelNamespace: {
    llvm::Value *ep =
        createMemberGEP(object, field, llvm::StringRef(field->name) + "&");
    callIns(STUBINFO(privateWriteBarrierRC), 4, gcAddr, object, ep,
            def_ins(value_in));
    break;
  }
  case kModelInt:
...
void LLVMEmitter::do_newinstance(UnaryExpr *instr) {
  ...
  llvm::Value *funcptr =
      loadMember(ivtable, module.vtable_createinstanceproc_member);
  llvm::Value *object =
      callIns(STUBINFO(createInstanceProc), 2, funcptr, def_ins(ctor_in));
...
void LLVMEmitter::do_newclass(NaryStmt2 *instr) {
  ...
  for (int i = nScopes - extraScopeCount, j = 0; i < nScopes; ++i, ++j) {
    ...
    if (options::debugScopes) {
      printf(">>   scope %s %s\n", module.traitsName(t).c_str(),
             scopeTraitsVec[j]->getName().data());
    }
  }
  llvm::Value *scopeTraitsConst = CreateAlloca(
      module.traitsPtrTy, getInt32(scopeTraitsVec.size()), "scopeTraitsArray");

  for (int i = 0; i < scopeTraitsVec.size(); ++i) {
    llvm::Value *argLoc =
        CreateConstGEP1_32(scopeTraitsConst, i, "av" + llvm::Twine(i) + "&");
    CreateStore(scopeTraitsVec[i], argLoc);
  }

  // extern "C" ClassClosure* llNewClass(MethodEnv* env, int classIndex,
  // Traits** ctraitsp, Traits** itraitsp, Traits*** scopeTraits,
  //     ClassClosure* base, int nWithScopes, int scopeCount, Atom* scopes)
  llvm::Value *result =
      callIns(STUBINFO(llNewClass), 7, env_param, getInt32(classIndex),
              /*traitsVar, itraitsVar,*/ scopeTraitsConst, baseVal,
...
void LLVMEmitter::do_newfunction(NaryStmt1 *instr) {
  ...
  if (options::debugScopes) {
    printf(">> newFunction %s, %d, %s, %s\n", containingMethodName.c_str(),
           body->method_id(), functionName.c_str(),
           /*dclTraitsVar->getName().data(), */
           module.traitsName(body->declaringTraits()).c_str());
  }
  ...
  emitAtomArgs(instr->args(), extraScopeCount);
  // extern "C" ClassClosure* llNewFunction(MethodEnv* env, uint32_t
  // methodindex, Traits** idForDeclaringTraits, Traits*** scopeTraits,
  //     int nWithScopes, int scopeCount, Atom* scopes)

  llvm::Value *result =
      callIns(STUBINFO(llNewFunction), 6, env_param,
              getInt32(body->method_id()), scopeTraitsConst,
              getInt32(nWithScopes), getInt32(extraScopeCount), params_);
  set_def_ins(instr->value_out(), result);
}
...
llvm::BasicBlock *LLVMEmitter::emitNpeHandler() {
  if (!npe_block) {
    npe_block =
        llvm::BasicBlock::Create(module.getContext(), "npe", currentFunction);
...
llvm::BasicBlock *LLVMEmitter::emitUpeHandler() {
  if (!upe_block) {
    upe_block =
        llvm::BasicBlock::Create(module.getContext(), "upe", currentFunction);
...
void LLVMEmitter::do_cknull(UnaryStmt *instr) {
  ...
  llvm::BasicBlock *nullcheck_ok =
      llvm::BasicBlock::Create(module.getContext(), "", currentFunction);
  CreateCondBr(CreateICmpULE(atom, undefined_ins), emitUpeHandler(),
               nullcheck_ok);
...
void LLVMEmitter::do_cknullobject(UnaryStmt *instr) {
  ...
  llvm::BasicBlock *nullcheck_ok =
      llvm::BasicBlock::Create(module.getContext(), "", currentFunction);
  AvmAssert(ptr->get_type()->isPointerTy());
  llvm::Value *cmp =
      CreateICmpEQ(ptr, llvm::ConstantPointerNull::get(
                            llvm::cast<llvm::PointerType>(ptr->get_type())));
  CreateCondBr(cmp, emitNpeHandler(), nullcheck_ok);
  SetInsertPoint(nullcheck_ok);
  set_def_ins(instr->value_out(), ptr);
}

// TODO (stan): AOT doesn't need to implement timeouts, except possibly at
// safepoints
...
void LLVMEmitter::do_doubletoint32(UnaryExpr *instr) {
  ...
  // Reason - On boundary cases (overflow ) CreateFPToSI behavior is undefined
  // as per llvm documentation.
  ...
  //    llvm::Value* result = CreateFPToSI(arg, getInt32Ty()); //### TODO:
  //    Verify semantics. set_def_ins(instr->value_out(), result);
}
...
void LLVMEmitter::do_abc_add(BinaryStmt *instr) {
  ...
  llvm::Value *result =
      callIns(STUBINFO(op_add_a_aa), 3, coreAddr, left_operand, right_operand);
  set_def_ins(instr->value_out(), result);
}
...
void LLVMEmitter::do_string2atom(UnaryExpr *i) { doTagPointer(i, kStringType); }
void LLVMEmitter::do_ns2atom(UnaryExpr *i) { doTagPointer(i, kNamespaceType); }

/// changes model atom to scriptobject
void LLVMEmitter::do_atom2scriptobject(UnaryExpr *instr) {
  const Use &value_in = instr->value_in();
  llvm::Value *result =
      removeTagReturningPointer(def_ins(value_in), module.scriptObjectPtrTy);
  set_def_ins(instr->value_out(), result);
}
...
void LLVMEmitter::do_bool2atom(UnaryExpr *instr) {
  ...
  llvm::Value *result =
      nativeToAtom(def_ins(value_in), getTraits(type(value_in)));
  set_def_ins(instr->value_out(), result);
}
...
void LLVMEmitter::do_getouterscope(BinaryExpr *instr) {
  ...
  llvm::Value *scopes =
      createMemberGEP(scope_chain, module.scope_scopes_member);
...
void LLVMEmitter::do_abc_finddef(BinaryStmt *instr) {
  ...
  llvm::Value *targetObj =
      CreateLoad(targetObjAddr, "FDCache:" + llvm::Twine(nameStr.c_str()));
  llvm::BasicBlock *oldBlock = GetInsertBlock();

  // check not null
  llvm::Value *cmp = CreateICmpEQ(
      targetObj, llvm::ConstantPointerNull::get(
                     llvm::cast<llvm::PointerType>(targetObj->get_type())));
  llvm::BasicBlock *ifNull =
      llvm::BasicBlock::Create(getContext(), "", currentFunction);
  llvm::BasicBlock *ifNonNull =
      llvm::BasicBlock::Create(getContext(), "", currentFunction);
  CreateCondBr(cmp, ifNull, ifNonNull);
  SetInsertPoint(ifNull);

  // If script object is not there then generate call to finddef_miss
  llvm::Value *newTargetObj =
      callIns(STUBINFO(finddef_miss), 2, targetObjAddr, getMethodFrame());

  CreateBr(ifNonNull);
  SetInsertPoint(ifNonNull);

  llvm::PHINode *finddefPhi = llvm::PHINode::Create(module.scriptObjectPtrTy, 2,
                                                    "abc_finddef", ifNonNull);
...
void LLVMEmitter::emitHelperCall2(UnaryExpr *instr,
                                  const LLVMModule::StubInfo *call) {
  const Use &value_in = instr->value_in();
...
void LLVMEmitter::emitSafepointSetup() {
  ...
  safepoint_space_ =
      CreateAlloca(module.atomTy, getInt32(safepoint_size), "safepoint_space_");
}
...
void LLVMEmitter::emitExceptionHandling() {
  ...
  exceptionFrame_ = CreateAlloca(module.exceptionFrameStruct->type, getInt32(1),
                                 "exceptionFrame");
  save_eip_ = CreateAlloca(getInt32Ty(), getInt32(1), "vpc");
  exceptionAtom_ =
      CreateAlloca(module.ptrSizedIntTy, getInt32(1), "exceptionAtom");
  ...
  llvm::Value *jmpbuf = createMemberGEP(
      exceptionFrame_, module.exceptionFrame_jmpbuf_member, "jmpbuf");
  llvm::CallInst *setjmpResult =
      callIns(STUBINFO(setjmp), 2, jmpbuf, getInt32(0));
  setjmpResult->setCanReturnTwice();

  catch_block_ = llvm::BasicBlock::Create(module.getContext(), "catch_handler",
                                          currentFunction);
  llvm::BasicBlock *afterExSetup = llvm::BasicBlock::Create(
      module.getContext(), "after_ex_setup", currentFunction);
...

  {
    ...
    for (int i = 0; i < exception_count; ++i) {
      ...
      ConstStructInitializer exceptionDesc(module.aotExceptionDescStruct);
      exceptionDesc.init(module.aotExceptionDesc_from_member,
                         getInt32(hdlr.from));
      ...
      llvm::Constant *typeIndexU30 = makeU32Constant(type_index, 5);
      exceptionDesc.init(module.aotExceptionDesc_typeIndexU30_member,
                         typeIndexU30);
      exceptionDesc.init(module.aotExceptionDesc_nameIndex_member,
                         getInt32(name_index));
      exceptionDescs[i] = exceptionDesc.create();

      // Moved matchtraitsp out of exceptionDesc because of the restriction
      // imposed by ConstStructInitializer, that all members of the structure
      // have to be of type llvm::Contanst. In an attempt to make this non global
      // we are using llvm::value for matchTraitsp instead.
      matchTraitspVec[i] = module.getTraitsValue(this, hdlr.traits);
    }
    llvm::Constant *exceptionDescsConst = llvm::ConstantArray::get(
        llvm::ArrayType::get(module.aotExceptionDescTy, exceptionDescs.size()),
        exceptionDescs);
    llvm::GlobalVariable *exceptionDescsVar = new llvm::GlobalVariable(
        module, exceptionDescsConst->get_type(), /*isConst*/ true,
        llvm::GlobalValue::InternalLinkage, exceptionDescsConst,
        "exceptionDesc");
    llvm::Value *exceptionDescsVal = CreateConstGEP2_32(
        exceptionDescsVar, 0, 0); // [n x AOTExceptionDesc] -> *AOTExceptionDesc

    llvm::Value *saved_eip = CreateLoad(save_eip_, "vpc_");
    // exceptionFrame_.beginCatch()

    llvm::Value *matchTraitspConst =
        CreateAlloca(module.traitsPtrTy, getInt32(matchTraitspVec.size()),
                     "matchTraitspArray");
    for (int i = 0; i < matchTraitspVec.size(); ++i) {
      llvm::Value *argLoc =
          CreateConstGEP1_32(matchTraitspConst, i, "av" + llvm::Twine(i) + "&");
      CreateStore(matchTraitspVec[i], argLoc);
    }

    llvm::Value *handler_ordinal =
        callIns(STUBINFO(llBeginCatch), 7, env_param, exceptionFrame_,
                saved_eip, getInt32(exception_count), exceptionDescsVal,
                matchTraitspConst, exceptionAtom_);
    ...
    CatchBlockInstr *defaultCatchBlockInstr = catch_blocks_
        [method->abc_exceptions()->exceptions[last_ordinal].target];
    llvm::BasicBlock *defaultCatchBlock = getBlock(defaultCatchBlockInstr);

    // You could make this a branch if there is only one catch, but LLVM will
    // figure that out. A special case for that is just one more way to possibly
    // be wrong.
    llvm::SwitchInst *sw =
        CreateSwitch(handler_ordinal, defaultCatchBlock, last_ordinal);
...
void LLVMEmitter::emitDebugEnter() {
  ...
  call_stack_node_ =
      CreateAlloca(module.callStackNodeTy, getInt32(1), "callStackNode");
  llvm::Value *eip = save_eip_;
  if (!eip)
    eip = llvm::ConstantPointerNull::get(getInt32Ty()->getPointerTo());
  callIns(STUBINFO(debugEnter), 5, env_param,
          llvm::ConstantPointerNull::get(module.genericPtrTy), call_stack_node_,
          safepoint_space_, eip);
}

llvm::Value *
LLVMEmitter::getActivationTraitsForMethodInfo(MethodInfo *methodInfo) {
...
void LLVMEmitter::do_catchblock(CatchBlockInstr *instr) {
  ...
  // "params" are in fact the arguments (locals), scopes, and one "stack"
  // location for the exception atom
  for (int i = 0, n = instr->paramc; i < n; ++i) {
    ...
    if (!isLinear(param_type) && !isState(param_type)) {
      if (i < safepoint_size) {
        ...
        llvm::Value *spLoc = CreateConstGEP1_32(
            safepoint_space_, i, "safepoint[" + llvm::Twine(i) + "]_");
        if (spLoc->get_type() != paramTy->getPointerTo())
          spLoc = CreateBitCast(spLoc, paramTy->getPointerTo());
        llvm::LoadInst *val =
            CreateLoad(spLoc, "cblocal[" + llvm::Twine(i) + "]");
...
void LLVMEmitter::do_newstate(ConstantExpr *instr) { (void)instr; }
...
void LLVMEmitter::do_setlocal(SetlocalInstr *instr) {
  ...
  // TODO: Halfmoon creates setlocal instructions for frame state updates that
  // are "stack pushes." and not just for setlocals. We don't need any of those
  // for now.
  ...
  llvm::Value *spLoc = CreateConstGEP1_32(
      safepoint_space_, varNo, "setlocal[" + llvm::Twine(varNo) + "]_");
...
void LLVMEmitter::do_getlocal(GetlocalStmt *instr) {
  ...
  llvm::LoadInst *load =
      CreateLoad(spLoc, "getlocal[" + llvm::Twine(varNo) + "]_");
...
void LLVMEmitter::do_safepoint(SafepointInstr *instr) { storeVPC(instr->vpc); }
...
void LLVMEmitter::do_abc_hasnext2(Hasnext2Stmt *instr) {
  ...
  llvm::Value *new_index = callIns(STUBINFO(hasnextproto), 3, env_param,
                                   hasnextAtom_, hasnextCounter_);
...
llvm::BasicBlock *LLVMEmitter::splitEdgeIfNecessary(llvm::BasicBlock *fromBlock,
                                                    llvm::BasicBlock *toBlock) {
  // Can't have two predecessors from the same block in a phi.
  // So if that happens create and return a new block that branches to the
  // destination block. If not, returns fromBlock.
    ...
    for (unsigned i = 0, n = phi->getNumIncomingValues(); i < n; ++i) {
      if (phi->getIncomingBlock(i) == fromBlock) {
        ...
        llvm::BasicBlock *bb = llvm::BasicBlock::Create(
            module.getContext(), fromBlock->getName() + "_split",
            currentFunction);
...
void LLVMEmitter::addPhiEdges(GotoInstr *instr) {
  ...
  // no need to worry about splitting since goto instrs have only a single
  // target
...
void LLVMEmitter::addPhiEdges(CondInstr *instr) {
  ...
  for (int iArm = 0, nArm = instr->armc; iArm < nArm; ++iArm) {
    ...
    llvm::BasicBlock *fromBlock =
        splitEdgeIfNecessary(GetInsertBlock(), toBlock);
  ...
  for (int i = 0; i < core->poolInfos.size(); i++) {
    ...
    if (pool == traits->pool) {
      for (int j = 0, end = (int)pool->classCount(); j < end; ++j) {
        if (traits == pool->getClassTraits(j)->itraits) {
          llvm::Value *res =
              loadInterfaceTraitsFromPool(getPoolLLVMValue(poolInfo), j);
          res->setName(module.traitsName(traits) + "_interface");
          return res;
        }
      }
...
llvm::Value *LLVMEmitter::getPoolLLVMValue(PoolInfo *poolInfo) {
  ...
  llvm::GlobalVariable *aotInfoVar =
      llvm::dyn_cast_or_null<llvm::GlobalVariable>(module.getNamedValue(name));
  if (!aotInfoVar) {
    aotInfoVar =
        new llvm::GlobalVariable(module, module.aotInfoTy, /*isConst*/ true,
                                 llvm::GlobalValue::ExternalLinkage, 0, name);
  }
  llvm::Value *res =
      callIns(STUBINFO(llGetPoolSameWorker), 2, poolAddr, aotInfoVar);
  return res;
}
