...
static const Register R3 = {
    3}; // Excluded from the regalloc because of its use as a hyper-scratch.
...
static const Register _F14 =
    _D7; // Excluded from the regalloc because of its use as a hyper-scratch.
...
static const RegisterMask SavedRegs =
    ((1 << REGNUM(R8)) | (1 << REGNUM(R9)) | (1 << REGNUM(R10)) |
     (1 << REGNUM(R11)) | (1 << REGNUM(R12)) | (1 << REGNUM(R13)));
static const RegisterMask ScratchRegs =
    ((1 << REGNUM(R0)) | (1 << REGNUM(R1)) | (1 << REGNUM(R2)) |
     (1 << REGNUM(R4)) | (1 << REGNUM(R5)) | (1 << REGNUM(R6)) |
     (1 << REGNUM(R7)));

static const RegisterMask GpRegs = ScratchRegs | SavedRegs;
static const RegisterMask FpRegs =
    ((1 << REGNUM(_D0)) | (1 << REGNUM(_D1)) | (1 << REGNUM(_D2)) |
     (1 << REGNUM(_D3)) | (1 << REGNUM(_D4)) | (1 << REGNUM(_D5)) |
     (1 << REGNUM(_D6)));
...
// Maximum size in bytes of a patch for a branch, keep in sync' with
// nPatchBranch().
