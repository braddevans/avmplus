...
static inline uint32_t REGNUM(Register r) { return r.n; }
...
static inline bool operator==(Register r1, Register r2) { return r1.n == r2.n; }
...
static inline uint32_t REGNUM(Register r) { return r; }
#endif
