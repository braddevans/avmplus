...
public:
  ...
  bool hasIDom(BlockStartInstr *b) { return info_[b->blockid].idom != 0; }
  ...
  int depth(BlockStartInstr *b) { return info_[b->blockid].depth; }
...
private:
  ...
  LoopNode &loop(BlockStartInstr *b) { return loops_[b->blockid]; }
