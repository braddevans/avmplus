...
namespace halfmoon {
BailoutData::BailoutData(Allocator &alloc, MethodInfo *method, int scope_base,
                         int stack_base)
    : alloc_(alloc), method_info_(method), state_map_(alloc),
      scope_base_(scope_base), stack_base_(stack_base) {
...
void BailoutData::clean() { state_map_.clear(); }
