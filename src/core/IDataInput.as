...
public interface IDataInput {
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readBytes(bytes: ByteArray,
                                 offset: uint = 0,
                                 length: uint = 0): void;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readBoolean(): Boolean;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readUnsignedByte(): uint;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readShort(): int;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readUnsignedShort(): uint;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readUnsignedInt(): uint;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readFloat(): Number;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readDouble(): Number;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readMultiByte(length: uint, charSet: String): String;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readUTF(): String;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function readUTFBytes(length: uint): String;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function get bytesAvailable(): uint;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function get objectEncoding(): uint;

    [cppcall] function set objectEncoding(version: uint): void;
     ...
     *  @playerversion Lite 4
     */
    [cppcall] function get endian(): String;

    [cppcall] function set endian(type: String): void;
}
...
public interface IDataInput2 extends IDataInput {
     ...
     * @langversion 3.0
     */
    [cppcall] function readFloat4(): float4;
}
