 ...
 */
    class OSR {
    private:
        static void unboxSlot(FrameState *, MethodEnv *, Atom *interpFramePtr,
                              FramePtr jitFramePtr, uint8_t *jitFrameTags, int index);
    ...
    public:
        ...
        static bool countEdge(const MethodEnv *env, MethodInfo *m,
                              MethodSignaturep ms);
         ...
         * JIT-compiled code.
         */
        static bool execute(MethodEnv *env, Atom *interp_frame, MethodSignaturep ms,
