...
namespace avmplus {
    ...
    *CreateInstanceProc)(
    ...
    VTable(Traits
    *traits,
    VTable *base, Toplevel
    *toplevel);

    void resolveSignatures(ScopeChain *scope);

    VTable *newParameterizedVTable(Traits * param_traits, Stringp
    fullname);
    ...
    MethodEnv *GC_POINTERS(methods[1], "(MMgc::GC::Size(this) - offsetof(VTable, "
                                       "methods)) / sizeof(MethodEnv*)");
