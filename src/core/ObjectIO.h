...
//
    ...
    public:
    ObjectOutputObject(VTable
    *vtable,
    GCRef <ScriptObject> delegate
    )
    :
...
public:
DynamicPropertyOutputObject(VTable
*vtable,
GCRef <ScriptObject> delegate
)
:
...
DynamicPropertyOutputObject() { m_out = NULL; }
...
public:
DynamicPropertyOutputClass(VTable
*vtable);
...
public:
ObjectEncodingClass(VTable
*vtable);
~

ObjectEncodingClass();

IDynamicPropertyWriterInterface *get_dynamicPropertyWriter() {
    return m_writer;
}

void set_dynamicPropertyWriter(IDynamicPropertyWriterInterface *writer) {
    m_writer = writer;
}
