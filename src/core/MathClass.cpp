...
MathClass::MathClass(VTable *cvtable) : ClassClosure(cvtable) {
...
double MathClass::abs(double x) { return MathUtils::abs(x); }

double MathClass::acos(double x) { return MathUtils::acos(x); }

double MathClass::asin(double x) { return MathUtils::asin(x); }

double MathClass::atan(double x) { return MathUtils::atan(x); }

double MathClass::atan2(double y, double x) { return MathUtils::atan2(y, x); }

double MathClass::ceil(double x) { return MathUtils::ceil(x); }

double MathClass::cos(double x) { return MathUtils::cos(x); }

double MathClass::exp(double x) { return MathUtils::exp(x); }

double MathClass::floor(double x) { return MathUtils::floor(x); }

double MathClass::log(double x) { return MathUtils::log(x); }
...
double MathClass::pow(double x, double y) { return MathUtils::pow(x, y); }

double MathClass::random() { return MathUtils::random(&seed); }

double MathClass::round(double x) { return MathUtils::round(x); }

double MathClass::sin(double x) { return MathUtils::sin(x); }

double MathClass::sqrt(double x) { return MathUtils::sqrt(x); }

double MathClass::tan(double x) { return MathUtils::tan(x); }
...
double MathClass::minImpl(double x, double y, const Atom *argv, uint32_t argc) {
  ...
  for (uint32_t i = 0; i < argc; i++) {
    ...
    if (y < x) {
      ...
      /*
       Lars: "You can tell -0 from 0 by dividing 1 by the zero, -0 gives
       -Infinity and 0 gives Infinity, so if you know x is a zero the test for
       negative zero is (1/x < 0)."
       */
      if ((1.0 / y) < 0.0)
...
double MathClass::_min(double x, double y) {
  ...
  if (x < y)
    return x;
  if (x == y && x == 0.0 && 1.0 / x < 0.0 &&
      core()->currentBugCompatibility()->bugzilla551587 == 1)
    return x; // -0
  return y;
}
