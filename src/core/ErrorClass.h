 ...
 */
    ...
    *cvtable);
    ...
    public:
    REALLY_INLINE static ErrorClass
    *
    create(MMgc::GC
    *gc,
    VTable *cvtable
...
#ifdef DEBUGGER
Atom getStackTrace(Atom thisAtom, Atom *argv, int argc);
#endif /* DEBUGGER */
...
protected:
UninitializedErrorClass(VTable
*cvtable) :
NativeErrorClass(cvtable) {}
...
protected:
UninitializedErrorObject(VTable
*vtable,
ScriptObject *delegate
)
:
