 ...
 */
    ...
    *cvtable);
    ...
    // returns null (or a non-object atom), we throw kCantInstantiateError
    // instead.
    GCRef <ScriptObject> constructObject();

    static ClassClosure *FASTCALL
    createClassClosure(VTable
    *cvtable);
    ...
    *p);
     ...
     * printf-style
     */
    void throwError(int errorID, Stringp arg1 = 0, Stringp arg2 = 0,
                    Stringp arg3 = 0);
    ...
    checkForRestrictedInheritance(VTable
    *ivtable,
    ...
    *cvtable);
    ...
    value);
    Atom FASTCALL
    coerceToTypeImpl(Atom
    value);

    public:
    static ScriptObject *FASTCALL
    createScriptObjectProc(ClassClosure
    *cls);
    static ScriptObject *FASTCALL
    cantInstantiateCreateInstanceProc(ClassClosure
    *cls);
    static ScriptObject *FASTCALL
    impossibleCreateInstanceProc(ClassClosure
    *cls);

    private:
    static ScriptObject *FASTCALL
    reinitNullPrototypeCreateInstanceProc(ClassClosure
    *cls);
