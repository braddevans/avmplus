...
// Template specialization.
    ...
    TypedVectorObject<TLIST>::_getNativeIntProperty(int32_t
    index_i) const {
    AvmAssertMsg(!
...
template<class TLIST>
void FASTCALL
TypedVectorObject<TLIST>::throwRangeError_u(uint32_t
index) const {
toplevel()->
throwRangeError(kOutOfRangeError, core()
->
uintToString(index),
        core()
->
...
template<class TLIST>
void FASTCALL
TypedVectorObject<TLIST>::throwRangeError_i(int32_t
index) const {
toplevel()->
throwRangeError(kOutOfRangeError, core()
->
...
template<class TLIST>
void FASTCALL
TypedVectorObject<TLIST>::throwRangeError_a(Atom
index) const {
toplevel()->
throwRangeError(kOutOfRangeError, core()
->
