...
var FEATURES =
    <features>
        ...
        <feature>
            ...
            <!-- FIXME: Bug 536304 legacy name -->
            <defines>AVMPLUS_64BIT</defines>
            <!-- FIXME: Bug 536304 legacy name -->
        </feature>
        ...
        <feature>
            ...
            <defines>FEATURE_NANOJIT</defines>
            <!-- referenced by nanojit module only -->
        </feature>
        ...
        <feature>
            ...
            <requires>AVMFEATURE_AOT</requires>
            <!-- HM AOT requires AOT -->
        ...
        <feature>
            ...
            <requires>AVMFEATURE_HALFMOON</requires>
            <!-- eventually split HM IR from HM JIT -->
            <requires>AVMFEATURE_JIT</requires>
