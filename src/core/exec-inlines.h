...
namespace avmplus {
    ...
    ImtHolder::getIID(MethodInfo
    *m) {
    AvmAssert(m
    ->declaringTraits()->isInterface());
...
REALLY_INLINE bool OSR::countEdge(const MethodEnv *env, MethodInfo *m,
                                  MethodSignaturep ms) {
