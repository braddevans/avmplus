...
namespace avmplus {
    ...
    E4XNodeAux(Stringp
    s,
    Namespace *ns, FunctionObject
    *
    notify = NULL
    );

    public:
    REALLY_INLINE static E4XNodeAux
    *
    create(MMgc::GC
    *gc,
    Stringp name,
            Namespace
    *ns,
    FunctionObject *notify = NULL
    ) {
    return new (gc, MMgc::kExact)
    E4XNodeAux(name, ns, notify
    );
}
...
virtual void setNotification(AvmCore * /*core*/, FunctionObject * /*f*/,
                             Namespacep /*publicNS*/) {
    return;
}
...
E4XNode *_deepCopy(AvmCore *core, Toplevel *toplevel,
                   Namespacep publicNS) const;

E4XNode *_deepCopyForeign(AvmCore *core, Toplevel *toplevel,
                          Namespacep publicNS) const;

virtual void _insert(AvmCore *core, Toplevel *toplevel, uint32_t entry,
                     Atom value);

virtual E4XNode *_replace(AvmCore *core, Toplevel *toplevel, uint32_t entry,
                          Atom value, Atom pastValue = 0);
...
Namespace *FindNamespace(AvmCore *core, Toplevel *toplevel, Stringp &tagName,
                         bool bAttribute);
...
protected:
  ...
  // memory is used from this node on down to the bottom of the tree of
  // E4XNodes; will not look "up" the tree at m_parent.
...
public:
REALLY_INLINE static TextE4XNode
*
create(MMgc::GC
*gc,
E4XNode *parent,
...
protected:
  virtual uint64_t bytesUsedDown() const {
    return E4XNode::bytesUsedDown() + m_value->bytesUsed();
  }
#endif
};
...
CommentE4XNode(E4XNode
*parent,
String *value
);

public:
REALLY_INLINE static CommentE4XNode
*
create(MMgc::GC
*gc,
E4XNode *parent,
...
AttributeE4XNode(E4XNode
*parent,
String *value
);

public:
REALLY_INLINE static AttributeE4XNode
*
create(MMgc::GC
*gc,
E4XNode *parent,
...
CDATAE4XNode(E4XNode
*parent,
String *value
);

public:
REALLY_INLINE static CDATAE4XNode
*
create(MMgc::GC
*gc,
E4XNode *parent,
...
public:
REALLY_INLINE static PIE4XNode
*
create(MMgc::GC
*gc,
E4XNode *parent,
...
uintptr_t
        GC_POINTER(m_children); // Must write with WB, GCMember<> does not work.
...
ElementE4XNode(E4XNode
*parent);

public:
REALLY_INLINE static ElementE4XNode
*
create(MMgc::GC
*gc,
E4XNode *parent
...
E4XNode *_replace(AvmCore *core, Toplevel *toplevel, uint32_t entry,
                  Atom value, Atom pastValue = 0);

void CopyAttributesAndNamespaces(AvmCore *core, Toplevel *toplevel,
                                 XMLTag &tag, Namespacep publicNS);
