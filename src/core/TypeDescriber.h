...
namespace avmplus {
    ...
    public:
        ...
        enum Flags {
            // this bit replicates a bug in Flash9/10, where a method that uses a custom
            // namespace won't be in the output if any of its base classes (or
            // interfaces) also define a method in that custom namespace.
    ...
    private:
        ...
        void addDescribeMetadata(ArrayObject *a, PoolObject *pool,
        ...
        static void addBindings(AvmCore *core, MultinameBindingHashtable *bindings,
