 ...
 */
    ...
    public:
         ...
         */
        static int32_t Utf16ToUtf8(const wchar *in, int32_t inLen, uint8_t *out,
                                   int32_t outMax);
         ...
         *      and strict is true
         */
        static int32_t Utf8ToUtf16(const uint8_t *in, int32_t inLen, wchar *out,
         ...
         */
        static int32_t Utf8ToUcs4(const uint8_t *chars, int32_t len, uint32_t *out,
                                  bool bugzilla609416);
         ...
         * to UTF-8 (>0x7fffffff)
         */
        static int32_t Ucs4ToUtf8(uint32_t value, uint8_t *out);
    };
} // namespace avmplus
