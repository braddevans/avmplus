...
// BEGIN
    ...
    REALLY_INLINE double MathUtils::max(double x, double y) {
        return (x > y) ? x : y;
    }

    REALLY_INLINE double MathUtils::min(double x, double y) {
        return (x < y) ? x : y;
    }

    REALLY_INLINE double MathUtils::nan() { return kNaN; }

    REALLY_INLINE float MathUtils::maxf(float x, float y) {
        return (x > y) ? x : y;
    }

    REALLY_INLINE float MathUtils::minf(float x, float y) {
        return (x < y) ? x : y;
    }
// END
