...
// The visible build code: d(evelopment) or r(elease candidate), followed by an
// identifying string.
//
...
#define AVMPLUS_VERSION_USER                                                   \
  avmplus_stringify(AVMPLUS_MAJOR_VERSION) "." avmplus_stringify(              \
      AVMPLUS_MINOR_VERSION) AVMPLUS_SECURITY_SUFFIX

// A more complex user-facing version number
#define AVMPLUS_VERSION_STRING                                                                  \
  avmplus_stringify(AVMPLUS_MAJOR_VERSION) "," avmplus_stringify(                               \
      AVMPLUS_MINOR_VERSION) "," avmplus_stringify(AVMPLUS_BUILD_NUMBER) "," AVMPLUS_BUILD_CODE \
      AVMPLUS_SECURITY_SUFFIX

// Define Mac only resource change to 'vers' resource so that player installer
// will replace previous player versions
