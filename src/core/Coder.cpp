...
namespace avmplus {
NullWriter::NullWriter(CodeWriter *coder) : coder(coder) {}

NullWriter::~NullWriter() {}

void NullWriter::write(const FrameState *state, const uint8_t *pc,
                       AbcOpcode opcode, Traits *type) {
  coder->write(state, pc, opcode, type);
}

void NullWriter::writeOp1(const FrameState *state, const uint8_t *pc,
                          AbcOpcode opcode, uint32_t opd, Traits *type) {
  coder->writeOp1(state, pc, opcode, opd, type);
}

void NullWriter::writeOp2(const FrameState *state, const uint8_t *pc,
                          AbcOpcode opcode, uint32_t opd1, uint32_t opd2,
                          Traits *type) {
  coder->writeOp2(state, pc, opcode, opd1, opd2, type);
}

void NullWriter::writeMethodCall(const FrameState *state, const uint8_t *pc,
...
void NullWriter::writeCoerce(const FrameState *state, uint32_t index,
                             Traits *type) {
...
void NullWriter::writeOpcodeVerified(const FrameState *state, const uint8_t *pc,
                                     AbcOpcode opcode) {
  coder->writeOpcodeVerified(state, pc, opcode);
}

void NullWriter::writeFixExceptionsAndLabels(const FrameState *state,
                                             const uint8_t *pc) {
  coder->writeFixExceptionsAndLabels(state, pc);
}

void NullWriter::cleanup() { coder->cleanup(); }

CodeWriter::~CodeWriter() {}

void CodeWriter::write(const FrameState *, const uint8_t *, AbcOpcode,
                       Traits *) {}

void CodeWriter::writeOp1(const FrameState *, const uint8_t *, AbcOpcode,
                          uint32_t, Traits *) {}

void CodeWriter::writeOp2(const FrameState *, const uint8_t *, AbcOpcode,
                          uint32_t, uint32_t, Traits *) {}

void CodeWriter::writeMethodCall(const FrameState *, const uint8_t *, AbcOpcode,
...
void CodeWriter::writeOpcodeVerified(const FrameState *, const uint8_t *,
                                     AbcOpcode) {}

void CodeWriter::writeFixExceptionsAndLabels(const FrameState *,
                                             const uint8_t *) {}
