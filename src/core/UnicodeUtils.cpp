 ...
 *
 *  Code Point         Value Representation  1st Octet 2nd Octet 3rd Octet 4th
 * Octet
 *
 ...
 *
 *  0xD800 - 0xDBFF    110110vv vvwwwwxx     11110uuu  10uuwwww  10xxyyyy
 * 10zzzzzz followed by        followed by 0xDC00 - 0xDFFF    110111yy yyzzzzzz
 *
 *  0xD800 - 0xDBFF
...
int UnicodeUtils::Utf16ToUtf8(const wchar *in, int inLen, uint8_t *out,
                              int outMax) {
  int outLen = 0;
  if (out) {
...
int32_t UnicodeUtils::Utf8ToUtf16(const uint8_t *in, int32_t inLen, wchar *out,
                                  int32_t outMax, bool strict) {
  int32_t outLen = 0;
  uint32_t outch;
  while (inLen > 0) {
    ...
    case 15:
      ...
      outch = ((c << 18 & 0x1C0000) | (in[1] << 12 & 0x3F000) |
...
int32_t UnicodeUtils::Utf8ToUcs4(const uint8_t *chars, int32_t len,
                                 uint32_t *out, bool bugzilla609416) {
  ...
  static const uint32_t minUCS4[] = {0x00000000, 0x00000080, 0x00000800,
...
int32_t UnicodeUtils::Ucs4ToUtf8(uint32_t value, uint8_t *chars) {
  // U-00000000 - U-0000007F:     0xxxxxxx
  // U-00000080 - U-000007FF:     110xxxxx 10xxxxxx
  // U-00000800 - U-0000FFFF:     1110xxxx 10xxxxxx 10xxxxxx
  // U-00010000 - U-001FFFFF:     11110xxx 10xxxxxx 10xxxxxx 10xxxxxx
