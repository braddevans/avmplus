...
class AVM2Assembler {
    ...
    function get maxStack() {
        return max_stack_depth
    }

    function get maxLocal() {
        return nextTemp
    }

    function get maxScope() {
    ...
    */
    ...
    function I_getglobalscope() {
        pushOne("getglobalscope", 0x64)
    }

    function I_getlocal_0() {
        pushOne("getlocal_0", 0xD0)
    }

    function I_getlocal_1() {
        pushOne("getlocal_1", 0xD1)
    }

    function I_getlocal_2() {
        pushOne("getlocal_2", 0xD2)
    }

    function I_getlocal_3() {
        pushOne("getlocal_3", 0xD3)
    }

    function I_newactivation() {
        need_activation = true;
        pushOne("newactivation", 0x57)
    }

    function I_pushfalse() {
        pushOne("pushfalse", 0x27)
    }

    function I_pushnan() {
        pushOne("pushnan", 0x28)
    }

    function I_pushnull() {
        pushOne("pushnull", 0x20)
    }

    function I_pushtrue() {
        pushOne("pushtrue", 0x26)
    }

    function I_pushundefined() {
        pushOne("pushundefined", 0x21)
    }
    ...
    function I_getglobalslot(index) {
        pushOneU30("getglobalslot", 0x6E, index)
    }

    function I_getlex(index) {
        pushOneU30("getlex", 0x60, index)
    }

    function I_getscopeobject(index) {
        pushOneU30("getscopeobject", 0x65, index)
    }

    function I_getouterscope(index) {
        pushOneU30("getouterscope", 0x67, index)
    }

    function I_newcatch(index) {
        pushOneU30("newcatch", 0x5A, index)
    }

    function I_newfunction(index) {
        pushOneU30("newfunction", 0x40, index)
    }

    function I_pushdouble(index) {
        pushOneU30("pushdouble", 0x2F, index)
    }

    function I_pushint(index) {
        pushOneU30("pushint", 0x2D, index)
    }

    function I_pushnamespace(index) {
        pushOneU30("pushnamespace", 0x31, index)
    }

    function I_pushshort(v) {
        pushOneU30("pushshort", 0x25, v)
    }

    function I_pushstring(index) {
        pushOneU30("pushstring", 0x2C, index)
    }

    function I_pushuint(index) {
        pushOneU30("pushuint", 0x2E, index)
    }
    ...
    function I_astypelate() {
        dropOne("astypelate", 0x87)
    }
    ...
    function I_greaterequals() {
        dropOne("greaterequals", 0xB0)
    }

    function I_greaterthan() {
        dropOne("greaterthan", 0xAF)
    }

    function I_hasnext() {
        dropOne("hasnext", 0x1F)
    }
    ...
    function I_instanceof() {
        dropOne("instanceof", 0xB1)
    }

    function I_istypelate() {
        dropOne("istypelate", 0xB3)
    }

    function I_lessequals() {
        dropOne("lessequals", 0xAE)
    }

    function I_lessthan() {
        dropOne("lessthan", 0xAD)
    }
    ...
    function I_multiply() {
        dropOne("multiply", 0xA2)
    }

    function I_multiply_i() {
        dropOne("multiply_i", 0xC7)
    }

    function I_nextname() {
        dropOne("nextname", 0x1E)
    }

    function I_nextvalue() {
        dropOne("nextvalue", 0x23)
    }
    ...
    function I_pushscope() {
        scope(1);
        dropOne("pushscope", 0x30)
    }

    function I_pushwith() {
        scope(1);
        dropOne("pushwith", 0x1C)
    }

    function I_returnvalue() {
        dropOne("returnvalue", 0x48)
    }
    ...
    function I_setlocal_0() {
        dropOne("setlocal_0", 0xD4)
    }

    function I_setlocal_1() {
        dropOne("setlocal_1", 0xD5)
    }

    function I_setlocal_2() {
        dropOne("setlocal_2", 0xD6)
    }

    function I_setlocal_3() {
        dropOne("setlocal_3", 0xD7)
    }

    function I_strictequals() {
        dropOne("strictequals", 0xAC)
    }

    function I_subtract() {
        dropOne("subtract", 0xA1)
    }

    function I_subtract_i() {
        dropOne("subtract_i", 0xC6)
    }
    ...
    function I_setglobalslot(index) {
        dropOneU30("setglobalslot", 0x6F, index)
    }
    ...
    function I_bitnot() {
        dropNone("bitnot", 0x97)
    }

    function I_checkfilter() {
        dropNone("checkfilter", 0x78)
    }

    function I_coerce_a() {
        dropNone("coerce_a", 0x82)
    }

    function I_coerce_s() {
        dropNone("coerce_s", 0x85)
    }

    function I_convert_b() {
        dropNone("convert_b", 0x76)
    }

    function I_convert_d() {
        dropNone("convert_d", 0x75)
    }

    function I_convert_i() {
        dropNone("convert_i", 0x73)
    }

    function I_convert_o() {
        dropNone("convert_o", 0x77)
    }

    function I_convert_s() {
        dropNone("convert_s", 0x70)
    }

    function I_convert_u() {
        dropNone("convert_u", 0x74)
    }

    function I_decrement() {
        dropNone("decrement", 0x93)
    }

    function I_decrement_i() {
        dropNone("decrement_i", 0xC1)
    }

    function I_esc_xattr() {
        dropNone("esc_xattr", 0x72)
    }

    function I_esc_xelem() {
        dropNone("esc_xattr", 0x71)
    }

    function I_increment() {
        dropNone("increment", 0x91)
    }

    function I_increment_i() {
        dropNone("increment_i", 0xC0)
    }

    function I_negate() {
        dropNone("negate", 0x90)
    }

    function I_negate_i() {
        dropNone("negate_i", 0xC4)
    }
    ...
    function I_popscope() {
        scope(-1);
        dropNone("popscope", 0x1D)
    }

    function I_returnvoid() {
        dropNone("returnvoid", 0x47)
    }
    ...
    function I_astype(index) {
        dropNoneU30("astype", 0x86, index)
    }

    function I_coerce(index) {
        dropNoneU30("coerce", 0x80, index)
    }

    function I_debugfile(index) {
        dropNoneU30("debugfile", 0xF1, index)
    }

    function I_debugline(linenum) {
        dropNoneU30("debugline", 0xF0, linenum)
    }

    function I_declocal(reg) {
        dropNoneU30("declocal", 0x94, reg)
    }

    function I_declocal_i(reg) {
        dropNoneU30("declocal_i", 0xC3, reg)
    }

    function I_dxns(index) {
        set_dxns = true;
        dropNoneU30("dxns", 0x06, index)
    }

    function I_getslot(index) {
        dropNoneU30("getslot", 0x6C, index)
    }

    function I_inclocal(reg) {
        dropNoneU30("inclocal", 0x92, reg)
    }

    function I_inclocal_i(reg) {
        dropNoneU30("inclocal_i", 0xC2, reg)
    }

    function I_istype(index) {
        dropNoneU30("istype", 0xB2, index)
    }

    function I_kill(index) {
        dropNoneU30("kill", 0x08, index)
    }

    function I_newclass(index) {
        dropNoneU30("newclass", 0x58, index)
    }
    ...
    function I_getlocal(index) {
        switch (index) {
            ...
            case 3:
                ...
                break;
            default:
                pushOneU30("getlocal", 0x62, index);
        }
    }
    ...
    function I_ifeq(L) {
        return jmp(-2, "ifeq", 0x13, L)
    }

    function I_ifge(L) {
        return jmp(-2, "ifge", 0x18, L)
    }

    function I_ifgt(L) {
        return jmp(-2, "ifgt", 0x17, L)
    }

    function I_ifle(L) {
        return jmp(-2, "ifle", 0x16, L)
    }

    function I_iflt(L) {
        return jmp(-2, "iflt", 0x15, L)
    }

    function I_ifne(L) {
        return jmp(-2, "ifne", 0x14, L)
    }

    function I_ifnge(L) {
        return jmp(-2, "ifnge", 0x0F, L)
    }

    function I_ifngt(L) {
        return jmp(-2, "ifngt", 0x0E, L)
    }

    function I_ifnle(L) {
        return jmp(-2, "ifnle", 0x0D, L)
    }

    function I_ifnlt(L) {
        return jmp(-2, "ifnlt", 0x0C, L)
    }

    function I_ifstricteq(L) {
        return jmp(-2, "ifstricteq", 0x19, L)
    }

    function I_ifstrictne(L) {
        return jmp(-2, "ifstrictne", 0x1A, L)
    }

    function I_iffalse(L) {
        return jmp(-1, "iffalse", 0x12, L)
    }

    function I_iftrue(L) {
        return jmp(-1, "iftrue", 0x11, L)
    }

    function I_jump(L) {
        return jmp(0, "jump", 0x10, L)
    }
    ...
    function I_call(nargs) {
        call("call", 0x41, nargs)
    }

    function I_construct(nargs) {
        construct("construct", 0x42, nargs)
    }
    ...
    function I_callmethod(index, nargs) {
        callIDX("callmethod", 0x43, index, nargs)
    }

    function I_callstatic(index, nargs) {
        callIDX("callstatic", 0x44, index, nargs)
    }
    ...
    function I_callsuper(index, nargs) {
        callMN("callsuper", 0x45, index, nargs, false)
    }

    function I_callproperty(index, nargs) {
        callMN("callproperty", 0x46, index, nargs, false)
    }

    function I_constructprop(index, nargs) {
        callMN("constructprop", 0x4A, index, nargs, false)
    }

    function I_callproplex(index, nargs) {
        callMN("callproplex", 0x4C, index, nargs, false)
    }

    function I_callsupervoid(index, nargs) {
        callMN("callsupervoid", 0x4E, index, nargs, true)
    }

    function I_callpropvoid(index, nargs) {
        callMN("callpropvoid", 0x4F, index, nargs, true)
    }
    ...
    */
    ...
    function I_deleteproperty(index) {
        propU30("deleteproperty", 1, 1, 0x6A, index)
    }

    function I_getdescendants(index) {
        propU30("getdescendants", 1, 1, 0x59, index)
    }

    function I_getproperty(index) {
        propU30("getproperty", 1, 1, 0x66, index);
    }

    function I_getsuper(index) {
        propU30("getsuper", 1, 1, 0x04, index);
    }

    function I_findproperty(index) {
        propU30("findproperty", 0, 1, 0x5E, index)
    }

    function I_findpropstrict(index) {
        propU30("findpropstrict", 0, 1, 0x5D, index)
    }

    function I_initproperty(index) {
        propU30("initproperty", 2, 0, 0x68, index)
    }

    function I_setproperty(index) {
        propU30("setproperty", 2, 0, 0x61, index)
    }

    function I_setsuper(index) {
        propU30("setsuper", 2, 0, 0x05, index)
    }
