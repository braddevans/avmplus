...
final class Tok /*implements Serializable*/ {
    ...
    function Tok(kind, text, hash): kind

    = kind, text = text, hash = hash
    {
    }
...
internal function setup(id, name, attr = 0) {
    let
    tok = new Tok(id, name, Util::hash_string(name));
    tokenStore[id] = tok;
...
const Minus = 0;
setup(Token::Minus, "minus", ADDITIVEOP);
const MinusMinus = Token::Minus + 1;
setup(Token::MinusMinus, "minusminus");
const Not = Token::MinusMinus + 1;
setup(Token::Not, "not");
const NotEqual = Token::Not + 1;
setup(Token::NotEqual, "notequals", EQUALITY);
const StrictNotEqual = Token::NotEqual + 1;
setup(Token::StrictNotEqual, "strictnotequals", EQUALITY);
const Remainder = Token::StrictNotEqual + 1;
setup(Token::Remainder, "modulus", MULTIPLICATIVEOP);
const RemainderAssign = Token::Remainder + 1;
setup(Token::RemainderAssign, "modulusassign", OPASSIGN);
const BitwiseAnd = Token::RemainderAssign + 1;
setup(Token::BitwiseAnd, "bitwiseand");
const LogicalAnd = Token::BitwiseAnd + 1;
setup(Token::LogicalAnd, "logicaland");
const LogicalAndAssign = Token::LogicalAnd + 1;
setup(Token::LogicalAndAssign, "logicalandassign", OPASSIGN);
const BitwiseAndAssign = Token::LogicalAndAssign + 1;
setup(Token::BitwiseAndAssign, "bitwiseandassign", OPASSIGN);
const LeftParen = Token::BitwiseAndAssign + 1;
setup(Token::LeftParen, "leftparen");
const RightParen = Token::LeftParen + 1;
setup(Token::RightParen, "rightparen");
const Mult = Token::RightParen + 1;
setup(Token::Mult, "mult", MULTIPLICATIVEOP);
const MultAssign = Token::Mult + 1;
setup(Token::MultAssign, "multassign", OPASSIGN);
const Comma = Token::MultAssign + 1;
setup(Token::Comma, "comma");
const Dot = Token::Comma + 1;
setup(Token::Dot, "dot");
const TripleDot = Token::Dot + 1;
setup(Token::TripleDot, "tripledot");
const LeftDotAngle = Token::TripleDot + 1;
setup(Token::LeftDotAngle, "leftdotangle");
const Div = Token::LeftDotAngle + 1;
setup(Token::Div, "div", MULTIPLICATIVEOP);
const DivAssign = Token::Div + 1;
setup(Token::DivAssign, "divassign", OPASSIGN);
const Colon = Token::DivAssign + 1;
setup(Token::Colon, "colon");
const DoubleColon = Token::Colon + 1;
setup(Token::DoubleColon, "doublecolon");
const SemiColon = Token::DoubleColon + 1;
setup(Token::SemiColon, "semicolon");
const QuestionMark = Token::SemiColon + 1;
setup(Token::QuestionMark, "questionmark");
const LeftBracket = Token::QuestionMark + 1;
setup(Token::LeftBracket, "leftbracket");
const RightBracket = Token::LeftBracket + 1;
setup(Token::RightBracket, "rightbracket");
const LogicalXorAssign = Token::RightBracket + 1;
setup(Token::LogicalXorAssign, "logicalxorassign", OPASSIGN);
const LeftBrace = Token::LogicalXorAssign + 1;
setup(Token::LeftBrace, "leftbrace");
const LogicalOr = Token::LeftBrace + 1;
setup(Token::LogicalOr, "logicalor");
const LogicalOrAssign = Token::LogicalOr + 1;
setup(Token::LogicalOrAssign, "logicalorassign", OPASSIGN);
const BitwiseOr = Token::LogicalOrAssign + 1;
setup(Token::BitwiseOr, "bitwiseor");
const BitwiseOrAssign = Token::BitwiseOr + 1;
setup(Token::BitwiseOrAssign, "bitwiseorassign", OPASSIGN);
const BitwiseXor = Token::BitwiseOrAssign + 1;
setup(Token::BitwiseXor, "bitwisexor");
const BitwiseXorAssign = Token::BitwiseXor + 1;
setup(Token::BitwiseXorAssign, "bitwisexorassign", OPASSIGN);
const RightBrace = Token::BitwiseXorAssign + 1;
setup(Token::RightBrace, "rightbrace");
const BitwiseNot = Token::RightBrace + 1;
setup(Token::BitwiseNot, "bitwisenot");
const Plus = Token::BitwiseNot + 1;
setup(Token::Plus, "plus", ADDITIVEOP);
const PlusPlus = Token::Plus + 1;
setup(Token::PlusPlus, "plusplus");
const PlusAssign = Token::PlusPlus + 1;
setup(Token::PlusAssign, "plusassign", OPASSIGN);
const LessThan = Token::PlusAssign + 1;
setup(Token::LessThan, "lessthan", RELATIONAL);
const LeftShift = Token::LessThan + 1;
setup(Token::LeftShift, "leftshift", SHIFTOP);
const LeftShiftAssign = Token::LeftShift + 1;
setup(Token::LeftShiftAssign, "leftshiftassign", OPASSIGN);
const LessThanOrEqual = Token::LeftShiftAssign + 1;
setup(Token::LessThanOrEqual, "lessthanorequals", RELATIONAL);
const Assign = Token::LessThanOrEqual + 1;
setup(Token::Assign, "assign");
const MinusAssign = Token::Assign + 1;
setup(Token::MinusAssign, "minusassign", OPASSIGN);
const Equal = Token::MinusAssign + 1;
setup(Token::Equal, "equals", EQUALITY);
const StrictEqual = Token::Equal + 1;
setup(Token::StrictEqual, "strictequals", EQUALITY);
const GreaterThan = Token::StrictEqual + 1;
setup(Token::GreaterThan, "greaterthan", RELATIONAL);
const GreaterThanOrEqual = Token::GreaterThan + 1;
setup(Token::GreaterThanOrEqual, "greaterthanorequals", RELATIONAL);
const RightShift = Token::GreaterThanOrEqual + 1;
setup(Token::RightShift, "rightshift", SHIFTOP);
const RightShiftAssign = Token::RightShift + 1;
setup(Token::RightShiftAssign, "rightshiftassign", OPASSIGN);
const UnsignedRightShift = Token::RightShiftAssign + 1;
setup(Token::UnsignedRightShift, "unsignedrightshift", SHIFTOP);
const UnsignedRightShiftAssign = Token::UnsignedRightShift + 1;
setup(Token::UnsignedRightShiftAssign, "unsignedrightshiftassign", OPASSIGN);

// reserved identifiers

const Break = Token::UnsignedRightShiftAssign + 1;
setup(Token::Break, "break", RESERVED);
const Case = Token::Break + 1;
setup(Token::Case, "case", RESERVED);
const Cast = Token::Case + 1;
setup(Token::Cast, "cast", RESERVED | RELATIONAL | RELTYPE);
const Catch = Token::Cast + 1;
setup(Token::Catch, "catch", RESERVED);
const Class = Token::Catch + 1;
setup(Token::Class, "class", RESERVED);
const Const = Token::Class + 1;
setup(Token::Const, "const", RESERVED);
const Continue = Token::Const + 1;
setup(Token::Continue, "continue", RESERVED);
const Default = Token::Continue + 1;
setup(Token::Default, "default", RESERVED);
const Delete = Token::Default + 1;
setup(Token::Delete, "delete", RESERVED);
const Do = Token::Delete + 1;
setup(Token::Do, "do", RESERVED);
const Dynamic = Token::Do + 1;
setup(Token::Dynamic, "dynamic", RESERVED);
const Else = Token::Dynamic + 1;
setup(Token::Else, "else", RESERVED);
const False = Token::Else + 1;
setup(Token::False, "false", RESERVED | LITERAL);
const Final = Token::False + 1;
setup(Token::Final, "final", RESERVED);
const Finally = Token::Final + 1;
setup(Token::Finally, "finally", RESERVED);
const For = Token::Finally + 1;
setup(Token::For, "for", RESERVED);
const Function = Token::For + 1;
setup(Token::Function, "function", RESERVED);
const If = Token::Function + 1;
setup(Token::If, "if", RESERVED);
const In = Token::If + 1;
setup(Token::In, "in", RESERVED | RELATIONAL);
const InstanceOf = Token::In + 1;
setup(Token::InstanceOf, "instanceof", RESERVED | RELATIONAL);
const Interface = Token::InstanceOf + 1;
setup(Token::Interface, "interface", RESERVED);
const Is = Token::Interface + 1;
setup(Token::Is, "is", RESERVED | RELATIONAL | RELTYPE);
const Let = Token::Is + 1;
setup(Token::Let, "let", RESERVED);
const Like = Token::Let + 1;
setup(Token::Like, "like", RESERVED | RELATIONAL | RELTYPE);
const Namespace = Token::Like + 1;
setup(Token::Namespace, "namespace", RESERVED);
const Native = Token::Namespace + 1;
setup(Token::Native, "native", RESERVED);
const New = Token::Native + 1;
setup(Token::New, "new", RESERVED);
const Null = Token::New + 1;
setup(Token::Null, "null", RESERVED | LITERAL);
const Override = Token::Null + 1;
setup(Token::Override, "override", RESERVED);
const Return = Token::Override + 1;
setup(Token::Return, "return", RESERVED);
const Static = Token::Return + 1;
setup(Token::Static, "static", RESERVED);
const Super = Token::Static + 1;
setup(Token::Super, "super", RESERVED);
const Switch = Token::Super + 1;
setup(Token::Switch, "switch", RESERVED);
const This = Token::Switch + 1;
setup(Token::This, "this", RESERVED);
const Throw = Token::This + 1;
setup(Token::Throw, "throw", RESERVED);
const True = Token::Throw + 1;
setup(Token::True, "true", RESERVED | LITERAL);
const Try = Token::True + 1;
setup(Token::Try, "try", RESERVED);
const Type = Token::Try + 1;
setup(Token::Type, "type", RESERVED);
const TypeOf = Token::Type + 1;
setup(Token::TypeOf, "typeof", RESERVED);
const Use = Token::TypeOf + 1;
setup(Token::Use, "use", RESERVED);
const Var = Token::Use + 1;
setup(Token::Var, "var", RESERVED);
const Void = Token::Var + 1;
setup(Token::Void, "void", RESERVED);
const While = Token::Void + 1;
setup(Token::While, "while", RESERVED);
const With = Token::While + 1;
setup(Token::With, "with", RESERVED);
const Yield = Token::With + 1;
setup(Token::Yield, "yield", RESERVED);
const __Proto__ = Token::Yield + 1;
setup(Token::__Proto__, "__proto__", RESERVED);

// sundry

const Identifier = Token::__Proto__ + 1;
setup(Token::Identifier, "identifier", LEXEME);
const IntLiteral = Token::Identifier + 1;
setup(Token::IntLiteral, "intliteral", LEXEME | LITERAL);
const UIntLiteral = Token::IntLiteral + 1;
setup(Token::UIntLiteral, "uintliteral", LEXEME | LITERAL);
const DoubleLiteral = Token::UIntLiteral + 1;
setup(Token::DoubleLiteral, "doubleliteral", LEXEME | LITERAL);
const DecimalLiteral = Token::DoubleLiteral + 1;
setup(Token::DecimalLiteral, "decimalliteral", LEXEME | LITERAL);
const RegexpLiteral = Token::DecimalLiteral + 1;
setup(Token::RegexpLiteral, "regexpliteral", LEXEME | LITERAL);
const StringLiteral = Token::RegexpLiteral + 1;
setup(Token::StringLiteral, "stringliteral", LEXEME | LITERAL);

// meta

const EOS = Token::StringLiteral + 1;
setup(Token::EOS, "EOS");
const BREAK_SLASH = Token::EOS + 1;
setup(Token::BREAK_SLASH, "BREAK_SLASH");
const BREAK_RBROCKET = Token::BREAK_SLASH + 1;
setup(Token::BREAK_RBROCKET, "BREAK_RBROCKET");
const NONE = Token::BREAK_RBROCKET + 1;
setup(Token::NONE, "NONE");
