...
// Others
    words["to_value"] = function () {
        push(peek().valueOf());
    }
    words["to_string"] = function () {
        push(peek().toString());
    }
    words["write"] = function () {
        write(pop().toString());
    }
    words["writeln"] = function () {
        writeln(pop().toString());
    }
    words["clear_output"] = function () {
        clear_output();
    }
    words["clear_stack"] = function () {
        clear_stack();
    }
    words["clear"] = function () {
        clear_output();
        clear_stack();
    }
