...
void SymbianPlatform::setTimer(int /*seconds*/, AvmTimerCallback /*callback*/,
                               void * /*callbackData*/) {
  // TODO. Symbian Posix library does not have signals, timer should be
  // implemented using other Symbian API.
}
} // namespace avmshell
