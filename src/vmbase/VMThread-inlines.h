...
REALLY_INLINE RecursiveMutex::RecursiveMutex()
    : m_ownerThreadID((vmpi_thread_t)0), m_recursionCount(0) {
#else
REALLY_INLINE RecursiveMutex::RecursiveMutex() {
#endif
...
REALLY_INLINE bool ConditionVariable::wait(RecursiveMutex &mutex,
...
REALLY_INLINE void WaitNotifyMonitor::notify() { m_condVar.signal(); }

REALLY_INLINE void WaitNotifyMonitor::notifyAll() { m_condVar.broadcast(); }

#ifndef VMCFG_SAFEPOINTS // See Safepoint-inlines.h for templatized versions
REALLY_INLINE MutexLocker::MutexLocker(RecursiveMutex &mutex) : m_mutex(mutex) {
  m_mutex.lock();
}
REALLY_INLINE MutexLocker::~MutexLocker() { m_mutex.unlock(); }
...
REALLY_INLINE MonitorLocker::~MonitorLocker() { m_monitor.unlock(); }

REALLY_INLINE void MonitorLocker::wait() { m_monitor.wait(); }

REALLY_INLINE bool MonitorLocker::wait(int32_t timeout_millis) {
  return m_monitor.wait(timeout_millis);
}

REALLY_INLINE void MonitorLocker::notify() { m_monitor.notify(); }

REALLY_INLINE void MonitorLocker::notifyAll() { m_monitor.notifyAll(); }
#endif
...
REALLY_INLINE int32_t AtomicCounter32::get() const { return m_value; }
...
AtomicOps::compareAndSwap32(int32_t oldValue, int32_t newValue,
                            volatile int32_t *address) {
  return VMPI_compareAndSwap32(oldValue, newValue, address);
}

/* static */ REALLY_INLINE bool
AtomicOps::compareAndSwap32WithBarrier(int32_t oldValue, int32_t newValue,
                                       volatile int32_t *address) {
  return VMPI_compareAndSwap32WithBarrier(oldValue, newValue, address);
}

/* static */ REALLY_INLINE int32_t AtomicOps::compareAndSwap32WithBarrierPrev(
    int32_t expected, int32_t next, volatile int32_t *wordptr) {
  ...
  return ::InterlockedCompareExchange(
      reinterpret_cast<volatile LONG *>(wordptr), next, expected);
#else
  //  THIS IS WRONG!!!!
  //  the "val" needs to be atomically obtained from
  //  "compareAndSwap32WithBuffer"
  int32_t val = *wordptr;
...
/* static */ REALLY_INLINE int32_t AtomicOps::or32(uint32_t mask,
                                                   volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
...
AtomicOps::or32WithBarrier(uint32_t mask, volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
    oldValue = *address;
...
/* static */ REALLY_INLINE int32_t AtomicOps::and32(uint32_t mask,
                                                    volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
...
/* static */ REALLY_INLINE int32_t
AtomicOps::and32WithBarrier(uint32_t mask, volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
    oldValue = *address;
...
/* static */ REALLY_INLINE int32_t
AtomicOps::or32Prev(uint32_t mask, volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
    oldValue = *address;
...
/* static */ REALLY_INLINE int32_t
AtomicOps::or32WithBarrierPrev(uint32_t mask, volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
    oldValue = *address;
...
/* static */ REALLY_INLINE int32_t
AtomicOps::and32Prev(uint32_t mask, volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
    oldValue = *address;
...
/* static */ REALLY_INLINE int32_t
AtomicOps::and32WithBarrierPrev(uint32_t mask, volatile int32_t *address) {
  int32_t oldValue;
  int32_t newValue;
  do {
    oldValue = *address;
