...
bool AVMPI_useVirtualMemory() { return false; }
...
bool AVMPI_commitMemory(void * /*address*/, size_t /*size*/) { return false; }

bool AVMPI_decommitMemory(char * /*address*/, size_t /*size*/) { return false; }
...
void AVMPI_releaseAlignedMemory(void *address) { _aligned_free(address); }
...
void *AVMPI_allocateCodeMemory(size_t /*nbytes*/) { return NULL; }
...
/*
It may not be possible to implement this feature in Windows Store apps, at least
by using the same APIs as before.
...
bool AVMPI_isMemoryProfilingEnabled() { return false; }
