...
//
//  - All eval code is placed in the namespace avmplus::RTC ("run-time
//  compiler")
...
// The HostContext must be implemented by the embedder of eval.  'wchar' is a
// 16-bit unsigned value always.
...
virtual const wchar *readFileForEval(const wchar *basename,
