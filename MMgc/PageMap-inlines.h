...
namespace MMgc {
namespace PageMap {
REALLY_INLINE uintptr_t PageMapBase::MemStart() const { return memStart; }

REALLY_INLINE uintptr_t PageMapBase::MemEnd() const { return memEnd; }
...
REALLY_INLINE PageType Tiered2::LeafAddrToVal(uint8_t *subMap,
...
REALLY_INLINE void Tiered2::LeafAddrSet(uint8_t *subMap, uintptr_t addr,
                                        PageType val) {
  uint32_t k = AddrToIndex2(addr);
