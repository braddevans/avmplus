...
REALLY_INLINE BasicList<GC *> &GCManager::gcs() { return collectors; }
...
REALLY_INLINE size_t GCHeap::GetUsedHeapSize() const { return totalNumAlloc; }
...
REALLY_INLINE MemoryStatus GCHeap::GetStatus() { return status; }

/* static */
REALLY_INLINE size_t GCHeap::CheckForAllocSizeOverflow(size_t size,
                                                       size_t extra) {
...
/* static */
REALLY_INLINE size_t GCHeap::CheckForCallocSizeOverflow(size_t count,
                                                        size_t elsize) {
...
/* static */
REALLY_INLINE size_t GCHeap::CheckForNewSizeOverflow(size_t count,
                                                     size_t elsize,
                                                     bool canFail) {
  // If either of the size of requested bytes
  // or the number of requested size
...
/* static */
REALLY_INLINE uintptr_t GCHeap::AddToAddressWithOverflowCheck(uintptr_t base,
                                                              size_t offset) {
...
REALLY_INLINE GCHeapConfig &GCHeap::Config() { return config; }

REALLY_INLINE void *GCHeap::GetStackEntryAddress() {
  return (void *)GetEnterFrame();
}

REALLY_INLINE EnterFrame *GCHeap::GetEnterFrame() { return enterFrame; }
