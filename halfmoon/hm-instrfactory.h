...
#include "generated/InstrFactory_preds_proto.hh"
  ...
  NaryStmt1 *newNaryStmt1(InstrKind kind, Def *effect, Def *param, int argc,
                          Def *args[]);

  NaryStmt2 *newNaryStmt2(InstrKind kind, Def *effect, Def *param1, Def *param2,
  ...
  NaryStmt4 *newNaryStmt4(InstrKind kind, Def *effect, Def *param1, Def *param2,
                          Def *param3, Def *param4, int varargc,
                          Def *varargs[]);
  NaryStmt4 *newNaryStmt4(InstrKind kind, Def *effect, Def *param1, Def *param2,
                          Def *param3, Def *param4, Def *param5, int varargc,
                          Def *varargs[]);

  // call stmt with multiname
  CallStmt2 *newCallStmt2(InstrKind kind, Def *effect, Def *param, Def *obj,
                          int varargc, Def *varargs[]);
  CallStmt2 *newCallStmt2(InstrKind kind, Def *effect, Def *param, Def *obj,
                          Def *arg);
  CallStmt2 *newCallStmt2(InstrKind kind, Def *effect, Def *param, Def *obj);
  ...
  CallStmt4 *newCallStmt4(InstrKind kind, Def *effect, Def *param, Def *ns,
                          Def *index, Def *obj, int varargc, Def *varargs[]);
  ...
  StartInstr *newStartInstr(InstrKind kind, int num_params,
  ...
  // switch instr
  SwitchInstr *newSwitchInstr(Def *sel, int num_cases, int argc,
                              Def *default_arg);
  ...
  StopInstr *newStopInstr(InstrKind k, Def *effect, int data_argc,
                          Def *data_args[]);
  ...
  DeoptSafepointInstr *newDeoptSafepointInstr(Def *effect, int argc,
                                              Def *args[]);
  ...
  // debug
  DebugInstr2 *newDebugInstr2(InstrKind kind, Def *effect, Def *val1,
                              Def *val2);
...
private:
  ...
  CallStmt2 *createCallStmt2(InstrKind kind, Def *effect, Def *param, Def *obj,
                             int varargc);

  // private helper - create a CallStmt3, up to vararg initialization
  CallStmt3 *createCallStmt3(InstrKind kind, Def *effect, Def *param,
                             Def *index, Def *obj, int varargc);

  // private helper - initialize a CondInstr in place
  static void initCondInstr(Allocator &, CondInstr *instr, Def *sel, int argc,
                            Def *default_arg, const InstrInfo *arm_info);
...
public:
  ...
  InfoManager &infoManager() { return infos_; }
...
private:
  ...
  struct InfoKey {
    ...
    bool operator!=(const InfoKey &that) const { return !(*this == that); }
    // for HashMap
    static size_t hash(const InfoKey &k) { return (k.kind << 2) + k.argc; }
  };

public:
  InfoManager(Allocator &alloc) : alloc_(alloc), instr_infos_(alloc, HR_MAX) {}
  ...
  InstrInfo *get(InstrKind kind, int argc, InstrFactory *);
