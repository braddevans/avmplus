...
inline void Assembler::SH4_add(Register Ry, Register Rx) {
  ...
  SH4_emit16((0x3 << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             ((REGNUM(Ry) & 0xF) << 4) | (0xC << 0));
...
inline void Assembler::SH4_and(Register Ry, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && REGNUM(Ry) <= 15);
  SH4_emit16((0x2 << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             ((REGNUM(Ry) & 0xF) << 4) | (0x9 << 0));
...
inline void Assembler::SH4_ldc_bank(Register Rx, int imm) {
  ...
  SH4_emit16((0x4 << 12) | ((REGNUM(Rx) & 0xF) << 8) | ((imm & 0x7) << 4) |
             (0xE << 0));
...
inline void Assembler::SH4_macw_incRy_incRx(Register Ry, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && REGNUM(Ry) <= 15);
  SH4_emit16((0x4 << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             ((REGNUM(Ry) & 0xF) << 4) | (0xF << 0));
...
inline void Assembler::SH4_movb_dispR0Rx(Register Ry, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && REGNUM(Ry) <= 15);
  SH4_emit16((0x0 << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             ((REGNUM(Ry) & 0xF) << 4) | (0x4 << 0));
...
inline void Assembler::SH4_movb_dispRy_R0(int imm, Register Ry) {
  ...
  SH4_emit16((0x8 << 12) | (0x4 << 8) | ((REGNUM(Ry) & 0xF) << 4) |
             ((imm & 0xF) << 0));
...
inline void Assembler::SH4_movb_R0_dispRx(int imm, Register Rx) {
  ...
  SH4_emit16((0x8 << 12) | (0x0 << 8) | ((REGNUM(Rx) & 0xF) << 4) |
             ((imm & 0xF) << 0));
...
#define FITS_SH4_movl_dispRx(imm)                                              \
  (SH4_CHECK_RANGE_movl_dispRx(imm) && SH4_CHECK_ALIGN_movl_dispRx(imm))

inline void Assembler::SH4_movl_dispRx(Register Ry, int imm, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && REGNUM(Ry) <= 15 &&
             SH4_CHECK_RANGE_movl_dispRx(imm) &&
             SH4_CHECK_ALIGN_movl_dispRx(imm));
  SH4_emit16((0x1 << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             ((REGNUM(Ry) & 0xF) << 4) | (((imm & 0x3C) >> 2) << 0));
...
#define FITS_SH4_movl_dispRy(imm)                                              \
  (SH4_CHECK_RANGE_movl_dispRy(imm) && SH4_CHECK_ALIGN_movl_dispRy(imm))

inline void Assembler::SH4_movl_dispRy(int imm, Register Ry, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && REGNUM(Ry) <= 15 &&
             SH4_CHECK_RANGE_movl_dispRy(imm) &&
             SH4_CHECK_ALIGN_movl_dispRy(imm));
  SH4_emit16((0x5 << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             ((REGNUM(Ry) & 0xF) << 4) | (((imm & 0x3C) >> 2) << 0));
...
#define FITS_SH4_movl_dispGBR_R0(imm)                                          \
  (SH4_CHECK_RANGE_movl_dispGBR_R0(imm) && SH4_CHECK_ALIGN_movl_dispGBR_R0(imm))

inline void Assembler::SH4_movl_dispGBR_R0(int imm) {
  NanoAssert(1 && SH4_CHECK_RANGE_movl_dispGBR_R0(imm) &&
...
inline void Assembler::SH4_movl_dispPC(int imm, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && SH4_CHECK_RANGE_movl_dispPC(imm) &&
             SH4_CHECK_ALIGN_movl_dispPC(imm));
  SH4_emit16((0xD << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             (((imm & 0x3FC) >> 2) << 0));
...
#define FITS_SH4_movl_R0_dispGBR(imm)                                          \
  (SH4_CHECK_RANGE_movl_R0_dispGBR(imm) && SH4_CHECK_ALIGN_movl_R0_dispGBR(imm))

inline void Assembler::SH4_movl_R0_dispGBR(int imm) {
  NanoAssert(1 && SH4_CHECK_RANGE_movl_R0_dispGBR(imm) &&
...
#define FITS_SH4_movw_dispRy_R0(imm)                                           \
  (SH4_CHECK_RANGE_movw_dispRy_R0(imm) && SH4_CHECK_ALIGN_movw_dispRy_R0(imm))

inline void Assembler::SH4_movw_dispRy_R0(int imm, Register Ry) {
  NanoAssert(1 && REGNUM(Ry) <= 15 && SH4_CHECK_RANGE_movw_dispRy_R0(imm) &&
             SH4_CHECK_ALIGN_movw_dispRy_R0(imm));
  SH4_emit16((0x8 << 12) | (0x5 << 8) | ((REGNUM(Ry) & 0xF) << 4) |
             (((imm & 0x1E) >> 1) << 0));
...
#define FITS_SH4_movw_dispGBR_R0(imm)                                          \
  (SH4_CHECK_RANGE_movw_dispGBR_R0(imm) && SH4_CHECK_ALIGN_movw_dispGBR_R0(imm))

inline void Assembler::SH4_movw_dispGBR_R0(int imm) {
  NanoAssert(1 && SH4_CHECK_RANGE_movw_dispGBR_R0(imm) &&
...
#define FITS_SH4_movw_dispPC(imm)                                              \
  (SH4_CHECK_RANGE_movw_dispPC(imm) && SH4_CHECK_ALIGN_movw_dispPC(imm))

inline void Assembler::SH4_movw_dispPC(int imm, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && SH4_CHECK_RANGE_movw_dispPC(imm) &&
             SH4_CHECK_ALIGN_movw_dispPC(imm));
  SH4_emit16((0x9 << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             (((imm & 0x1FE) >> 1) << 0));
...
#define FITS_SH4_movw_R0_dispRx(imm)                                           \
  (SH4_CHECK_RANGE_movw_R0_dispRx(imm) && SH4_CHECK_ALIGN_movw_R0_dispRx(imm))

inline void Assembler::SH4_movw_R0_dispRx(int imm, Register Rx) {
  NanoAssert(1 && REGNUM(Rx) <= 15 && SH4_CHECK_RANGE_movw_R0_dispRx(imm) &&
             SH4_CHECK_ALIGN_movw_R0_dispRx(imm));
  SH4_emit16((0x8 << 12) | (0x1 << 8) | ((REGNUM(Rx) & 0xF) << 4) |
             (((imm & 0x1E) >> 1) << 0));
...
#define FITS_SH4_movw_R0_dispGBR(imm)                                          \
  (SH4_CHECK_RANGE_movw_R0_dispGBR(imm) && SH4_CHECK_ALIGN_movw_R0_dispGBR(imm))

inline void Assembler::SH4_movw_R0_dispGBR(int imm) {
  NanoAssert(1 && SH4_CHECK_RANGE_movw_R0_dispGBR(imm) &&
...
#define FITS_SH4_mova_dispPC_R0(imm)                                           \
  (SH4_CHECK_RANGE_mova_dispPC_R0(imm) && SH4_CHECK_ALIGN_mova_dispPC_R0(imm))

inline void Assembler::SH4_mova_dispPC_R0(int imm) {
  NanoAssert(1 && SH4_CHECK_RANGE_mova_dispPC_R0(imm) &&
...
inline void Assembler::SH4_stc_bank(int imm, Register Rx) {
  ...
  SH4_emit16((0x0 << 12) | ((REGNUM(Rx) & 0xF) << 8) | ((imm & 0x7) << 4) |
             (0x2 << 0));
...
inline void Assembler::SH4_fabs(Register Rx) {
  ...
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x5 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fcnvds_double_FPUL(Register Rx) {
  ...
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0xB << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fcnvsd_FPUL_double(Register Rx) {
  NanoAssert(1 && !((REGNUM(Rx) - 16) & 0x1));
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0xA << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fipr(Register Ry, Register Rx) {
  ...
  SH4_emit16(
      (0xF << 12) |
      (((((REGNUM(Rx) - 16) & 0xF) << 2) | (((REGNUM(Ry) - 16) & 0xF) >> 2))
       << 8) |
      (0xE << 4) | (0xD << 0));
...
inline void Assembler::SH4_fldi0(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x8 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fldi1(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x9 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_flds_FPUL(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x1 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_float_FPUL(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x2 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fmov_indRx(Register Ry, Register Rx) {
  ...
  SH4_emit16((0xF << 12) | ((REGNUM(Rx) & 0xF) << 8) |
             (((REGNUM(Ry) - 16) & 0xF) << 4) | (0xA << 0));
...
inline void Assembler::SH4_fneg(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x4 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fsca_FPUL_double(Register Rx) {
  NanoAssert(1 && !((REGNUM(Rx) - 16) & 0x1));
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0xF << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fsqrt(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x6 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fsrra(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x7 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_fsts_FPUL(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x0 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_ftrc_FPUL(Register Rx) {
  NanoAssert(1 && (REGNUM(Rx) - 16) <= 15);
  SH4_emit16((0xF << 12) | (((REGNUM(Rx) - 16) & 0xF) << 8) | (0x3 << 4) |
             (0xD << 0));
...
inline void Assembler::SH4_ftrv(Register Rx) {
  ...
  SH4_emit16((0xF << 12) | (((((REGNUM(Rx) - 16) & 0xF) << 2) | 0x1) << 8) |
             (0xF << 4) | (0xD << 0));
