...
#define DECLARE_PLATFORM_ASSEMBLER()                                           \
  inline void xALUi(ALU_Op op, uint32_t S, Register rd, Register rl,           \
                    uint32_t op2imm);                                          \
  inline void xTSTi(Test_Op op, Register rl, uint32_t op2imm);                 \
  inline void xMOVi(Move_Op op, Register rd, uint32_t op2imm);                 \
  inline void xALUr(ALU_Op op, uint32_t S, Register rd, Register rl,           \
                    Register rr);                                              \
  ...
  inline void GenericVfp(const char *NAME, Register _Dd, Register _Dn,         \
                         Register _Dm, uint32_t SPECIFIC_ENC);                 \
  inline void GenericNeon(const char *NAME, Register _Qd, Register _Qn,        \
                          Register _Qm, uint32_t SPECIFIC_ENC);                \
  ...
  inline void VCVT(const char *name, Register _Rd, Register _Rm,               \
                   uint32_t SPECIFIC_ENC, bool check_dst = true);              \
...
#define PC_OFFSET_FROM(target, frompc)                                         \
  ((intptr_t)(target) - ((intptr_t)(frompc) + 4))
