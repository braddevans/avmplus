...
static const Register G0 = {0}, G1 = {1}, G2 = {2}, G3 = {3}, G4 = {4},
                      G5 = {5}, // Reserved for system
    G6 = {6},                   // Reserved for system
    G7 = {7},                   // Reserved for system

    O0 = {8}, O1 = {9}, O2 = {10}, O3 = {11}, O4 = {12}, O5 = {13},
                      O6 = {14}, // SP
    O7 = {15},                   // Not used.

    L0 = {16}, L1 = {17}, L2 = {18}, L3 = {19}, L4 = {20}, L5 = {21}, L6 = {22},
                      L7 = {23},

                      I0 = {24}, I1 = {25}, I2 = {26}, I3 = {27}, I4 = {28},
                      I5 = {29}, I6 = {30}, // FP
    I7 = {31},                              // Not used
    ...
    SP = O6, FP = I6,
                      ...
                      F5 = {37}, F6 = {38}, F7 = {39}, F8 = {40}, F9 = {41},
                      F10 = {42}, F11 = {43}, F12 = {44}, F13 = {45},
                      F14 = {46}, F15 = {47}, F16 = {48}, F17 = {49},
                      F18 = {50}, F19 = {51}, F20 = {52}, F21 = {53},
                      F22 = {54}, F23 = {55}, F24 = {56}, F25 = {57},
                      F26 = {58}, F27 = {59}, F28 = {60}, F29 = {61},
                      F30 = {62}, F31 = {63},
...
static const RegisterMask SavedRegs =
    _rmask_(L1) | _rmask_(L3) | _rmask_(L5) | _rmask_(L7) | _rmask_(I0) |
    _rmask_(I1) | _rmask_(I2) | _rmask_(I3) | _rmask_(I4) | _rmask_(I5);
static const RegisterMask GpRegs = SavedRegs | _rmask_(O0) | _rmask_(O1) |
                                   _rmask_(O2) | _rmask_(O3) | _rmask_(O4) |
                                   _rmask_(O5);
...
#define DECLARE_PLATFORM_ASSEMBLER()                                           \
  ...
  void Format_2_3(int32_t a, int32_t cond, int32_t op2, int32_t cc1,           \
                  int32_t cc0, int32_t p, int32_t disp19) {                    \
    Format_2_2(a, cond, op2,                                                   \
               (cc1 & 0x1) << 21 | (cc0 & 0x1) << 20 | (p & 0x1) << 19 |       \
                   disp19 & 0x7FFFF);                                          \
  }                                                                            \
  void Format_2_4(int32_t a, int32_t rcond, int32_t op2, int32_t d16hi,        \
                  int32_t p, int32_t rs1, int32_t d16lo) {                     \
    Format_2_2(a, rcond & 0x7, op2,                                            \
               (d16hi & 0x3) << 20 | (p & 0x1) << 19 | rs1 << 14 |             \
                   d16lo & 0x3FFF);                                            \
  }                                                                            \
  ...
  void Format_3_1(int32_t op1, Register rd, int32_t op3, Register rs1,         \
                  int32_t bit8, Register rs2) {                                \
    Format_3A(op1, rd, op3,                                                    \
              _reg_(rs1) << 14 | (bit8 & 0xFF) << 5 | _reg_(rs2));             \
  }                                                                            \
  void Format_3_1I(int32_t op1, Register rd, int32_t op3, Register rs1,        \
                   int32_t simm13) {                                           \
    Format_3A(op1, rd, op3, _reg_(rs1) << 14 | 1 << 13 | simm13 & 0x1FFF);     \
  }                                                                            \
  void Format_3_2(int32_t op1, Register rd, int32_t op3, Register rs1,         \
                  int32_t rcond, Register rs2) {                               \
    Format_3A(op1, rd, op3,                                                    \
              _reg_(rs1) << 14 | (rcond & 0x3) << 10 | _reg_(rs2));            \
  }                                                                            \
  void Format_3_2I(int32_t op1, Register rd, int32_t op3, Register rs1,        \
                   int32_t rcond, int32_t simm10) {                            \
    Format_3A(op1, rd, op3,                                                    \
              _reg_(rs1) << 14 | 1 << 13 | (rcond & 0x3) << 10 |               \
                  simm10 & 0x1FFF);                                            \
  }                                                                            \
  void Format_3_3(int32_t op1, Register rd, int32_t op3, Register rs1,         \
                  int32_t cmask, int32_t mmask) {                              \
    Format_3A(op1, rd, op3,                                                    \
              _reg_(rs1) << 14 | 1 << 13 | (cmask & 0x7) << 5 | mmask & 0xF);  \
  }                                                                            \
  void Format_3_4(int32_t op1, Register rd, int32_t op3, int32_t bits19) {     \
    Format_3A(op1, rd, op3, bits19);                                           \
  }                                                                            \
  void Format_3_5(int32_t op1, Register rd, int32_t op3, Register rs1,         \
                  int32_t x, Register rs2) {                                   \
    Format_3A(op1, rd, op3, _reg_(rs1) << 14 | (x & 0x1) << 12 | _reg_(rs2));  \
  }                                                                            \
  void Format_3_6(int32_t op1, Register rd, int32_t op3, Register rs1,         \
                  int32_t shcnt32) {                                           \
    Format_3A(op1, rd, op3, _reg_(rs1) << 14 | 1 << 13 | (shcnt32 & 0x3F));    \
  }                                                                            \
  void Format_3_7(int32_t op1, Register rd, int32_t op3, Register rs1,         \
                  int32_t shcnt64) {                                           \
    Format_3A(op1, rd, op3,                                                    \
              _reg_(rs1) << 14 | 1 << 13 | 1 << 12 | (shcnt64 & 0x7F));        \
  }                                                                            \
  void Format_3_8(int32_t op1, Register rd, int32_t op3, Register rs1,         \
                  int32_t bits9, Register rs2) {                               \
    Format_3A(op1, rd, op3,                                                    \
              _reg_(rs1) << 14 | (bits9 & 0x1FF) << 5 | _reg_(rs2));           \
  }                                                                            \
  void Format_3_9(int32_t op1, int32_t cc1, int32_t cc0, int32_t op3,          \
                  Register rs1, int32_t bits9, Register rs2) {                 \
    Format_3(op1, (cc1 & 0x1) << 1 | (cc0 & 0x1), op3,                         \
             _reg_(rs1) << 14 | (bits9 & 0x1FF) << 5 | _reg_(rs2));            \
  }                                                                            \
  void Format_4_1(Register rd, int32_t op3, Register rs1, int32_t cc1,         \
                  int32_t cc0, Register rs2) {                                 \
    Format_3A(2, rd, op3,                                                      \
              _reg_(rs1) << 14 | (cc1 & 0x1) << 12 | (cc0 & 0x1) << 11 |       \
                  _reg_(rs2));                                                 \
  }                                                                            \
  void Format_4_1I(Register rd, int32_t op3, Register rs1, int32_t cc1,        \
                   int32_t cc0, int32_t simm11) {                              \
    Format_3A(2, rd, op3,                                                      \
              _reg_(rs1) << 14 | (cc1 & 0x1) << 12 | 1 << 13 |                 \
                  (cc0 & 0x1) << 11 | simm11 & 0x7FF);                         \
  }                                                                            \
  void Format_4_2(Register rd, int32_t op3, int32_t cc2, int32_t cond,         \
                  int32_t cc1, int32_t cc0, Register rs2) {                    \
    Format_3A(2, rd, op3,                                                      \
              (cc2 & 0x1) << 18 | (cond & 0xF) << 14 | (cc1 & 0x1) << 12 |     \
                  (cc0 & 0x1) << 11 | _reg_(rs2));                             \
  }                                                                            \
  void Format_4_2I(Register rd, int32_t op3, int32_t cc2, int32_t cond,        \
                   int32_t cc1, int32_t cc0, int32_t simm11) {                 \
    Format_3A(2, rd, op3,                                                      \
              (cc2 & 0x1) << 18 | (cond & 0xF) << 14 | 1 << 13 |               \
                  (cc1 & 0x1) << 12 | (cc0 & 0x1) << 11 | (simm11 & 0x7FF));   \
  }                                                                            \
  void Format_4_3(Register rd, int32_t op3, Register rs1, int32_t cc1,         \
                  int32_t cc0, int32_t swap_trap) {                            \
    Format_3A(2, rd, op3,                                                      \
              _reg_(rs1) << 14 | 1 << 13 | (cc1 & 0x1) << 12 |                 \
                  (cc0 & 0x1) << 11 | swap_trap & 0x7F);                       \
  }                                                                            \
  void Format_4_4(Register rd, int32_t op3, Register rs1, int32_t rcond,       \
                  int32_t opf_low, Register rs2) {                             \
    Format_3A(2, rd, op3,                                                      \
              _reg_(rs1) << 14 | (rcond & 0x7) << 10 | (opf_low & 0x1F) << 5 | \
                  _reg_(rs2));                                                 \
  }                                                                            \
  void Format_4_5(Register rd, int32_t op3, int32_t cond, int32_t opf_cc,      \
                  int32_t opf_low, Register rs2) {                             \
    Format_3A(2, rd, op3,                                                      \
              (cond & 0xF) << 14 | (opf_cc & 0x7) << 11 |                      \
                  (opf_low & 0x3F) << 5 | _reg_(rs2));                         \
  }                                                                            \
  void IntegerOperation(Register rs1, Register rs2, Register rd, int32_t op3,  \
                        const char *opcode);                                   \
  void IntegerOperationI(Register rs1, int32_t simm13, Register rd,            \
                         int32_t op3, const char *opcode);                     \
  void FloatOperation(Register rs1, Register rs2, Register rd, int32_t op3,    \
                      const char *opcode);                                     \
  ...
  void LoadOperation(Register rs1, Register rs2, Register rd, int32_t op3,     \
                     const char *opcode);                                      \
  void LoadOperationI(Register rs1, int32_t simm13, Register rd, int32_t op3,  \
                      const char *opcode);                                     \
  void MOVcc(Register rs, int32_t cc2, int32_t cc1, int32_t cc0, Register rd,  \
             int32_t cond, const char *opcode);                                \
  void MOVccI(int32_t simm11, int32_t cc2, int32_t cc1, int32_t cc0,           \
              Register rd, int32_t cond, const char *opcode);                  \
  void FMOVDcc(Register rs, int32_t opt_cc, Register rd, int32_t cond,         \
               const char *opcode);                                            \
  void ShiftOperation(Register rs1, Register rs2, Register rd, int32_t op3,    \
                      const char *opcode);                                     \
  void ShiftOperationI(Register rs1, int32_t shcnt32, Register rd,             \
                       int32_t op3, const char *opcode);                       \
  void Store(Register rd, Register rs1, Register rs2, int32_t op3,             \
             const char *opcode);                                              \
  void StoreI(Register rd, int32_t simm13, Register rs1, int32_t op3,          \
              const char *opcode);                                             \
