...
#define DEFINESLOT(ns, structname, slotstructname, fieldname, fieldtype,       \
                   slotNum)                                                    \
  {                                                                            \
#fieldname, fieldtype, 'F',                                                \
        offsetof(ns::structname, m_slots_##structname) +                       \
            offsetof(avmplus::NativeID::slotstructname, m_##fieldname),        \
        slotNum                                                                \
  }
#define DEFINENATIVE(nativeid, unmangled, mangled, typestr)                    \
  { #unmangled, mangled " " typestr, 'N', nativeid, 0 }
#define FIELD_DATA_BEGIN                                                       \
  { "<<<< Field Data Begin >>>>", "", 0, 0, 0 }
#define FIELD_DATA_END                                                         \
  { "<<<< Field Data End >>>>", "", 0, 0, 0 }

#ifndef VMCFG_HALFMOON
// AOT runtimes don't geneally have halfmoon defined, but the layouts structure
// needs to see the private fields.
namespace halfmoon {
class JitFriend {
  void aotFieldLayout();
};
...
typedef avmplus::ExactStructContainer<avmplus::AbcEnv::FinddefEntry>
    FinddefTableType;

// This is sorta cheaty: the GCList<MethodInfo> expands the member m_list as a
// pointer to TracedListData<GCObject*>, but we'll flatten that out to bypass
// the private fields and template craziness. But beware! if the implementation
// changes, this will need to be revisited

// njindal: Presence of vtable in GCList/RCList doesnt't map TracedListData
// directly to GCList. creating a stubbed implementation of GCList/RCList to
// make offsetof work as m_list is private and offset of cannot access private
// members.
...
AOTLayoutData
    *saveLayoutData; // give the function something to do (thwart optimizer)

//
// The function is a member of JitFriend to have access to structure member
// layouts.
//
void halfmoon::JitFriend::aotFieldLayout() {
  static AOTLayoutData field_data[] = {
    ...
    DEFINESTRUCT(MMgc::GC), DEFINESTRUCT(avmplus::String),
    DEFINESTRUCT(avmplus::Traits),
    DEFINEFIELD(avmplus::Traits, itraits, "*'avmplus::Traits'"),

    DEFINESTRUCT(AOTInfo), DEFINEFIELD(AOTInfo, origABCSHA1, "[20]c"),
    DEFINEFIELD(AOTInfo, abcBytes, "*c"), DEFINEFIELD(AOTInfo, nABCBytes, "i"),
    ...
    DEFINESTRUCT(AOTExceptionDesc), DEFINEFIELD(AOTExceptionDesc, from, "i"),
    ...
    DEFINEFIELD(avmplus::TracedListData<avmplus::MethodInfo *>, entries,
                "*'avmplus::MethodInfo'"),

    DEFINESTRUCT(ListAccess<avmplus::MethodInfo *>),
    DEFINEFIELD2(ListAccess<avmplus::MethodInfo *>, m_list, "m_list",
                 "*'avmplus::TracedListData<avmplus::MethodInfo*>'"),

    DEFINESTRUCT(avmplus::TracedListData<avmplus::Namespace *>),
    DEFINEFIELD(avmplus::TracedListData<avmplus::Namespace *>, entries,
                "*'avmplus::Namespace'"),

    DEFINESTRUCT(ListAccess<avmplus::Namespace *>),
    DEFINEFIELD2(ListAccess<avmplus::Namespace *>, m_list, "m_list",
                 "*'avmplus::TracedListData<avmplus::Namespace*>'"),

    DEFINESTRUCT(avmplus::TracedListData<avmplus::Traits *>),
    DEFINEFIELD(avmplus::TracedListData<avmplus::Traits *>, entries,
                "*'avmplus::Traits'"),

    DEFINESTRUCT(ListAccess<avmplus::Traits *>),
    DEFINEFIELD2(ListAccess<avmplus::Traits *>, m_list, "m_list",
                 "*'avmplus::TracedListData<avmplus::Traits*>'"),
    ...
    DEFINEFIELD2(avmplus::PoolObject, _classes, "classes",
                 "'ListAccess<avmplus::Traits*>'"),
    DEFINEFIELD2(avmplus::PoolObject, _scripts, "scripts",
                 "'ListAccess<avmplus::Traits*>'"),
    DEFINEFIELD2(avmplus::PoolObject, cpool_ns, "namespaces",
                 "'ListAccess<avmplus::Namespace*>'"),
    DEFINEFIELD2(avmplus::PoolObject, _methods, "methods",
                 "'ListAccess<avmplus::MethodInfo*>'"),
    ...
    DEFINEFIELD(avmplus::AvmCore, currentMethodFrame,
                "*'avmplus::MethodFrame'"),
    ...
    DEFINEFIELD(avmplus::ExceptionFrame, jmpbuf,
                "i"), // not really this type, but &jmpbuf is OK.
    ...
    DEFINEFIELD2(avmplus::MethodInfo, _native, "native",
                 "'avmplus::MethodInfo::NativeInfo'"),
    ...
    DEFINEFIELD2(avmplus::MethodFrame, envOrCodeContext, "env",
                 "*'avmplus::MethodEnv'"),
