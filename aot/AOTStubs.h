...
template <bool isSuperSub> struct convert_helper<isSuperSub, void, void> {
  static inline void convert(void) { AvmAssert(false); }
};
...
template <bool isSuperSub> struct convert_helper<isSuperSub, Atom, LLVMAtom> {
  static inline Atom convert(LLVMAtom a) { return (Atom)a; }
};
...
public:
  ...
  enum { exists2Way = exists && conversion<t_From, t_To>::exists };
  enum { eq = false };
...
template <class T> struct conversion<T, T> {
  enum { exists = true, exists2Way = true, eq = true };
  static inline T convert(T t) { return t; }
};

template <class T> struct conversion<T, void> {
  enum { exists = false, exists2Way = false, eq = false };
...
template <typename t1> struct is_integer {
  enum { yes = (conversion<t1, int32_t>::eq || conversion<t1, uint32_t>::eq) };
};

template <typename t1, typename t2> struct both_integer {
  enum { yes = (is_integer<t1>::yes && is_integer<t2>::yes) };
};

template <typename t1> struct is_numeric {
  enum { yes = (is_integer<t1>::yes || conversion<t1, double>::eq) };
};

template <typename t1, typename t2> struct both_numeric {
  enum { yes = (is_numeric<t1>::yes && is_numeric<t2>::yes) };
};

template <typename t1, typename t2> struct both_boolean {
  enum { yes = (conversion<t1, LLVMBool>::eq && conversion<t2, LLVMBool>::eq) };
};
...
private:
  ...
  template <class U> struct un_volatile {
    typedef U result;
    enum { isVolatile = false };
  };
  template <class U> struct un_volatile<volatile U> {
    typedef U result;
  ...
  struct bad_type;
  template <class U> struct ptr_traits {
    enum { result = false };
    typedef bad_type pointee;
  };
  template <class U> struct ptr_traits<U *> {
    enum { result = true };
    typedef U pointee;
  };
  template <class U> struct ptr_traits<U *&> {
...
private:
  ...
  template <class T> struct make_ptr_const_volatile<T *> {
    typedef const volatile T *result;
  };

  template <class B, class D> struct helper {
    enum { result = false };
  };
...
template <>
extern LLVMAtom abcOP_box<LLVMAtom, LLVMBool>(MethodEnv *, LLVMBool b);
template <>
...
template <>
extern LLVMAtom abcOP_box<LLVMAtom, int32_t>(MethodEnv *env, int32_t i);
template <>
extern LLVMAtom abcOP_box<LLVMAtom, uint32_t>(MethodEnv *env, uint32_t i);
template <>
extern LLVMAtom abcOP_box<LLVMAtom, double>(MethodEnv *env, double d);
template <>
...
template <>
extern ScriptObject *abcOP_unbox<ScriptObject *, Atom>(MethodEnv *, Atom a);
template <>
extern ArrayObject *abcOP_unbox<ArrayObject *, Atom>(MethodEnv *, Atom a);
template <>
...
template <>
extern String *abcOP_unbox<String *, LLVMAtom>(MethodEnv *, LLVMAtom a);
...
template <>
extern Namespace *abcOP_unbox<Namespace *, Atom>(MethodEnv *, Atom a);
template <> extern uint32_t abcOP_unbox<uint32_t, Atom>(MethodEnv *, Atom a);
template <>
extern QNameObject *abcOP_unbox<QNameObject *, Atom>(MethodEnv *, Atom a);
...
abcOP_unbox<DoubleVectorObject *, LLVMAtom>(MethodEnv *, LLVMAtom a);
template <>
...
abcOP_unbox<ObjectVectorObject *, LLVMAtom>(MethodEnv *, LLVMAtom a);
template <>
extern int32_t abcOP_unbox<int32_t, LLVMAtom>(MethodEnv *, LLVMAtom a);
template <>
extern LLVMAtom abcOP_unbox<LLVMAtom, LLVMAtom>(MethodEnv *, LLVMAtom a);
template <>
extern LLVMBool abcOP_unbox<LLVMBool, LLVMAtom>(MethodEnv *, LLVMAtom a);
template <>
extern Namespace *abcOP_unbox<Namespace *, LLVMAtom>(MethodEnv *, LLVMAtom a);
template <>
extern uint32_t abcOP_unbox<uint32_t, LLVMAtom>(MethodEnv *, LLVMAtom a);
template <>
extern QNameObject *abcOP_unbox<QNameObject *, LLVMAtom>(MethodEnv *,
                                                         LLVMAtom a);
template <>
extern double abcOP_unbox<double, LLVMAtom>(MethodEnv *, LLVMAtom a);
...
template <> inline bool isNullOrUndefined(MethodEnv *, LLVMBool) {
  return false;
}
template <> inline bool isNullOrUndefined(MethodEnv *, ScriptObject *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, ArrayObject *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, DoubleVectorObject *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, IntVectorObject *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, UIntVectorObject *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, ObjectVectorObject *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, String *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, Namespace *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, QNameObject *v) {
  return v == NULL;
}
template <> inline bool isNullOrUndefined(MethodEnv *, int32_t) {
  return false;
}
template <> inline bool isNullOrUndefined(MethodEnv *, uint32_t) {
  return false;
}
template <> inline bool isNullOrUndefined(MethodEnv *, double) { return false; }
template <> inline bool isNullOrUndefined(MethodEnv *, LLVMAtom v) {
  return AvmCore::isNullOrUndefined((Atom)v);
}
...
void throwNullOrUndefined(MethodEnv *, Atom atom)
...
template <>
inline void nullcheck(MethodEnv *env, LLVMAtom v) // only Atoms can be undefined
{
  if (isNullOrUndefined(env, v))
    throwNullOrUndefined(env, (Atom)v);
}

template <> inline void nullcheck(MethodEnv *env, AbcEnv *abcenv) {
  if (abcenv == NULL) {
...
template <typename rt> rt abcOP_null(MethodEnv *env, Traits *traits) {
  // null script object
...
template <typename rt, typename t1> rt abcOP_coerce_s(MethodEnv *env, t1 val) {
  AvmCore *core = env->core();
  return abcOP_unbox<rt>(
      env, isNullOrUndefined(env, val)
               ? nullStringAtom
               : core->string((Atom)abcOP_box<LLVMAtom, t1>(env, val))->atom());
}
...
rt abcOP_coerce(MethodEnv *env, Traits **traitsID, t1 val) {
  ...
  if (!traits) {
    ...
    env->toplevel()->throwTypeError(kCheckTypeFailedError,
                                    env->core()->atomToErrorString(atom));
    // unreachable
  }
...
template <typename rt, typename t1> rt abcOP_coerce_a(MethodEnv *env, t1 val) {
...
template <typename rt, typename t1> rt abcOP_coerce_o(MethodEnv *env, t1 val) {
  Atom a = (Atom)abcOP_box<LLVMAtom, t1>(env, val);
  return abcOP_unbox<rt>(env,
...
template <typename rt, typename t1> rt abcOP_convert_ns(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
                       env->internRtns((Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
...
const Multiname *abcOP_setup_multiname(MethodEnv *env, Multiname &multiname,
                                       tNameIndex multinameIndex, t1 name,
                                       t2 ns) {
          ...
          eq) // LLVMEmitter provided us with a live multiname!
  {
    ...
    if (conversion<LLVMUnusedParam, t1>::eq &&
        conversion<LLVMUnusedParam, t2>::eq)
      return multinamep; // not runtime? just return it
    else
      multiname = *multinamep; // runtime? copy it
  } else {
    aotGetPool(env)->parseMultiname(
        multiname, (int)multinameIndex); // TODO should be using conversion<>
  }
  ...
  if (super_sub_class_ptr<QNameObject *, t1>::result) {
    ...
    return &multiname;
             ...
             (conversion<ScriptObject *, t1>::convert(name)->traits() ==
  ...
  if (conversion<String *, t1>::eq)
    multiname.setName(
        env->core()->internString(conversion<String *, t1>::convert(name)));
  else if (!conversion<LLVMUnusedParam, t1>::eq)
    multiname.setName(env->core()->intern(
        (Atom)abcOP_coerce_a<LLVMAtom>(env, name))); // TODO OPT ensure interned
  if (conversion<Namespace *, t2>::eq) {
    if (!ns)
      env->toplevel()->throwTypeError(kIllegalNamespaceError);
    multiname.setNamespace(
        env->core()->internNamespace(conversion<Namespace *, t2>::convert(ns)));
...
template <typename rt, typename t1> rt abcOP_upcast(MethodEnv *env, t1 val) {
  if (conversion<rt, t1>::eq)
    return conversion<rt, t1>::convert(val);
  return abcOP_unbox<rt>(env, abcOP_box<LLVMAtom, t1>(env, val));
}
...
template <typename rt, typename t1> rt abcOP_convert_i(MethodEnv *env, t1 a) {
  if (is_numeric<rt>::yes) {
    if (is_numeric<t1>::yes)
      return conversion<rt, int32_t>::convert(
  ...
  return abcOP_unbox<rt>(
      env, env->core()->intAtom((Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
...
template <typename rt, typename t1>
inline rt abcOP_convert_u(MethodEnv *env, t1 a) {
  if (is_numeric<rt>::yes) {
    if (is_numeric<t1>::yes)
      return conversion<rt, uint32_t>::convert(
  ...
  return abcOP_unbox<rt>(
      env, env->core()->uintAtom((Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
...
template <typename rt, typename t1> rt abcOP_convert_d(MethodEnv *env, t1 a) {
  if (is_numeric<rt>::yes) {
    if (is_numeric<t1>::yes)
      return conversion<rt, double>::convert(
  ...
  return abcOP_unbox<rt>(
      env, env->core()->numberAtom((Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
...
template <typename rt, typename t1> rt abcOP_convert_b(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env, (LLVMBool)env->core()->boolean(
...
template <typename rt, typename t1> rt abcOP_convert_s(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(
      env, env->core()->string((Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
...
template <typename rt, typename t1> rt abcOP_convert_o(MethodEnv *env, t1 a) {
  nullcheck(env, a);
...
template <typename rt> rt abcOP_getglobalscope(MethodEnv *env) {
...
template <typename rt> rt abcOP_newactivation(MethodEnv *env) {
...
rt abcOP_newfunction(MethodEnv *env, Traits **idForDeclaringTraits,
                     Traits ***scopeTraitIds, uint32_t nScopeTraits,
                     uint32_t nStateWithTraits, LLVMAtom *scopes_masked,
    ...
    *idForDeclaringTraits = declTraits;
    ...
    if (atraits) {
      ...
      if (handler != NULL) {
        ...
        atraits->init = MethodInfo::create(
...
rt abcOP_newclass(MethodEnv *env, Traits **idForCTraits, Traits **idForITraits,
                  Traits ***scopeTraitIds, uint32_t nScopeTraits,
                  uint32_t nStateWithTraits, LLVMAtom *scopes_masked,
                  ScriptObject *basetype, uint32_t classindex) {
  Atom *scopes = (Atom *)scopes_masked;
  ...
  if (!(*idForCTraits)) {
    ...
    itraits->m_interfaceBindingFunction =
    ...
    const ScopeTypeChain *iscope = ScopeTypeChain::create(
        aotGetGC(env), itraits, cscope, NULL, ctraits, itraits);
    Toplevel *toplevel = env->toplevel();
  ...
  ScriptObject *o =
      basetype ? (ScriptObject *)(~7 & env->toplevel()->coerce(
               ...
               : NULL;
  return abcOP_box<rt>(env,
                       (ScriptObject *)env->newclass(ctraits, (ClassClosure *)o,
                                                     env->scope(), scopes));
}
...
rt abcOP_findproperty(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                      LLVMAtom *scopes, int32_t scopeDepth, int32_t withDepth) {
  Multiname multiname;
  return abcOP_unbox<rt>(
      env, env->findproperty(
               env->scope(), (Atom *)scopes, scopeDepth,
...
template <typename rt, typename tNameIndex, typename t1, typename t2>
rt abcOP_findpropstrict(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                        LLVMAtom *scopes, int32_t scopeDepth,
                        int32_t withDepth) {
  Multiname multiname;
  return abcOP_unbox<rt>(
      env, env->findproperty(
...
rt abcOP_finddef(MethodEnv *env, tNameIndex multinameIndex) {
  Multiname multiname;
  return abcOP_box<rt>(
      env, env->finddef(abcOP_setup_multiname(env, multiname, multinameIndex,
...
template <typename t1, typename t2> bool isDictionaryLookup(t1 key, t2 obj) {
  if ((super_sub_class_ptr<ScriptObject *, t1>::result) ||
...
// getproperty
template <typename rt> rt convertForGetProperty(MethodEnv *env, Atom a) {
...
rt abcOP_get_set_del_has_property_impl(MethodEnv *env,
                                       const Multiname &multiname, t1 obj,
                                       t2 val) {
  Toplevel *toplevel = env->toplevel();
  Atom objAtom = (Atom)abcOP_box<LLVMAtom, t1>(env, obj);
  VTable *vtable = abcOP_toVTable<nc, t1>(env, obj);
  if (select == LLVMSelectGet) {
    return convertForGetProperty<rt>(
        env, toplevel->getproperty(objAtom, &multiname, vtable));
  } else if (select == LLVMSelectSet) {
    toplevel->setproperty(objAtom, &multiname,
                          (Atom)abcOP_box<LLVMAtom, t2>(env, val), vtable);
...
template <typename t> struct is_known_derived_object_type {
  enum {
...
template <typename objt> bool isDoubleVector(objt obj) {
...
template <typename objt> bool isIntVector(objt obj) {
...
template <typename objt> bool isUIntVector(objt obj) {
...
rt abcOP_get_set_del_has_property(MethodEnv *env DOUBLE_ALLOCA_DEF,
                                  tNameIndex multinameIndex, t1 n, t2 ns,
                                  t3 obj, t4 val) {
  if (conversion<LLVMUnusedParam, t1>::eq &&
      conversion<LLVMUnusedParam, t2>::eq) {
    Multiname multiname;
    ...
    return abcOP_get_set_del_has_property_impl<nc, select, rt, t3, t4>(
  ...
  if (conversion<LLVMUnusedParam, t2>::eq &&
    ...
    if ((conversion<uint32_t, t1>::eq &&
         ((int32_t)conversion<uint32_t, t1>::convert(n)) >= 0) ||
      ...
      if (super_sub_class_ptr<ScriptObject *, t3>::result ||
        ...
        if (nc && super_sub_class_ptr<ScriptObject *, t3>::result &&
...
#else
              return abcOP_unbox<rt>(
                  env, (Atom)abcOP_box<LLVMAtom, double>(env, dres));
#endif
            }
...
#else
              return abcOP_unbox<rt>(
                  env, (Atom)abcOP_box<LLVMAtom, int32_t>(env, res));
#endif
            }
            if (conversion<double, rt>::eq)
...
#else
              return abcOP_unbox<rt>(
                  env, (Atom)abcOP_box<LLVMAtom, uint32_t>(env, ures));
#endif
            }
            if (conversion<double, rt>::eq)
        ...
        if (conversion<ArrayObject *, t3>::eq) {
          ...
          if (select == LLVMSelectGet) {
            ...
            a->_setIntProperty(intIndex,
                               (Atom)abcOP_box<LLVMAtom, t4>(env, val));
            return conversion<rt, LLVMUnusedParam>::convert(g_unusedParam);
          }
        }
        ...
        if (intIndex >= 0) {
          ...
          if (select == LLVMSelectGet) {
            ...
            so->setUintProperty(uintIndex,
                                (Atom)abcOP_box<LLVMAtom, t4>(env, val));
            return conversion<rt, LLVMUnusedParam>::convert(g_unusedParam);
          } else {
            AvmAssert(select == LLVMSelectDel);
            return abcOP_unbox<rt, LLVMAtom>(
      ...
      if ((conversion<LLVMAtom, t1>::eq) ||
        ...
        if (AvmCore::isXMLList(nAtom))
          env->toplevel()->throwTypeError(
              kDeleteTypeError,
              env->core()->toErrorString(env->toplevel()->toTraits(nAtom)));
      }
    }
    return abcOP_get_set_del_has_property_impl<nc, select, rt, t3, t4>(
  ...
  if (select == LLVMSelectGet) {
    return convertForGetProperty<rt>(
        env, env->getpropertyHelper(objAtom, &multiname, objVTable, nameAtom));
  } else if (select == LLVMSelectSet) {
    env->setpropertyHelper(objAtom, &multiname,
                           (Atom)abcOP_box<LLVMAtom, t4>(env, val), objVTable,
                           nameAtom);
    return conversion<rt, LLVMUnusedParam>::convert(g_unusedParam);
  } else {
    AvmAssert(select == LLVMSelectDel);
    return abcOP_unbox<rt>(
        env, env->delpropertyHelper(objAtom, &multiname, nameAtom));
  }
}
...
rt abcOP_getproperty(MethodEnv *env DOUBLE_ALLOCA_DEF,
                     tNameIndex multinameIndex, t1 n, t2 ns, t3 obj) {
  return abcOP_get_set_del_has_property<true, LLVMSelectGet, rt, tNameIndex, t1,
...
rt abcOP_getproperty_nonc(MethodEnv *env DOUBLE_ALLOCA_DEF,
                          tNameIndex multinameIndex, t1 n, t2 ns, t3 obj) {
  return abcOP_get_set_del_has_property<false, LLVMSelectGet, rt, tNameIndex,
...
template <typename tNameIndex, typename t1, typename t2, typename t3,
          typename t4>
void abcOP_setproperty(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                       t3 obj, t4 val) {
...
template <typename tNameIndex, typename t1, typename t2, typename t3,
          typename t4>
void abcOP_setproperty_nonc(MethodEnv *env, tNameIndex multinameIndex, t1 n,
                            t2 ns, t3 obj, t4 val) {
...
template <typename tNameIndex, typename t1, typename t2, typename t3>
LLVMBool abcOP_deleteproperty(MethodEnv *env, tNameIndex multinameIndex, t1 n,
                              t2 ns, t3 obj) {
  return abcOP_get_set_del_has_property<
...
template <typename rt, typename tNameIndex, typename t1, typename t2,
          typename t3>
rt abcOP_getsuper(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                  t3 obj) {
  Multiname multiname;
  return abcOP_unbox<rt>(
      env, env->getsuper(
               (Atom)abcOP_box<LLVMAtom>(env, obj),
               abcOP_setup_multiname(env, multiname, multinameIndex, n, ns)));
}
...
template <typename tNameIndex, typename t1, typename t2, typename t3,
          typename t4>
void abcOP_setsuper(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                    t3 obj, t4 val) {
  Multiname multiname;
  env->setsuper((Atom)abcOP_box<LLVMAtom>(env, obj),
                abcOP_setup_multiname(env, multiname, multinameIndex, n, ns),
                (Atom)abcOP_box<LLVMAtom>(env, val));
}
...
template <typename tNameIndex, typename t1, typename t2, typename t3,
          typename t4>
void abcOP_initproperty(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                        t3 obj, t4 val) {
  Multiname multiname;
  Atom objAtom = (Atom)abcOP_box<LLVMAtom, t3>(env, obj);
  ...
  env->initproperty(
      ...
      (Atom)abcOP_box<LLVMAtom, t4>(env, val), vtable);
}
...
rt callMethodEnvVA(MethodEnv *method, adt argDesc, va_list ap) {
  ...
  if (info->isAotCompiled()) // fastest! going straight to compiled method
  {
    ...
    if (conversion<rt, double>::eq)
      ...
      return conversion<rt, int32_t>::convert(
          (int32_t)coerce32CdeclArgDescEnter(INT_TYPE, argDesc, method, ap));
    else if (conversion<rt, uint32_t>::eq)
      return conversion<rt, uint32_t>::convert(
          (uint32_t)coerce32CdeclArgDescEnter(UINT_TYPE, argDesc, method, ap));
    else if (conversion<rt, LLVMBool>::eq)
      return conversion<rt, LLVMBool>::convert(
          (LLVMBool)coerce32CdeclArgDescEnter(BOOLEAN_TYPE, argDesc, method,
                                              ap));
    else if (conversion<rt, Stringp>::eq)
      return conversion<rt, Stringp>::convert(
          (Stringp)coerce32CdeclArgDescEnter(STRING_TYPE, argDesc, method, ap));
    else if (conversion<rt, ArrayObject *>::eq)
      return conversion<rt, ArrayObject *>::convert(
          (ArrayObject *)coerce32CdeclArgDescEnter(ARRAY_TYPE, argDesc, method,
                                                   ap));
    else if (type_void<rt>::eq)
      return coerce32CdeclArgDescEnter(VOID_TYPE, argDesc, method, ap),
             type_void<rt>::assert_void();
    else if (conversion<rt, LLVMAtom>::eq)
      return conversion<rt, LLVMAtom>::convert(
          (LLVMAtom)coerce32CdeclArgDescEnter(NULL, argDesc, method, ap));
    else if (conversion<rt, QNameObject *>::eq)
      return conversion<rt, QNameObject *>::convert(
          (QNameObject *)coerce32CdeclArgDescEnter(core->traits.qName_itraits,
                                                   argDesc, method, ap));
    else {
  ...
  if (!ms->argcOk(argc)) {
    ...
    core->console << "Function: " << info->getMethodName() << " requires "
                  ...
                  << "\n";
#endif
    method->toplevel()->argumentErrorClass()->throwError(
        kWrongArgumentCountError, core->toErrorString(info),
  ...
  if (type_known_to_be_compatible<rt>(
          method, returnTraits)) // second fastest -- use argc / ap calling
                                 // convention without boxing return value
  {
    ...
    if (conversion<rt, double>::eq)
      return conversion<rt, double>::convert(
          method->implFPR()(method, argc, args));
    if (conversion<rt, int32_t>::eq)
      return conversion<rt, int32_t>::convert(
          (int32_t)method->implGPR()(method, argc, args));
    if (conversion<rt, uint32_t>::eq)
      return conversion<rt, uint32_t>::convert(
          (uint32_t)method->implGPR()(method, argc, args));
    if (conversion<rt, LLVMBool>::eq)
      return conversion<rt, LLVMBool>::convert(
          (LLVMBool)method->implGPR()(method, argc, args));
    if (conversion<rt, Stringp>::eq)
      return conversion<rt, Stringp>::convert(
          (Stringp)method->implGPR()(method, argc, args));
    if (conversion<rt, ArrayObject *>::eq)
      return conversion<rt, ArrayObject *>::convert(
          (ArrayObject *)method->implGPR()(method, argc, args));
    else if (type_void<rt>::eq)
      return method->implGPR()(method, argc, args),
             type_void<rt>::assert_void();
    if (conversion<rt, LLVMAtom>::eq)
      return conversion<rt, LLVMAtom>::convert(
          (LLVMAtom)method->implGPR()(method, argc, args));
    else
      return conversion<rt, ScriptObject *>::convert(
          (ScriptObject *)method->implGPR()(method, argc, args));
         ...
         // unboxed) return value
  {
    ...
    if (returnTraits == NUMBER_TYPE)
      return abcOP_unbox<rt>(
          method, core->doubleToAtom(method->implFPR()(method, argc, args)));
    else if (returnTraits == INT_TYPE)
      return abcOP_unbox<rt>(method, core->intToAtom((int32_t)method->implGPR()(
                                         method, argc, args)));
    else if (returnTraits == UINT_TYPE)
      return abcOP_unbox<rt>(
          method,
          core->uintToAtom((uint32_t)method->implGPR()(method, argc, args)));
    else if (returnTraits == BOOLEAN_TYPE)
      return abcOP_unbox<rt>(
          method, method->implGPR()(method, argc, args) ? trueAtom : falseAtom);
    else if (returnTraits == STRING_TYPE)
      return abcOP_unbox<rt>(
          method, ((Stringp)method->implGPR()(method, argc, args))->atom());
    else if (returnTraits == VOID_TYPE)
      return method->implGPR()(method, argc, args),
             abcOP_unbox<rt>(method, undefinedAtom);
    else if (Traits::isSSTAtom(returnTraits))
      return abcOP_unbox<rt>(method,
                             (Atom)method->implGPR()(method, argc, args));
    else {
      AvmAssert(returnTraits->isSSTObject());
      return abcOP_unbox<rt>(
          method,
          ((ScriptObject *)method->implGPR()(method, argc, args))->atom());
    }
  }
}
...
rt abcOP_callproperty_impl(MethodEnv *env, const Multiname &multiname,
                           objt objp, adt argDesc, va_list ap) {
  Toplevel *toplevel = env->toplevel();
  ...
  AvmAssert(argc > 0);
  return abcOP_unbox<rt>(
      env, toplevel->callproperty(rcv, &multiname, argc - 1, atomv, vtable));
}

template <typename rt, typename tNameIndex, typename t1, typename t2,
          typename objt, typename adt>
rt abcOP_callproperty(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                      objt objp, adt argDesc, ...) {
  Multiname multiname;

  va_list ap;
  va_start(ap, argDesc); // FIXME va_end
  return abcOP_callproperty_impl<rt, objt, adt>(
...
rt abcOP_call(MethodEnv *env, t1 method, adt argDesc, ...) {
  ...
  AvmAssert(argc > 0);
  return abcOP_unbox<rt>(
      env, avmplus::op_call(env, (Atom)abcOP_box<LLVMAtom, t1>(env, method),
                            argc - 1, atomv));
}
...
template <typename objt>
MethodEnv *abcOP_methodEnvFromDispId(MethodEnv *env, objt objp,
                                     int32_t methodindex) {
  VTable *vtable = abcOP_toVTable<true, objt>(env, objp);
...
abcOP_methodEnvFromBaseDispId(MethodEnv *env, objt,
                              int32_t methodindex) // TODO remove objt
{
...
template <typename rt, typename adt>
rt abcOP_callstatic(MethodEnv *, AbcEnv *abcenv, int32_t methodindex,
                    adt argDesc, ...) {
  va_list ap;
  va_start(ap, argDesc); // FIXME va_end
...
template <typename rt, typename tNameIndex, typename t1, typename t2,
          typename adt>
rt abcOP_callsuper(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                   adt argDesc, ...) {
  Multiname multiname;
...
rt abcOP_construct(MethodEnv *env, t1 obj, adt argDesc, ...) {
  ...
  return abcOP_unbox<rt>(env,
                         toplevel->op_construct(factoryAtom, nArgs - 1, atomV));
}
...
template <typename rt, typename tNameIndex, typename t1, typename t2,
          typename adt>
rt abcOP_constructprop(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                       adt argDesc, ...) {
  Multiname multiname;
  ...
  argDescArgsToAtomv(atomV, argDesc, env, ap);
  return abcOP_unbox<rt>(
      env, env->toplevel()->constructprop(
               abcOP_setup_multiname(env, multiname, multinameIndex, n, ns),
               nArgs - 1, atomV, env->toplevel()->toVTable(atomV[0])));
}
...
template <typename rt, typename tNameIndex, typename t1, typename t2,
          typename t3>
rt abcOP_getdescendants(MethodEnv *env, tNameIndex multinameIndex, t1 n, t2 ns,
                        t3 obj) {
  Multiname multiname;

  return abcOP_unbox<rt>(
      env, env->getdescendants(
               (Atom)abcOP_box<LLVMAtom, t3>(env, obj),
               abcOP_setup_multiname(env, multiname, multinameIndex, n, ns)));
}
...
rt abcOP_applytype(MethodEnv *env, t1 factory, adt argDesc, ...) {
  ...
  if ((nArgs == 1) &&
      (env->toplevel()
           ->toTraits(atomResult)
           ->containsInterface(env->core()->traits.class_itraits)) &&
      (env->toplevel()
           ->toTraits(factoryAtom)
           ->containsInterface(env->core()->traits.vector_ctraits))) {
    uint32_t i = 0;
    if (ISNULL(atomV[0])) {
...
rt abcOP_hasnext(MethodEnv *env, t1 obj, t2 index) {
  return abcOP_box<rt, LLVMBool>(
      env, (LLVMBool)env->hasnext((Atom)abcOP_box<LLVMAtom, t1>(env, obj),
...
template <typename rt, typename t1, typename t2>
rt abcOP_hasnext2(avmplus::MethodEnv *env, t1 obj, t2 indexIn,
                  int32_t *indexOut, LLVMAtom *objectOut) {
  Atom objAtom = (Atom)abcOP_box<LLVMAtom, t1>(env, obj);
  int indexInt =
      env->core()->integer((Atom)abcOP_box<LLVMAtom, t2>(env, indexIn));
...
rt abcOP_nextname(MethodEnv *env, t1 obj, t2 index) {
  return abcOP_unbox<rt>(
      env, env->nextname((Atom)abcOP_box<LLVMAtom, t1>(env, obj),
                         abcOP_convert_i<int32_t, t2>(env, index)));
}
...
rt abcOP_nextvalue(MethodEnv *env, t1 obj, t2 index) {
  return abcOP_unbox<rt>(
      env, env->nextvalue((Atom)abcOP_box<LLVMAtom, t1>(env, obj),
                          abcOP_convert_i<int32_t, t2>(env, index)));
}
...
template <typename rt, typename t1> rt abcOP_not(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(
      env, (LLVMBool)(AvmCore::booleanAtom(
                          (Atom)abcOP_box<LLVMAtom, t1>(env, a)) == falseAtom));
}
...
rt abcOP_add_i(MethodEnv *env, t1 a, t2 b) {
  if (both_numeric<t1, t2>::yes && is_numeric<rt>::yes)
    return demote_numeric<rt>::convert(
        (int32_t)conversion_numeric<t1>::convert(a) +
        (int32_t)conversion_numeric<t2>::convert(b));
...
template <typename rt, typename t1> rt abcOP_increment(MethodEnv *env, t1 x) {
  if (is_numeric<t1>::yes)
    return abcOP_add<rt, t1, int32_t>(env, x, 1);
  return abcOP_add<rt, double, int32_t>(env,
                                        abcOP_convert_d<double, t1>(env, x), 1);
}
...
template <typename rt, typename t1> rt abcOP_decrement(MethodEnv *env, t1 x) {
...
template <typename rt, typename t1> rt abcOP_increment_i(MethodEnv *env, t1 x) {
...
template <typename rt, typename t1> rt abcOP_decrement_i(MethodEnv *env, t1 x) {
...
template <typename rt, typename t1> rt abcOP_bitnot(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env, ~abcOP_convert_i<int32_t, t1>(env, a));
}
...
rt abcOP_lshift(MethodEnv *env, t1 a, t2 b) {
  return abcOP_box<rt>(env,
                       abcOP_convert_i<int32_t, t1>(env, a)
                           << (abcOP_convert_u<uint32_t, t2>(env, b) & 0x1F));
}
...
rt abcOP_urshift(MethodEnv *env, t1 a, t2 b) {
  return abcOP_box<rt>(env, abcOP_convert_u<uint32_t, t1>(env, a) >>
                                (abcOP_convert_u<uint32_t, t2>(env, b) & 0x1F));
}
...
template <typename rt, typename t1> rt abcOP_negate(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env, -abcOP_convert_d<double, t1>(env, a));
}

template <>
extern int32_t abcOP_negate<int32_t, int32_t>(MethodEnv *, int32_t a);
...
template <typename rt, typename t1> rt abcOP_negate_i(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env, -abcOP_convert_i<int32_t, t1>(env, a));
}

template <>
extern int32_t abcOP_negate_i<int32_t, int32_t>(MethodEnv *, int32_t a);
template <>
extern int32_t abcOP_negate_i<int32_t, double>(MethodEnv *, double a);

//------------------------------------------------------------------------------
// OP_true
//------------------------------------------------------------------------------

template <typename rt, typename t1> rt abcOP_true(MethodEnv *env, t1 a) {
...
enum cmp_ops { cmp_lt, cmp_gt, cmp_lteq, cmp_gteq, cmp_eq, cmp_stricteq };
...
template <typename T> inline double toDouble(T v) { return double(v); }

template <> inline double toDouble(LLVMBool v) { return double(uint(v)); }
...
template <cmp_ops op, typename t> bool cmp_func(t a, t b) {
...
rt abcOP_compare_helper(MethodEnv *env, t1 a, t2 b) {
  ...
  if (both_numeric<t1, t2>::yes)
    return abcOP_unbox<rt>(env, cmp_func<op>(conversion_numeric<t1>::convert(a),
                                             conversion_numeric<t2>::convert(b))
                                    ? trueAtom
                                    : falseAtom);

  // Fast path for boolean equality tests
  if ((op == cmp_eq || op == cmp_stricteq) && conversion<LLVMBool, t1>::eq &&
      conversion<LLVMBool, t2>::eq)
    return abcOP_unbox<rt>(env, cmp_func<op, LLVMBool, LLVMBool>(
  ...
  if (conversion<String, t1>::eq && conversion<String, t2>::eq &&
      !isNullOrUndefined<t1>(env, a) && !isNullOrUndefined<t2>(env, b)) {
    ...
    case cmp_stricteq:
      return abcOP_unbox<rt>(env,
                             (sa == sb || *sa == *sb) ? trueAtom : falseAtom);
    }
  ...
  case cmp_gteq:
    return abcOP_unbox<rt>(
        env, env->core()->compare(a_boxed, b_boxed) == falseAtom ? trueAtom
                                                                 : falseAtom);
  case cmp_lteq:
    return abcOP_unbox<rt>(
        env, env->core()->compare(b_boxed, a_boxed) == falseAtom ? trueAtom
                                                                 : falseAtom);
  case cmp_eq:
...
rt abcOP_istype(MethodEnv *env, Traits **ppT, t1 a) {
  ...
  return abcOP_unbox<rt>(
      env, env->core()->istypeAtom((Atom)abcOP_box<LLVMAtom, t1>(env, a), t));
}
...
rt abcOP_astype(MethodEnv *env, tNameIndex multinameIndex, t1 a) {
  ...
  if (t == NULL)
    toplevel->throwVerifyError(kClassNotFoundError,
                               core->toErrorString(multinamep));
  ...
  return env->core()->istype((Atom)atom, t) ? abcOP_unbox<rt>(env, atom)
                                            : abcOP_null<rt>(env, t);
}
...
rt abcOP_istypelate(MethodEnv *env, t1 a, t2 b) {
  ...
  // TODO can "b" be null?
  return abcOP_unbox<rt>(
      env, env->core()->istypeAtom((Atom)abcOP_box<LLVMAtom, t1>(env, a),
                                   env->toplevel()->toClassITraits(atom)));
}
...
rt abcOP_astypelate(MethodEnv *env, t1 val, t2 classobj) {
  ...
  Traits *t = env->toplevel()->toClassITraits(
      (Atom)abcOP_box<LLVMAtom, t2>(env, classobj));
  Atom atom = (Atom)abcOP_box<LLVMAtom, t1>(env, val);
  return env->core()->istype(atom, t) ? abcOP_unbox<rt>(env, atom)
...
template <typename rt, typename t1> rt abcOP_typeof(MethodEnv *env, t1 a) {
  return abcOP_box<rt, String *>(
      env, env->core()->_typeof((Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
...
rt abcOP_instanceof(MethodEnv *env, t1 a, t2 b) {
  return abcOP_unbox<rt>(env, env->toplevel()->instanceof
                         ((Atom)abcOP_box<LLVMAtom, t1>(env, a),
                          (Atom)abcOP_box<LLVMAtom, t2>(env, b)));
}
...
rt abcOP_in(MethodEnv *env, t1 a, t2 b) {
  return abcOP_unbox<rt>(
      env, env->toplevel()->in_operator((Atom)abcOP_box<LLVMAtom, t1>(env, a),
                                        (Atom)abcOP_box<LLVMAtom, t2>(env, b)));
}
...
template <typename rt, typename t1> rt abcOP_checkfilter(MethodEnv *env, t1 a) {
...
template <typename rt, typename t1> rt abcOP_esc_xattr(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env, env->core()->EscapeAttributeValue(
                                (Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
...
template <typename rt, typename t1> rt abcOP_esc_xelem(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(
      env, env->core()->ToXMLString((Atom)abcOP_box<LLVMAtom, t1>(env, a)));
}
//------------------------------------------------------------------------------
// OP_loadnull
//------------------------------------------------------------------------------

template <typename rt> rt abcOP_loadnull(MethodEnv *env) {
...
template <typename rt> rt abcOP_loadundefined(MethodEnv *env) {
...
template <typename rt> rt abcOP_loadnan(MethodEnv *env) {
...
template <typename rt> rt abcOP_loadtrue(MethodEnv *env) {
...
template <typename rt> rt abcOP_loadfalse(MethodEnv *env) {
...
template <typename rt> rt abcOP_loadstring(MethodEnv *env, uint32_t index) {
...
template <typename rt> rt abcOP_loadnamespace(MethodEnv *env, uint32_t index) {
...
template <typename rt> rt abcOP_getouterscope(MethodEnv *env, uint32_t index) {
...
template <typename t1, typename t2>
REALLY_INLINE void abcOP_setslot_nonc(MethodEnv *env, char *slotAddr, t1 obj,
                                      t2 val) {
  abcOP_setslot_impl<t1, t2>(env, slotAddr, obj, val);
}

template <typename t1, typename t2>
REALLY_INLINE void abcOP_setslot(MethodEnv *env, char *slotAddr, t1 obj,
                                 t2 val) {
  nullcheck(env, obj);
  abcOP_setslot_impl<t1, t2>(env, slotAddr, obj, val);
}
...
template <typename t1> void abcOP_pushscope(MethodEnv *env, t1 val) {
  // meat is generated as LLVM operations... we're really a glorified null check
  nullcheck(env, val);
}

template <typename t1> void abcOP_pushwith(MethodEnv *env, t1 val) {
  // meat is generated as LLVM operations... we're really a glorified null check
  nullcheck(env, val);
}
...
template <typename rt, typename t1> rt abcOP_li8(MethodEnv *env, t1 a) {
...
template <typename rt, typename t1> rt abcOP_li16(MethodEnv *env, t1 a) {
  int32_t addr = abcOP_convert_i<int32_t, t1>(env, a);
  int32_t result = 0;
...
template <typename rt, typename t1> rt abcOP_li32(MethodEnv *env, t1 a) {
  int32_t addr = abcOP_convert_i<int32_t, t1>(env, a);
  int32_t result = 0;
...
template <typename rt, typename t1> rt abcOP_lf32(MethodEnv *env, t1 a) {
  int32_t addr = abcOP_convert_i<int32_t, t1>(env, a);
...
template <typename rt, typename t1> rt abcOP_lf64(MethodEnv *env, t1 a) {
  int32_t addr = abcOP_convert_i<int32_t, t1>(env, a);
#ifndef VMCFG_UNALIGNED_FP_ACCESS
...
template <typename t1, typename t2> void abcOP_si8(MethodEnv *env, t1 a, t2 b) {
...
template <typename rt, typename t1> rt abcOP_sxi1(MethodEnv *env, t1 a) {
  int32_t value = abcOP_convert_i<int32_t, t1>(env, a);
  if (is_numeric<rt>::yes)
    return conversion<rt, int32_t>::convert((value << (8 * sizeof(Atom) - 1)) >>
                                            (8 * sizeof(Atom) - 1));
  return abcOP_unbox<rt>(env, (LLVMAtom)(((value << (8 * sizeof(Atom) - 1)) >>
                                          ((8 * sizeof(Atom) - 1) - 3)) |
                                         kIntptrType));
}

template <typename rt, typename t1> rt abcOP_sxi8(MethodEnv *env, t1 a) {
  int32_t value = abcOP_convert_i<int32_t, t1>(env, a);
  if (is_numeric<rt>::yes)
    return conversion<rt, int32_t>::convert(
        (value << (8 * (sizeof(Atom) - 1))) >> (8 * (sizeof(Atom) - 1)));
  return abcOP_unbox<rt>(env, (LLVMAtom)(((value << (8 * (sizeof(Atom) - 1))) >>
                                          ((8 * (sizeof(Atom) - 1)) - 3)) |
                                         kIntptrType));
}

template <typename rt, typename t1> rt abcOP_sxi16(MethodEnv *env, t1 a) {
  int32_t value = abcOP_convert_i<int32_t, t1>(env, a);
  if (is_numeric<rt>::yes)
    return conversion<rt, int32_t>::convert(
        (value << (8 * (sizeof(Atom) - 2))) >> (8 * (sizeof(Atom) - 2)));
  return abcOP_unbox<rt>(env, (LLVMAtom)(((value << (8 * (sizeof(Atom) - 2))) >>
                                          ((8 * (sizeof(Atom) - 2)) - 3)) |
                                         kIntptrType));
}
...
template <typename t1> int32_t abcOP_findInterfaceBinding(int32_t iid, t1 rle) {
  while (true) {
...
template <typename t1> void abcOP_throw(MethodEnv *env, t1 a) {
#ifdef VMCFG_OPTIMISTIC_DOUBLE_ATOM
  env->core()->throwAtom(
...
template <typename rt> rt abcOP_xarg(MethodEnv *env, ExceptionFrame *ef) {
  (void)ef;
...
void abcOP_debug(MethodEnv *env, uint32_t i, uint32_t nameId, uint32_t slotNum,
                 uint32_t lineNo);
...
template <typename rt, typename t1> rt abcOP_Math_abs(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <typename rt, typename t1> rt abcOP_Math_acos(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_acos<double, double>(MethodEnv *, double a);

//------------------------------------------------------------------------------
// "OP_Math_asin" (Math)
//------------------------------------------------------------------------------

template <typename rt, typename t1> rt abcOP_Math_asin(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_asin<double, double>(MethodEnv *, double a);

//------------------------------------------------------------------------------
// "OP_Math_atan" (Math)
//------------------------------------------------------------------------------

template <typename rt, typename t1> rt abcOP_Math_atan(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_atan<double, double>(MethodEnv *, double a);
...
template <>
extern double abcOP_Math_atan2<double, int, int>(MethodEnv *, int32_t a,
                                                 int32_t b);
template <>
extern double abcOP_Math_atan2<double, double, double>(MethodEnv *, double a,
                                                       double b);
template <>
extern double abcOP_Math_atan2<double, int, double>(MethodEnv *, int32_t a,
                                                    double b);
template <>
extern double abcOP_Math_atan2<double, double, int>(MethodEnv *, double a,
                                                    int32_t b);
...
template <typename rt, typename t1> rt abcOP_Math_ceil(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_ceil<double, double>(MethodEnv *, double a);

//------------------------------------------------------------------------------
// "OP_Math_cos" (Math)
//------------------------------------------------------------------------------

template <typename rt, typename t1> rt abcOP_Math_cos(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <typename rt, typename t1> rt abcOP_Math_exp(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <typename rt, typename t1> rt abcOP_Math_floor(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_floor<double, double>(MethodEnv *, double a);

//------------------------------------------------------------------------------
// "OP_Math_log" (Math)
//------------------------------------------------------------------------------

template <typename rt, typename t1> rt abcOP_Math_log(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_pow<double, int, int>(MethodEnv *, int32_t a,
                                               int32_t b);
template <>
extern double abcOP_Math_pow<double, double, double>(MethodEnv *, double a,
                                                     double b);
template <>
extern double abcOP_Math_pow<double, int, double>(MethodEnv *, int32_t a,
                                                  double b);
template <>
extern double abcOP_Math_pow<double, double, int>(MethodEnv *, double a,
                                                  int32_t b);
...
template <typename rt, typename t1> rt abcOP_Math_round(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_round<double, double>(MethodEnv *, double a);

//------------------------------------------------------------------------------
// "OP_Math_sin" (Math)
//------------------------------------------------------------------------------

template <typename rt, typename t1> rt abcOP_Math_sin(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <typename rt, typename t1> rt abcOP_Math_sqrt(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <>
extern double abcOP_Math_sqrt<double, double>(MethodEnv *, double a);

//------------------------------------------------------------------------------
// "OP_Math_tan" (Math)
//------------------------------------------------------------------------------

template <typename rt, typename t1> rt abcOP_Math_tan(MethodEnv *env, t1 a) {
  return abcOP_box<rt>(env,
...
template <typename rt, typename t1>
rt abcOP_String_concat(MethodEnv *env, t1 a, LLVMAtom argv, int32_t argc,
                       ArrayObject *) {
  Stringp instance = abcOP_convert_s<Stringp, t1>(env, a);
  ...
  for (int32_t i = 0; i < argc; ++i)
    concatString =
        String::concatStrings(concatString, core->string(((Atom *)argv)[i]));
...
template <typename rt>
rt abcOP_String_fromCharCode(MethodEnv *env, LLVMAtom argv, int32_t argc,
                             ArrayObject *) {
  return abcOP_box<rt>(
      env, env->toplevel()->stringClass()->fromCharCode((Atom *)argv, argc));
}
...
rt abcOP_String_match(MethodEnv *env, t1 a, t2 b) {
  ...
  return abcOP_box<rt>(
      env, env->toplevel()->stringClass()->_match(instance, pattern));
}
...
rt abcOP_String_replace(MethodEnv *env, t1 a, t2 b, t3 c) {
  ...
  return abcOP_box<rt>(env, env->toplevel()->stringClass()->_replace(
...
rt abcOP_String_search(MethodEnv *env, t1 a, t2 b) {
  ...
  nullcheck(env, pattern);
  return abcOP_box<rt>(
      env, env->toplevel()->stringClass()->_search(instance, pattern));
}
...
rt abcOP_String_split(MethodEnv *env, t1 a, t2 b, t3 c) {
  ...
  return abcOP_box<rt>(
      env, env->toplevel()->stringClass()->_split(instance, delimiter, limit));
}
